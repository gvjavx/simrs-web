...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollTunjanganUmk" action="saveEdit_payrollTunjanganUmk" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Payroll Tunjangan Umk</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="skalaGajiId1" readonly="true" name="payrollTunjanganUmk.umkId" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboBranch.listOfComboBranch" id="branchId1" name="payrollTunjanganUmk.branchId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollTunjanganUmk.golonganId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilai1" name="payrollTunjanganUmk.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

    ...
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/smkKategoriAspek" action="saveDelete_smkKategoriAspek" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Smk Kategori Aspek </legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkKategoriAspekBobot1" name="smkKategoriAspek.bobot" required="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var tipe = document.getElementById("tipe1").value;
            var tahun = document.getElementById("liburTahun1").value;
            var tanggal = document.getElementById("tgl1").value;
            var keterangan = document.getElementById("liburKeterangan1").value;
            console.log(tipe);
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addLiburForm" method="post" theme="simple" namespace="/libur" action="saveAdd_libur" cssClass="well form-horizontal">
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboLibur.listOfResultTipe" id="tipe1" name="libur.tipeLiburId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textarea rows="4" id="liburKeterangan1" name="libur.liburKeterangan" required="false" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addLiburForm" id="save" name="save"

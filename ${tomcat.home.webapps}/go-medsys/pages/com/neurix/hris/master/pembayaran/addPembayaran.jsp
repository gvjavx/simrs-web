...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave1', function (event, data) {
            var pembayaranName = document.getElementById("pembayaranName1").value;
            var coa = document.getElementById("coa1").value;

            if (pembayaranName != '' && coa != '') {
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPembayaranForm" method="post" theme="simple" namespace="/akunpembayaran" action="saveAdd_akunpembayaran" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Akun Pembayaran</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="pembayaranName1" name="pembayaran.pembayaranName"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="coa1" name="pembayaran.coa"
                                             required="false" readonly="false"
                                             cssClass="form-control" cssStyle="margin-top: 7px"/>
                                <script>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addPembayaranForm" id="save" name="save"

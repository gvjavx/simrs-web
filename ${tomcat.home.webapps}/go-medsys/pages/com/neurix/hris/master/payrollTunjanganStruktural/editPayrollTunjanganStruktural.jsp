...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollTunjanganStruktural" action="saveEdit_payrollTunjanganStruktural" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Payroll Tunjangan Struktural</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="skalaGajiId1" readonly="true" name="payrollTunjanganStruktural.tunjStrukturId" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollTunjanganStruktural.golonganId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilai1" name="payrollTunjanganStruktural.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

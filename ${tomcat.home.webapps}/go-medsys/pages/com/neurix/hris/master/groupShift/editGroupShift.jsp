...
<s:form id="editForm" method="post" theme="simple" namespace="/groupShift" action="saveEdit_groupShift" cssClass="well form-horizontal">
    ...
    <legend align="left">Edit Group Shift</legend>

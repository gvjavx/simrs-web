...
<s:form id="addForm" method="post" theme="simple" namespace="/groupMember" action="save_groupMember" cssClass="well form-horizontal">
    ...
    <legend align="left">Add Group Member</legend>

...
<s:form id="viewDocumentRekruitmen" method="post" theme="simple" namespace="/rekruitmen" action="viewDoc_rekruitmen" cssClass="well form-horizontal">
    ...
    <div class="form-group">
       <div class="col-md-12 col-sm-12">
           <img src="<s:property value='RekruitmenUploadDoc.filePath'/>" width="100%">
       </div>
    </div>

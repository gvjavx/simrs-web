...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollForm" method="post"  theme="simple" namespace="/payroll" action="searchCsv_payroll.action" cssClass="well form-horizontal">
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        'JP':'Jasprod','IN':'Insentif', 'JB':'Jubileum', 'PN':'Pensiun'}" id="tipe" name="payroll.tipe"
                            ...
                            <table id="showdata" width="70%">
                                <tr>
                                    <td align="center">
                                        ...
                                        <s:set name="listOfPayroll" value="#session.listOfCsvPajak" scope="request" />
                                        <display:table name="listOfPayroll" class=" tablePayroll table table-condensed table-striped table-hover"
                                                       requestURI="paging_displaytag_payroll_csv.action" export="true" id="row" pagesize="80" style="font-size:10">

                                            <display:column property="bulan" title="Bulan"  />
                                            <display:column property="tahun" title="Tahun"  />
                                            <display:column property="pembetulan" title="Pembetulan"  />
                                            <display:column property="npwp" title="Npwp"  />
                                            <display:column property="nama" title="Nama"  />
                                            <display:column property="kodePajak" title="Kode Pajak"  />
                                            <display:column property="totalANilai" title="Jumlah Bruto"  />
                                            <display:column property="pphGajiNilai" title="Jumlah PPH"  />
                                            <display:column property="kodeNegara" title="Kode Negara"  />

                                            <display:setProperty name="paging.banner.item_name">csvPajak</display:setProperty>
                                            <display:setProperty name="paging.banner.items_name">csvPajak</display:setProperty>
                                            <display:setProperty name="export.excel.filename" value="csvPajak.xls">Positions.xls</display:setProperty>
                                            <display:setProperty name="export.csv.filename" value="csvPajak.csv">Positions.csv</display:setProperty>
                                            <display:setProperty name="export.pdf.filename">csvPajak.pdf</display:setProperty>

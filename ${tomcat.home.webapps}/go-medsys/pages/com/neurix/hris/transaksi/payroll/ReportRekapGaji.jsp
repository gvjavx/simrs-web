...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollForm" method="post"  theme="simple" namespace="/payroll" action="searchReportRekapGaji_payroll.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:select list="#{'RG':'Rekap Gaji', 'RP':'Rekap Potongan', 'THR':'Rekap THR', 'jasprod':'Rekap Jasprod',
                                         'insentif':'Rekap Insentif',

                                        '':'--------------',
                                        'RGD':'Rekap Gaji Dirkom', 'RPD':'Rekap Potongan Dirkom', 'THRD':'Rekap THR Dirkom'}" id="tipe" name="payroll.tipe"
    ...
    $(document).ready(function() {
        ...
        $('#btnExcell').click(function(){
            if (confirm('Apakah Anda ingin mendownload Payroll dalam format excel?')) {
                ...
                window.location.href = 'payrollReportExcelRekapGaji_payroll?branchId='+branchId+'&bulan='+bulan+'&tahun='+tahun+'&statusPegawai='+statusPegawai
                    +'&tipe='+tipePrint;
            }
        });

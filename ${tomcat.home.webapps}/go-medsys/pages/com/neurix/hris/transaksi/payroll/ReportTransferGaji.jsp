...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollForm" method="post"  theme="simple" namespace="/payroll" action="searchReportTransferGaji_payroll.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:select list="#{'PR':'Payroll', 'T':'THR', 'PD':'Pendidikan', 'JP':'Jasprod'}" id="tipe" name="payroll.tipe"
                        ...
                        <div id="actions" class="form-actions">
                            <table align="center">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="reportTransferGaji_payroll"/>'">

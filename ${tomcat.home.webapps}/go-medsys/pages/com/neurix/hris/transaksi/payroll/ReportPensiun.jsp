...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollForm" method="post"  theme="simple" namespace="/payroll" action="searchPensiun_payroll.action" cssClass="well form-horizontal">
                            ...
                            <table id="showdata" width="50%">
                                <tr>
                                    <td align="center">
                                        ...
                                        <s:set name="listOfPayroll" value="#session.listOfResultPayrollPensiun" scope="request" />
                                        <display:table name="listOfPayroll" class=" tablePayroll table table-condensed table-striped table-hover"
                                                       requestURI="paging_displaytag_payroll_pensiun_payroll.action" export="true" id="row" pagesize="30" style="font-size:10">

                                            <display:column property="nip" title="Nip"  />
                                            <display:column property="nama" title="Nama Pegawai"  />
                                            <display:column property="stTanggalAktif" title="Tanggal Masuk"  />
                                            <display:column property="stTanggalPensiun" title="Tanggal Pensiun"  />
                                            <display:column property="stMasaKerja" title="Masa Kerja"  />

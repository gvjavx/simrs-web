...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="approveForm" method="post" theme="simple" namespace="/medicalrecord" action="saveApprove_medicalrecord" cssClass="well form-horizontal">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:hidden name="medicalRecord.rsKelasId"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textarea id="note" name="medicalRecord.note" cssClass="form-control" rows="4"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label class="control-label"><small>Tolak :</small></label>
                        </td>
                        <td>
                            <table>
                                <input id="check" type="checkbox" onclick="changeTipe()"/>
                            </table>
                        </td>
                    </tr>
                </table>

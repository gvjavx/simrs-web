    ...
    <script type="text/javascript">
        ...
        function saveButtonAddLahan() {
            ...
            if (biayaPengobatanId!='' && jumlah!='' && pengobatanId != '' && tipe !='') {
                ...
                MedicalRecordAction.saveEditBiayaPengobatan(pengobatanId,biayaPengobatanId, jumlah, tipe, function (response) {
                    if (response == '00') {
                        $('#view_dialog_menu').dialog('close');
                ...
                if (biayaPengobatanId == '') {
                    msg = 'Field <strong>biaya Pengobatan Id</strong> is required.' + '<br/>';
                }
                if (pengobatanId == '') {

...
//            var notifName = document.getElementById("notifName1").value;
            ...
            if (nip != '' && tipeNotifId != '' && note != '' && read != '' && fromPerson != '' && noRequest != '' ) {
//                if(isNaN(nip) == false){
...
//                if (notifName == '') {
//                    msg += 'Field <strong>Notif Name</strong> is required.' + '<br/>';
//                }
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addNotifikasiForm" method="post" theme="simple" namespace="/notifikasi" action="saveAdd_notifikasi" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Notifikasi</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="nip1" name="notifikasi.nip" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <%--<tr>--%>
                        <%--<td>--%>
                            <%--<label class="control-label"><small>Notif Name :</small></label>--%>
                        <%--</td>--%>
                        <%--<td>--%>
                            <%--<table>--%>
                                <%--<s:textfield  id="notifName1" name="notifikasi.notifName" required="true" cssClass="form-control"/>--%>
                            <%--</table>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="note1" name="notifikasi.note" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="read1" name="notifikasi.read" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="fromPerson1" name="notifikasi.fromPerson" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="noRequest1" name="notifikasi.noRequest" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addNotifikasiForm" id="save" name="save"

...
<script type='text/javascript'>
    ...
    function back() {
        ...
        if (trans != "" && trans != null){
            var host = firstpath()+"/bgnominasi/edit_bgnominasi.action?status="+status+"&trans="+trans;
        } else {
            var host = firstpath()+"/bgnominasi/add_bgnominasi.action?status="+status+"&tipe=detail&trans="+trans;
        }
    ...
    function refresh() {
        var host = firstpath()+"/bgnominasi/edit_bgnominasi.action?status="+status+"&id="+rekeningid+"&tipe=detail&trans="+trans;
        post(host, form);
    }

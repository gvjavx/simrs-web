                                        ...
                                        <div id="normal" class="tab-pane active">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-4 txt_kurang_bayar_normal" style="margin-top: 14px;margin-left: 20px">Kurang Bayar (RP) </label>
                                                            <div class="col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-4" style="margin-top: 14px;margin-left: 20px"><b class="txt_total_kurang_bayar_normal">Total Lebih Bayar (RP)</b> </label>
                                                            <div class="col-sm-6">

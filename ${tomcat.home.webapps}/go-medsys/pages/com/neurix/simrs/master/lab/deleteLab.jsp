...
//            window.location.reload(true);
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var idLab = document.getElementById("idLab3").value;
            console.log(idLab);
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="deleteLabForm" method="post" theme="simple" namespace="/lab" action="saveDelete_lab" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>

                <legend align="left">Delete Lab.</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="idLab3" name="lab.idLab" required="true" readonly="true" disabled="false" cssClass="form-control"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="namaLab2" name="lab.namaLab" required="true" readonly="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboDokter.listOfComboDokter" id="idDokter2" name="lab.idDokter" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboKategoriLab.listOfComboKategoriLab" id="idKategoriLab2" name="lab.idKategoriLab" disabled="true"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="deleteLabForm" id="save" name="save"

 ...
 */
public class DokterBoImplBackup extends DokterSpesialisModuls implements DokterBo {
    private static transient Logger logger = Logger.getLogger(DokterBoImplBackup.class);

...
/**
 * @author gondok
 * Sunday, 02/02/20 20:07
 */
public class PermintaanObatMobile implements Serializable {
    ...
    private String approvalLastUpdate;
    ...
    public String getApprovalLastUpdate() {
        return approvalLastUpdate;
    }

    public void setApprovalLastUpdate(String approvalLastUpdate) {
    ...
    public String getQtyGudang() {
        return qtyGudang;
    }

    public void setQtyGudang(String qtyGudang) {

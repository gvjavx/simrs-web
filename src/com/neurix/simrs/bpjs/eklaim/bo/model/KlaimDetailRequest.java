...
public class KlaimDetailRequest {
    ...
    private String addPaymentPct;
    private String birthWeight;
    private String dischargeStatus;
    private String diagnosa;
    private String procedure;
    private String tarifRsNonBedah;
    ...
    private String tarifRsObatKemoterapi;
    private String tarifRsObatAlkes;
    ...
    public String getIcuIndikator() {
        return icuIndikator;
    }

    public void setIcuIndikator(String icuIndikator) {
        this.icuIndikator = icuIndikator;
    }
    ...
    public String getAddPaymentPct() {
        return addPaymentPct;
    }

    public void setAddPaymentPct(String addPaymentPct) {
        this.addPaymentPct = addPaymentPct;
    }
    ...
    public String getTarifRsNonBedah() {
        return tarifRsNonBedah;
    }

    public void setTarifRsNonBedah(String tarifRsNonBedah) {
        this.tarifRsNonBedah = tarifRsNonBedah;
    }
    ...
    public String getTarifRsObatKemoterapi() {
        return tarifRsObatKemoterapi;
    }

    public void setTarifRsObatKemoterapi(String tarifRsObatKemoterapi) {
        this.tarifRsObatKemoterapi = tarifRsObatKemoterapi;
    }

    public String getTarifRsObatAlkes() {
        return tarifRsObatAlkes;
    }

    public void setTarifRsObatAlkes(String tarifRsObatAlkes) {
        this.tarifRsObatAlkes = tarifRsObatAlkes;
    }
    ...
    public String getTarifRsPayorId() {
        return tarifRsPayorId;
    }

    public void setTarifRsPayorId(String tarifRsPayorId) {
        this.tarifRsPayorId = tarifRsPayorId;
    }

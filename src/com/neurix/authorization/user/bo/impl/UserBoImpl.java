        ...
        for (int i = 0; i < listdownMenu.size(); i++) {
            ...
            if (itemMenu.size() > 1) { //get url
                ...
                if (itemMenu.get(2).equals("2")) {
                    ...
                    }else if (menuName.equalsIgnoreCase("Kontrol Ulang")) {
                        menuNameString = "<li id=\"kontrol_ulang\"><a href=\"" + itemMenu.get(1) + "\"><i class=\"fa fa-circle-o\"></i><span> " + menuName + "</span></a></li>";
                    } else {
                    ...
                    if (itemMenu.get(1) != null) {
                        ...
                        } else if (menuName.equalsIgnoreCase("License")) {
                            menuNameString = "<li id=\"lisence\"><a href=\"" + itemMenu.get(1) + "\"><i class=\"fa fa-th-large\"></i><span> " + menuName + "</span></a></li>";
                        } else if (menuName.equalsIgnoreCase("Version")) {

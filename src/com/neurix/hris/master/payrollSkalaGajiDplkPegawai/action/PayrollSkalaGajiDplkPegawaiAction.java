...
public class PayrollSkalaGajiDplkPegawaiAction extends BaseMasterAction{
        ...
        if(kode != null && !"".equalsIgnoreCase(kode)){
            if(listOfResult != null){
                for (payrollSkalaGajiDplkPegawai payrollSkalaGajiDplkPegawai: listOfResult) {
                    if(kode.equalsIgnoreCase(payrollSkalaGajiDplkPegawai.getSkalaGajiPensiunDplkPegawaiId()) && flag.equalsIgnoreCase(payrollSkalaGajiDplkPegawai.getFlag())){
    ...
    public String edit() {
        ...
        if(itemFlag != null){
            try {
                ...
                Long logId = null;
                try {
                    logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "PayrollSkalaGajiDplkPegawaiBO.getPayrollSkalaGajiDplkPegawaiByCriteria");
    ...
    public String delete() {
        ...
        if (itemFlag != null ) {
            ...
            try {
                ...
                Long logId = null;
                try {
                    logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "PayrollSkalaGajiDplkPegawaiBO.init");
                } catch (GeneralBOException e1) {
    ...
    public String saveEdit(){
        ...
        try {
            ...
            Long logId = null;
            try {
                logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "PayrollSkalaGajiDplkPegawaiBO.saveEdit");
            } catch (GeneralBOException e1) {
    ...
    public String saveDelete(){
        ...
        try {
            ...
            Long logId = null;
            try {
                logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "PayrollSkalaGajiDplkPegawaiBO.saveDelete");
            } catch (GeneralBOException e1) {
    ...
    public String saveAdd(){
        ...
        try {
            ...
            Long logId = null;
            try {
                logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "payrollSkalaGajiDplkPegawaiBO.saveAdd");
            } catch (GeneralBOException e1) {
                logger.error("[PayrollSkalaGajiDplkPegawaiAction.saveAdd] Error when saving error,", e1);
                return ERROR;
            }
            logger.error("[PayrollSkalaGajiDplkPegawaiAction.saveAdd] Error when adding item ," + "[" + logId + "] Found problem when saving add data, please inform to your admin.", e);
        ...
        logger.info("[PayrollSkalaGajiDplkPegawaiAction.saveAdd] end process >>>");
    ...
    public String search() {
        ...
        try {
            ...
            Long logId = null;
            try {
                logId = payrollSkalaGajiDplkPegawaiBoProxy.saveErrorMessage(e.getMessage(), "PayrollSkalaGajiDplkPegawaiBO.getByCriteria");
            } catch (GeneralBOException e1) {
    ...
    public String searchPayrollSkalaGajiDplkPegawai() {
        logger.info("[PayrollSkalaGajiDplkPegawaiAction.search] start process >>>");
        ...
        try {
            ...
            logger.error("[PayrollSkalaGajiDplkPegawaiAction.save] Error when searching Skala Gaji Iuran Dplk by criteria," + "[" + logId + "] Found problem when searching data by criteria, please inform to your admin.", e);
            addActionError("Error, " + "[code=" + logId + "] Found problem when searching data by criteria, please inform to your admin" );
            return ERROR;
        }
        ...
        session.removeAttribute("listOfResult");
        session.setAttribute("listOfResult", listComboPayrollSkalaGajiDplkPegawai);
        return SUCCESS;
    }
    ...
    public String initPayrollSkalaGajiDplkPegawai() {
        logger.info("[PayrollSkalaGajiDplkPegawaiAction.search] start process >>>");
        ...
        session.removeAttribute("listOfResultPayrollSkalaGajiDplkPegawai");
        session.setAttribute("listOfResultPayrollSkalaGajiDplkPegawai", listOfsearchPayrollSkalaGajiDplkPegawai);

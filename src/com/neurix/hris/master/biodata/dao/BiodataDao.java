...
//                "\titPosisi.position_id";
        ...
        //RAKA-19JAN2021 ==> Penambahan Filter untuk mengambil 1 biodata perorang (case : search biodata ganda krn jabtan aktif rangkap)
        for (Object[] row : results) {
...
//            result.setMt((String) row[46]);
            ...
            result.setProvinsiName((String) row[92]);
            result.setKotaName((String) row[93]);
            result.setKecamatanName((String) row[94]);
            result.setDesaName((String) row[95]);
            result.setTipePegawaiName((String) row[96]);
            result.setNamaBank((String) row[55]);
            result.setNoRekBank((String) row[56]);
            result.setCabangBank((String) row[58]);
...
//            }
    ...
    public List<Biodata> getBiodataListDefault(String branchId,String divisiId,String bagianId,String nip){
        ...
        //RAKA-06JAN2021 ==> penambahan Tipe Pegawai
        //RAKA-20JAN2021 ==> perbaikan query (b4: position.bagian_asli_id)
        String query = "SELECT   \n" +
                "                   pegawai.nip,   \n" +
                "                   pegawai.nama_pegawai,   \n" +
                "                   position.position_id,   \n" +
    ...
    public List<ImBiodataEntity> getAllBiodata(String nip, String nama, String branchId, String divisiId, String tipePegawai, String flag){
        ...
        //RAKA-20JAN2021 ==> penambahan validasi hanya ambil 1 data per biodata (case : typeahead)
        List<String> bioNIP = new ArrayList<>();

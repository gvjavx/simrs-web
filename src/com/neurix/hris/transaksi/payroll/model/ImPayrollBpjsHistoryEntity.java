...
public class ImPayrollBpjsHistoryEntity implements Serializable {
    private String bpjsIdHistory;
    ...
    public String getBpjsIdHistory() {
        return bpjsIdHistory;
    }

    public void setBpjsIdHistory(String bpjsIdHistory) {
        this.bpjsIdHistory = bpjsIdHistory;
    }

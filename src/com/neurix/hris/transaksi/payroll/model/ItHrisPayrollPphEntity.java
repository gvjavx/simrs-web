...
public class ItHrisPayrollPphEntity {
    ...
    private ItHrisPayrollEntity itHrisPayroll;

    public ItHrisPayrollEntity getItHrisPayroll() {
        return itHrisPayroll;
    }

    public void setItHrisPayroll(ItHrisPayrollEntity itHrisPayroll) {
        this.itHrisPayroll = itHrisPayroll;
    }
    ...
    public boolean equals(Object o) {
        ...
        ItHrisPayrollPphEntity that = (ItHrisPayrollPphEntity) o;
        return Objects.equals(pphId, that.pphId) &&
                Objects.equals(payrollId, that.payrollId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pphId, payrollId, pkp, pphGaji, bruto, reduce, nip, bulan, tahun, ptkp, netto, biayaJabatan, hutangPphSetahun, selisihPphSetahun, tunjPph, gaji, sankhus, tunjJabatan, tunjStruktural, tunjFungsional, tunjPeralihan, totalTunjLain, tunjTambahan, pemondokan, komunikasi, totalRlab, iuranPegawai, lembur, tunjPensiun, bpjsTk, bpjsKs, bonus, keterangan, createdDate, createdWho, lastUpdate, lastUpdateWho, action, flag);
    }
}

...
public class ProfilPayroll implements Serializable {
    ...
    public String getFlagJaspord() {
        return flagJaspord;
    }

    public void setFlagJaspord(String flagJaspord) {
        this.flagJaspord = flagJaspord;
    }

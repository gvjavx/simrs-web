...
import com.neurix.akuntansi.transaksi.jurnal.model.ItAkunJurnalDetailAkhirTahunEntity;
 ...
 */
public class JurnalDetailAkhirTahunDao extends GenericDao<ItAkunJurnalDetailAkhirTahunEntity, String> {

    @Override
    protected Class<ItAkunJurnalDetailAkhirTahunEntity> getEntityClass() {
        return ItAkunJurnalDetailAkhirTahunEntity.class;
    }

    @Override
    public List<ItAkunJurnalDetailAkhirTahunEntity> getByCriteria(Map mapCriteria) {
        Criteria criteria=this.sessionFactory.getCurrentSession().createCriteria(ItAkunJurnalDetailAkhirTahunEntity.class);
        ...
        List<ItAkunJurnalDetailAkhirTahunEntity> results = criteria.list();
    ...
    public String getNextJurnalDetailId() throws HibernateException {
        Query query = this.sessionFactory.getCurrentSession().createSQLQuery("select nextval ('seq_jurnal_detail_akhir_tahun')");

 ...
 */
public class JurnalDetailActivityPendingDao extends GenericDao<ItJurnalDetailActivityPendingEntity, String> {

    @Override
    protected Class<ItJurnalDetailActivityPendingEntity> getEntityClass() {
        return ItJurnalDetailActivityPendingEntity.class;
    }

    @Override
    public List<ItJurnalDetailActivityPendingEntity> getByCriteria(Map mapCriteria) {
        Criteria criteria=this.sessionFactory.getCurrentSession().createCriteria(ItJurnalDetailActivityPendingEntity.class);
        ...
        List<ItJurnalDetailActivityPendingEntity> results = criteria.list();

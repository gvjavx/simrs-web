...
import com.neurix.akuntansi.transaksi.budgetinginvestasi.action.BgInvestasiAction;
...
public class BgNominasiAction {
    ...
    public CrudResponse getSearchListBudgeting(String tahun, String unit){
        ...
        budgeting.setRekeningIdList(kodeRekeningBo.getListRekeningIdsByTipeBudgeting("nominasi"));

...
<link rel="stylesheet" href="<s:url value="/pages/bootstraplte/css/bootstrap.css"/>" media="screen">
<link rel="stylesheet" href="<s:url value="/pages/bootstrap/css/hover.css"/>">
<link rel="stylesheet" href="<s:url value="/pages/bootstraplte/css/bootstrap.min.css"/>" type="text/css"/>
...
<link rel="stylesheet" href="<s:url value="/pages/plugins/datepicker/datepicker3.css"/>"/>
<link rel="stylesheet" href="<s:url value="/pages/bootstraplte/css/toast.css"/>"/>


<%--SCRIPT JS--%>
<script type='text/javascript' src="<s:url value="/pages/bootstraplte/js/html5shiv.min.js"/>"/>
<script type='text/javascript' src="<s:url value="/pages/bootstraplte/js/respond.min.js"/>"/>
<script type='text/javascript' src='<s:url value="/dwr/engine.js"/>'/>
<script type='text/javascript' src='<s:url value="/dwr/util.js"/>'/>
<script type='text/javascript' src='<s:url value="/dwr/interface/UserLoginAction.js"/>'/>
<sj:head jqueryui="true" jquerytheme="redmond"/>
<sb:head />
<script type='text/javascript' src='<s:url value="/pages/bootstraplte/js/bootstrap.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/datepicker/bootstrap-datepicker.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/datatables/jquery.dataTables.min.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/datatables/dataTables.bootstrap.min.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/slimScroll/jquery.slimscroll.min.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/chartjs/Chart.min.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/select2/select2.full.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/chartjs/chartjs-plugin-labels.min.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/flot/jquery.flot.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/flot/jquery.flot.resize.js"/>'/>

<script type='text/javascript' src="<s:url value="/pages/bootstraplte/js/bootstrap.min.js"/>"/>
<script src="<s:url value="/pages/dist/js/app.min.js"/>"/>
<script src="<s:url value="/pages/dist/js/timepicker.js"/>"/>
<script src="<s:url value="/pages/plugins/typeahead/bootstrap3-typeahead.js"/>"/>

<script src="<s:url value="/pages/plugins/input-mask/jquery.inputmask.js"/>"/>
<script src="<s:url value="/pages/plugins/input-mask/jquery.inputmask.date.extensions.js"/>"/>
<script src="<s:url value="/pages/plugins/input-mask/jquery.inputmask.extensions.js"/>"/>
<script src="<s:url value="/pages/bootstraplte/js/jquery.tabletojson.js"/>"/>
<script src="<s:url value="/pages/plugins/pace/pace.min.js"/>"/>
<script src="<s:url value="/pages/plugins/iCheck/icheck.min.js"/>"/>
<script type="text/javascript" src="<s:url value="/pages/bootstraplte/js/jquery-ui.js"/>"/>
<script src="<s:url value="/pages/plugins/morris/morris.min.js"/>"/>
<script src="<s:url value="/pages/plugins/morris/raphael.min.js"/>"/>
<script src="<s:url value="/pages/dist/js/spinner.js"/>"/>
<script type='text/javascript' src='<s:url value="/pages/dist/js/toast.js"/>'/>
<script type='text/javascript' src='<s:url value="/pages/plugins/ckeditor/ckeditor.js"/>'/>

                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_neurologi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_neurologi" class="hvr-grow"
                                ...
                                <img id="del_anamnesa_neurologi" class="hvr-grow" onclick="conSPS('anamnesa_neurologi', 'spesialis_neurologi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_pemeriksaan_neurologi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_pemeriksaan_neurologi" class="hvr-grow"
                                ...
                                <img id="del_pemeriksaan_neurologi" class="hvr-grow" onclick="conSPS('pemeriksaan_neurologi', 'spesialis_neurologi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_neurologi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_neurologi" class="hvr-grow"
                                ...
                                <img id="del_edukasi_neurologi" class="hvr-grow" onclick="conSPS('edukasi_neurologi', 'spesialis_neurologi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>

<div class="modal fade" id="modal-sps-spesialis_jantung">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #00a65a; color: white">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-stethoscope"></i> Asesmen Jantung
                </h4>
            </div>
            <div class="modal-body">
                <div class="box-body btn-hide">
                    <div class="alert alert-success alert-dismissible" style="display: none" id="warning_sps_spesialis_jantung">
                    ...
                    <div class="btn-group btn-hide">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a onclick="showModalSPS('anamnesa_pemeriksaan_jantung')" style="cursor: pointer"><i
                                    class="fa fa-plus"></i> Anamnesa dan Pemeriksaan</a></li>
                            <li><a onclick="showModalSPS('edukasi_jantung')" style="cursor: pointer"><i
                ...
                <div class="box-body">
                    <table class="table">
                        <tbody>
                        <tr id="row_sps_anamnesa_pemeriksaan_jantung">
...
<div class="modal fade" id="modal-sps-anamnesa_pemeriksaan_jantung">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="alert alert-danger alert-dismissible" style="display: none" id="warning_sps_anamnesa_pemeriksaan_jantung">
                        <h4><i class="icon fa fa-ban"></i> Warning!</h4>
                        <p id="msg_sps_anamnesa_pemeriksaan_jantung"></p>
                    </div>
                    <div class="row">
                    ...
                    <div class="row jarak">
                        <div class="col-md-12">
                            <div class="text-center">
                                <canvas class="paint-canvas" style="cursor: pointer" id="area_jantung" onmouseover="paintTtd('area_jantung', true)"></canvas>
                            </div>
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button class="btn btn-success pull-right" id="save_sps_anamnesa_pemeriksaan_jantung" onclick="saveSPS('anamnesa_pemeriksaan_jantung', 'spesialis_jantung')"><i class="fa fa-check"></i> Save
                </button>
                <button style="display: none; cursor: no-drop" type="button" class="btn btn-success" id="load_sps_anamnesa_pemeriksaan_jantung"><i
...
<div class="modal fade" id="modal-sps-edukasi_jantung">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="alert alert-danger alert-dismissible" style="display: none" id="warning_sps_edukasi_jantung">
                        <h4><i class="icon fa fa-ban"></i> Warning!</h4>
                        <p id="msg_sps_edukasi_jantung"></p>
                    </div>
                    <div class="row">
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button class="btn btn-success pull-right" id="save_sps_edukasi_jantung" onclick="saveSPS('edukasi_jantung', 'spesialis_jantung')"><i class="fa fa-check"></i> Save
                </button>
                <button style="display: none; cursor: no-drop" type="button" class="btn btn-success" id="load_sps_edukasi_jantung"><i
                        class="fa fa-spinner fa-spin"></i> Sedang Menyimpan...
                </button>
            </div>
        </div>

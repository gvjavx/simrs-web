                        ...
                        <tr id="row_ina_kebutuhan_discharge_planing">
                            ...
                            <td width="20%" align="center">
                                <img id="btn_ina_kebutuhan_discharge_planing" class="hvr-grow"
                                     ...
                                     src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_kebutuhan_discharge_planing" class="hvr-grow btn-hide" onclick="conRI('kebutuhan_discharge_planing', 'discharge_planing')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>

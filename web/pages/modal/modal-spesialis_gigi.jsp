                    ...
                    <table class="table" id="tabel_sps_spesialis_gigi">
                        ...
                        <tr id="row_sps_asesmen_gigi">
                            ...
                            <td width="20%" align="center">
                                ...
                                <img id="del_asesmen_gigi" class="hvr-grow" onclick="conSPS('asesmen_gigi', 'spesialis_gigi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_rencana_gigi_pasien">
                            ...
                            <td width="20%" align="center">
                                <img id="btn_sps_rencana_gigi_pasien" class="hvr-grow"
                                     ...
                                     src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="del_rencana_gigi_pasien" class="hvr-grow" onclick="conSPS('rencana_gigi_pasien', 'spesialis_gigi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>

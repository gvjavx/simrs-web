<div class="modal fade" id="modal-gizi-pengkajian_gizi_ulang">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #00a65a; color: white">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-user-md"></i> Pengkajian Gizi Ulang
                </h4>
            </div>
            <div class="modal-body">
                <div class="box-body btn-hide">
                    <div class="alert alert-success alert-dismissible" style="display: none"
                         id="warning_gizi_pengkajian_gizi_ulang">
                        <h4><i class="icon fa fa-info"></i> Info!</h4>
                        <p id="msg_gizi_pengkajian_gizi_ulang"></p>
                    </div>
                    <div class="alert alert-danger alert-dismissible" style="display: none" id="warn_pengkajian_gizi_ulang">
                        <h4><i class="icon fa fa-warning"></i> Warning!</h4>
                        <p id="msg_pengkajian_gizi_ulang"></p>
                    </div>
                    <button type="button" onclick="showModalGizi('add_pengkajian_gizi_ulang')" class="btn btn-success"><i
                            class="fa fa-plus"></i> Tambah Pengkajian Gizi Ulang
                    </button>
                </div>
                <div class="box-body">
                    <table class="table" id="tabel_gizi_pengkajian_gizi_ulang">
                        <tbody>
                        <tr id="row_gizi_add_pengkajian_gizi_ulang">
                            <td>Pengkajian Gizi Ulang</td>
                            <td width="20%" align="center">
                                <img id="btn_gizi_add_pengkajian_gizi_ulang" class="hvr-grow"
                                     onclick="detailGizi('add_pengkajian_gizi_ulang')"
                                     src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_add_pengkajian_gizi_ulang" class="hvr-grow btn-hide"
                                     onclick="conGizi('add_pengkajian_gizi_ulang','pengkajian_gizi_ulang')"
...
<div class="modal fade" id="modal-gizi-add_pengkajian_gizi_ulang">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #00a65a; color: white">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-user-plus"></i> Pengkajian Gizi Ulang
                </h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-danger alert-dismissible" style="display: none"
                     id="warning_gizi_add_pengkajian_gizi_ulang">
                    <h4><i class="icon fa fa-ban"></i> Warning!</h4>
                    <p id="msg_gizi_add_pengkajian_gizi_ulang"></p>
                </div>
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" oninput="$('#gizi102').val(''); $('#gizi102').val(this.value);"
                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" oninput="$('#gizi112').val(''); $('#gizi112').val(this.value);"
                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <input onclick="isCek(this.id, 'form_berupa1')" type="checkbox" name="gizi16" id="gizi161" value="Muntah">
                                <label for="gizi161"></label> Parenteral
                            </div>
                        </div>
                        <div class="col-md-7" style="display: none" id="form_berupa1">
                            <input class="form-control" placeholder="Berupa" oninput="$('#gizi161').val(''); $('#gizi161').val(this.value)">
                        </div>
                    </div>
                    <div class="row jarak">
                        <div class="col-md-offset-2 col-md-3">
                            <div class="form-check">
                                <input onclick="isCekMulti(this.id)" type="checkbox" name="gizi16" id="gizi162" value="Muntah">
                    ...
                    <div class="row jarak" style="display: none" id="form_gizi17">
                        <div class="col-md-offset-5 col-md-7">
                            <input class="form-control" placeholder="Keterang Lain-Lain">
                        </div>
                    </div>
                    <div class="row jarak" style="display: none" id="form_gizi163">
                        <div class="col-md-offset-5 col-md-7">
                            <input class="form-control" placeholder="Berupa">
                        </div>
                    </div>
                    <hr class="garis">
                    <div class="row jarak">
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button id="save_gizi_add_pengkajian_gizi_ulang" class="btn btn-success pull-right"
                        onclick="saveGizi('add_pengkajian_gizi_ulang', 'pengkajian_gizi_ulang')"><i class="fa fa-check"></i>
                    Save
                </button>
                <button id="load_gizi_add_pengkajian_gizi_ulang" style="display: none; cursor: no-drop" type="button"

                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_pemeriksaan_paru">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_pemeriksaan_paru" class="hvr-grow"
                                ...
                                <img id="del_anamnesa_pemeriksaan_paru" class="hvr-grow" onclick="conSPS('anamnesa_pemeriksaan_paru', 'spesialis_paru')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_paru">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_paru" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="del_edukasi_paru" class="hvr-grow" onclick="conSPS('edukasi_paru', 'spesialis_paru')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>

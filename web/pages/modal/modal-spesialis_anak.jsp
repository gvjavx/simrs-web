                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_anak">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_anak" class="hvr-grow"
                                ...
                                <img id="delete_anamnesa_anak" class="hvr-grow btn-hide" onclick="conSPS('anamnesa_anak', 'spesialis_anak')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_pemeriksaan_anak">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_pemeriksaan_anak" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_pemeriksaan_anak" class="hvr-grow btn-hide" onclick="conSPS('pemeriksaan_anak', 'spesialis_anak')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_anak">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_anak" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_edukasi_anak" class="hvr-grow btn-hide" onclick="conSPS('edukasi_anak', 'spesialis_anak')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-8">
                            <select class="form-control select2" id="intruksi_pemeriksaan_anak" style="width: 100%" onchange="showKetIntruksi(this.value)">
                            </select>
                        </div>
                    </div>
                    <div class="row jarak" style="display: none" id="int-ket1">
                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-8">
                                <select class="form-control select2" id="ket_pemeriksaan_anak" style="width: 100%">

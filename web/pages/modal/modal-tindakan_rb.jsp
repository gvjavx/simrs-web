        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger alert-dismissible" style="display: none"
                     id="warning_rb_kurretage_rb">
                    <h4><i class="icon fa fa-ban"></i> Warning!</h4>
                    <p id="msg_rb_kurretage_rb"></p>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" id="tindakan_rb" style="width: 100%">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered" style="font-size: 12px">
                        ...
                        <tr style="font-weight: bold">
                            ...
                            <td>Isi Informasi</td>
                            <td width="20%" align="center">Check(<i class="fa fa-check"></i>)</td>
                        </tr>
                        </thead>
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button id="save_rb_kurretage_rb" class="btn btn-success pull-right"
                        onclick="saveRB('kurretage_rb','laporan_pembedahan')"><i class="fa fa-check"></i>
                    Save
                </button>
                <button id="load_rb_kurretage_rb" style="display: none; cursor: no-drop" type="button"

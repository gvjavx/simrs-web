                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input class="form-control ptr-tgl" id="pt17">
                            </div>
                        </div>
                    </div>
                    <div class="row jarak">
                        ...
                        <div class="col-md-8">
                            <select class="form-control select2" id="intruksi_pemeriksaan_ortopedi" style="width: 100%" onchange="showKetIntruksi(this.value)">
                            </select>
                        </div>
                    </div>
                    <div class="row jarak" style="display: none" id="int-ket1">
                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-8">
                                <select class="form-control select2" id="ket_pemeriksaan_ortopedi" style="width: 100%">

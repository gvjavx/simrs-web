                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_ortopedi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_ortopedi" class="hvr-grow"
                                ...
                                <img id="del_anamnesa_ortopedi" class="hvr-grow" onclick="conSPS('anamnesa_ortopedi', 'spesialis_ortopedi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_pemeriksaan_ortopedi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_pemeriksaan_ortopedi" class="hvr-grow"
                                ...
                                <img id="del_pemeriksaan_ortopedi" class="hvr-grow" onclick="conSPS('pemeriksaan_ortopedi', 'spesialis_ortopedi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_ortopedi">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_ortopedi" class="hvr-grow"
                                ...
                                <img id="del_edukasi_ortopedi" class="hvr-grow" onclick="conSPS('edukasi_ortopedi', 'spesialis_ortopedi')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="row jarak">
                        ...
                        <div class="col-md-8">
                            <textarea rows="2" class="form-control resep-pasien" id="pt15"></textarea>
                        </div>
                    </div>
                    <div class="row jarak">

<div class="modal fade" id="modal-icu-catatan_integrasi">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="alert alert-success alert-dismissible" style="display: none"
                         id="warning_icu_catatan_terintegrasi_icu">
                        <h4><i class="icon fa fa-info"></i> Info!</h4>
                        <p id="msg_icu_catatan_terintegrasi_icu"></p>
                    </div>
                    <button class="btn btn-success btn-hide" onclick="showModalICU('catatan_integrasi_pasien_icu')"><i class="fa fa-plus"></i> Catatan Integrasi Pasien</button>
                </div>
                <div class="box-body">
                    <table class="table" id="tabel_hd_monitoring_hd">
                        <tbody>
                        <tr id="row_icu_catatan_integrasi_pasien_icu">
                            <td>Catatan Perkembangan Pasien Terintegrasi</td>
                            <td width="20%" align="center">
                                <img id="btn_icu_catatan_integrasi_pasien_icu" class="hvr-grow" onclick="detailCPPT('catatan_integrasi_pasien_icu', 'catatan_terintegrasi_icu', 'icu')"
...
<div class="modal fade" id="modal-icu-catatan_integrasi_pasien_icu">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger alert-dismissible" style="display: none"
                     id="warning_icu_catatan_integrasi_pasien_icu">
                    <h4><i class="icon fa fa-ban"></i> Warning!</h4>
                    <p id="msg_icu_catatan_integrasi_pasien_icu"></p>
                </div>
                <div class="modal-body">
                    <div class="alert alert-danger alert-dismissible" style="display: none"
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button id="save_icu_catatan_integrasi_pasien_icu" class="btn btn-success pull-right"
                        onclick="saveCPPT('catatan_integrasi_pasien_icu','catatan_terintegrasi_icu', 'icu')"><i class="fa fa-check"></i>
                    Save
                </button>
                <button id="load_icu_catatan_integrasi_pasien_icu" style="display: none; cursor: no-drop" type="button"

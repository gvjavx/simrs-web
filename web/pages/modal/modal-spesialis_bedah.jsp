                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_bedah" class="hvr-grow"
                                ...
                                <img id="del_anamnesa_bedah" class="hvr-grow" onclick="conSPS('anamnesa_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_pemeriksaan_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_pemeriksaan_bedah" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="del_pemeriksaan_bedah" class="hvr-grow" onclick="conSPS('pemeriksaan_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_bedah" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="del_edukasi_bedah" class="hvr-grow" onclick="conSPS('edukasi_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>

                    ...
                    <table class="table">
                        ...
                        <tr id="row_sps_anamnesa_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_anamnesa_bedah" class="hvr-grow"
                                ...
                                <img id="delete_anamnesa_bedah" class="hvr-grow btn-hide" onclick="conSPS('anamnesa_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_pemeriksaan_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_pemeriksaan_bedah" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_pemeriksaan_bedah" class="hvr-grow btn-hide" onclick="conSPS('pemeriksaan_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        <tr id="row_sps_edukasi_bedah">
                            ...
                            <td width="20%" align="center"><img id="btn_sps_edukasi_bedah" class="hvr-grow"
                                                                ...
                                                                src="<%= request.getContextPath() %>/pages/images/icons8-plus-25.png">
                                <img id="delete_edukasi_bedah" class="hvr-grow btn-hide" onclick="conSPS('edukasi_bedah', 'spesialis_bedah')" src="<%= request.getContextPath() %>/pages/images/cancel-flat-new.png">
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="row jarak" style="display: none" id="int-ket1">
                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-8">
                                <select class="form-control select2" id="ket_pemeriksaan_bedah" style="width: 100%">

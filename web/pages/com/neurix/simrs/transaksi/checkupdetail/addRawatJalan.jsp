    ...
    <div class="modal-dialog modal-flat">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                ...
                <button type="button" class="btn btn-success" onclick="saveDokter()" id="save_dokter"><i
                        class="fa fa-arrow-right"></i> Save
                </button>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select class="form-control" style="margin-top: 7px" id="tin_id_tindakan"
                                    onchange="$(this).css('border','')">
                                <option value=''>[Select One]</option>
                            </select>
                        </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select class="form-control" style="margin-top: 7px" id="nosa_jenis_diagnosa"
                                    onchange="$(this).css('border','')">
                                <option value="">[select one]</option>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            ...
                            <s:select cssStyle="margin-top: 7px" onchange="$(this).css('border',''); listSelectLab(this)"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select class="form-control" style="margin-top: 7px" id="lab_lab" onchange="$(this).css('border','');">
                                <option value=''>[Select One]</option>
                            </select>
                        </div>
                    </div>
...
//                                "<td align='center'>"+ qtyTotal +"</td>"+
    ...
    function saveLab() {
        ...
        if (idDetailCheckup != '' && idKategori != '' && idLab != '') {
            ...
            $('#load_lab').show();
            dwr.engine.setAsync(true);
            Lab.saveDiagnosa(idDetailCheckup, idLab,{
                callback: function (response) {
                    if (response == "success") {
                        dwr.engine.setAsync(false);
                        listDiagnosa();

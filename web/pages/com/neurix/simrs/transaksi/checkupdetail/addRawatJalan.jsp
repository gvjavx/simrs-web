                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <%--<div class="btn-group">--%>
                            ...
                            <%--<button type="button" class="btn btn-success btn-outline" onclick="showModal(7)" style="margin-bottom: 10px; width: 150px"><i class="fa fa-plus"></i> Tambah Resep</button>--%>
                                <%--<button type="button" class="btn btn-success btn-outline" onclick="showModal(7)" style="margin-bottom: 10px; width: 150px"><i class="fa fa-efresh"></i> Copy Resep</button>--%>

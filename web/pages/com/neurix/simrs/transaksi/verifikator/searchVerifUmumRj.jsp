...
<head>
    ...
    <script type='text/javascript'>
        ...
        $( document ).ready(function() {
            $('#bayar_rawat_jalan, #verif_umum_active').addClass('active');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Verifikasi Transaksi Pasien Umum Rawat Jalan
        </h1>
    </section>
                            ...
                            <s:form id="verifForm" method="post" namespace="/verifumumrj" action="searchVerif_verifumumrj.action" theme="simple" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initVerif_verifumumrj.action">
                        ...
                        <table id="sortTable" class="table table-bordered table-striped" style="font-size: 12px">
                            ...
                            <s:iterator value="#session.listOfResult" var="row">
                                <tr>
                                    ...
                                    <td align="center">
                                        <s:if test='#row.flagCloseTraksaksi == "Y"'>
        ...
        if(!cekSession()){
            ...
            CheckupAction.listDataPasien(idDetail, {callback: function (res) {
                    if (res.idPasien != null) {
                        ...
                        idPelayanan = res.idPelayanan;
                       idPelayananHeader = res.idHeaderPelayanan;
                    }
                }
            });
        }

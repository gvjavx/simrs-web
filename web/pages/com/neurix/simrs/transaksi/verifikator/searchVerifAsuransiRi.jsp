...
<head>
    ...
    <script type='text/javascript'>
        ...
        $( document ).ready(function() {
            $('#bayar_rawat_inap, #verif_asuransi_active').addClass('active');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Verifikasi Transaksi Pasien Asuransi Rawat Inap
        </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="verifForm" method="post" namespace="/verifasri" action="searchVerifAs_verifasri.action" theme="simple" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initVerif_verifasri.action">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 70%;overflow-y: scroll;" id="top_up">
                ...
                <div class="box-header with-border">
                    ...
                    <button class="btn btn-success pull-right" onclick="showDiagnosa()"><i class="fa fa-plus"></i> Tambah Diagnosa</button>
                </div>
                <div class="box-body">
...
<script type='text/javascript'>
    ...
    function detail(noCheckup, idDetail, flagClose) {
        if(!cekSession()){
            startSpinner('spin_', idDetail);
            dwr.engine.setAsync(true);
            CheckupAction.listDataPasien(idDetail, {callback: function (res) {
                    if (res.idPasien != null) {
                        stopSpinner('spin_', idDetail);
                        ...
                        if(res.flagCloseTransaksi == "Y"){
                            ...
                            listTindakanApprove(noCheckup, idDetail, res.idJenisPeriksaPasien);
                        }else{
                            $('#form-close').show();
                            $('#form-cover').hide();

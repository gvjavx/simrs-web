                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div id="permintaanPOForm">
                                <div class="row">
                                    <label class="col-sm-4" align="right" style="margin-top: 7px">ID Permintaan Vendor</label>
                                    <div class="col-sm-4">
                                        <s:textfield id="id-permintaan" cssStyle="margin-top: 7px"
                                                     name="permintaanVendor.idPermintaanVendor" required="false"
                                                     readonly="false" cssClass="form-control"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-4" align="right" style="margin-top: 7px">ID Approval</label>
                                    <div class="col-sm-4">
                                        <s:textfield id="id-approval" name="permintaanVendor.idApprovalObat"
                                                     required="false" readonly="false"
                                                     cssClass="form-control" cssStyle="margin-top: 7px"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-4" align="right" style="margin-top: 7px">Flag</label>
                                    <div class="col-sm-4">
                                ...
                                <br>
                                <s:hidden id="id-vendor" name="permintaanVendor.idVendor" />
                                <div class="row">
                                    <label class="col-sm-4" align="right" style="margin-top: 7px"></label>
                                    <div class="col-sm-8" style="margin-top: 7px">
                                        <button class="btn btn-success" onclick="search()"><i class="fa fa-search"></i> Search</button>
                                        <a type="button" class="btn btn-danger" href="initFormVendor_permintaanvendor.action">
                            ...
                            <s:iterator value="#session.listOfResult" var="row">
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <s:url var="verify_po" namespace="/permintaanvendor" action="addPoVendor_permintaanvendor" escapeAmp="false">
                                            <s:param name="id"><s:property value="idPermintaanVendor"/></s:param>
                                        </s:url>
                                        <s:a href="%{verify_po}">
                                        ...
                                        <%--<s:else>--%>
                                            <%--<s:url var="verify_po" namespace="/permintaanvendor" action="edit_permintaanvendor" escapeAmp="false">--%>
                                                <%--<s:param name="id"><s:property value="idPermintaanVendor"/></s:param>--%>
                                            <%--</s:url>--%>
                                            <%--<s:a href="%{verify_po}">--%>
                                                <%--<img class="hvr-grow" src="<s:url value="/pages/images/icons8-create-25.png"/>" style="cursor: pointer;">--%>
...
<script type='text/javascript'>
    ...
    function search() {
        var idvendor = $("#id-vendor").val();
        var idpermintaan = $("#id-permintaan").val();
        var idapproval = $("#id-approval").val();
        PermintaanVendorAction.getListPermintaanVendor(idpermintaan, idapproval, idvendor, function (res) {
    ...
    function refresh() {
        var host = firstpath()+"/permintaanvendor/searchPoVendor_permintaanvendor.action";
        post(host);
    }

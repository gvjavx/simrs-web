...
<head>
    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function () {
            $('#monitoring_obat_poli, #obat_poli_active').addClass('active');
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Monitoring Obat Poli</h3>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Monitoring Obat Poli</h3>
                    </div>
                    <div class="box-body">

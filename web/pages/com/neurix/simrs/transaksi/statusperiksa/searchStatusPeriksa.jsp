            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Status Pasien</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="statusPeriksaForm" method="post" namespace="/statuspasien" action="search_statuspasien.action" theme="simple" cssClass="form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Jenis Rawat</label>
                                    <div class="col-sm-4">
                                        <s:select list="#{'RI':'Rawat Inap'}" cssStyle="margin-top: 7px"
                                                  id="jenis_pelayanan" name="headerDetailCheckup.tipePelayanan"
                                                  headerKey="RJ" headerValue="Rawat Jalan"
                                                  cssClass="form-control select2" onchange="hidePoli(this.value)"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="form-poli">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <s:hidden value="1"  name="headerDetailCheckup.statusPeriksa"></s:hidden>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        <sj:submit type="button" cssClass="btn btn-success" formIds="statusPeriksaForm" id="search" name="search"
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Status Pasien</h3>
                    </div>
                    <div class="box-body">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <s:iterator value="#session.listOfResult" status="listOfRawatJalan" id="listRawatjalan">
                                <tr>
                                    ...
                                    <td><s:property value="jenisPeriksa"/></td>
                                    <td align="center">

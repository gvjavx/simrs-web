                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control select2" id="penjamin">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" id="diagnosa_awal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group" style="margin-top: 7px">
                                            <s:textfield name="headerDetailCheckup.noBpjs" cssClass="form-control" id="no_bpjs"></s:textfield>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control select2" style="margin-top: 7px" id="perujuk">
                                            <option value="">[Select One]</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" id="intansi_perujuk">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group" style="margin-top: 7px">
                                            <input class="form-control" id="no_rujukan">
                                            <div class="input-group-btn">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" style="margin-top: 7px" id="ppk_rujukan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4" style="margin-top: 7px">Tanggal Rujukan</label>
                                    <div class="col-md-8">
                                        <input class="form-control datepicker" style="margin-top: 7px" id="tgl_rujukan">
                                    </div>
                                </div>
...
<script type='text/javascript'>
    ...
    function savePerubahan(){
        ...
        if(jenisPeriksa != ''){
            ...
            StatusPeriksaAction.savePerubahanStatus(result, function (response) {
                console.log(response);
            });

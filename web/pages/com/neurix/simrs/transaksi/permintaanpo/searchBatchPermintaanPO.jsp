...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Batch Permintaan Purchase Order (PO)
                        ...
                        <table class="table table-bordered table-striped" id="tabel_po">
                            ...
                            <s:iterator value="#session.listOfBatch" var="row">
                                <tr id='row<s:property value="noBatch"/>'>
                                    ...
                                    <td align="center">
                                        <a onclick="updateBatch('<s:property value="noBatch"/>')" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                        <a onclick="approveBatch('')" class="btn btn-success"><i class="fa fa-check"></i></a>
                                    </td>
                                </tr>
                            </s:iterator>
                            </tbody>

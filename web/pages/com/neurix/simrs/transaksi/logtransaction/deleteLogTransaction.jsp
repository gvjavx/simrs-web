            ...
            <s:form id="formLogTrxDelete" method="post" theme="simple" namespace="/logtransaction" action="saveDelete_logtransaction" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="delLogTrxId" readonly="true" name="logTransaction.pgLogTrxId" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Transaction Amount :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Name Person :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Address Person :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Phone Person :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Email Person :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Message :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group date">
                                ...
                                <s:textfield id="delSentDate" readonly="true" name="logTransaction.stSentDate" cssClass="form-control pull-right"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group date">
                                ...
                                <s:textfield id="delReceivedDate" readonly="true" name="logTransaction.stReceivedDate" cssClass="form-control pull-right"
                                             required="false"  cssStyle=""/>
                            </div>
                        </td>
                    </tr>

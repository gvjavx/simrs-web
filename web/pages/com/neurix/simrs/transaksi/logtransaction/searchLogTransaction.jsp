...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="logTransactionForm" method="post"  theme="simple" namespace="/logtransaction" action="search_logtransaction.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            ...
                            <tr>
                                <td>
                                    <label class="control-label"><small>Log ID :</small></label>
                                </td>
                                <td>
                                    <table>
                                        <s:textfield type="number"  id="logTrxId" name="logTransaction.pgLogTrxId" required="true" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="control-label"><small>Transaction ID :</small></label>
                                </td>
                                <td>
                                    <table>
                            ...
                            <tr>
                                <td>
                                    <label class="control-label"><small>Tipe Transaction :</small></label>
                                </td>
                                <td>
                                    <table>
                                        <s:textfield  id="tipeTrx" name="logTransaction.tipeTrx" required="true" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="control-label"><small>Bank Name :</small></label>
                                </td>
                                <td>
                                    <table>
                            ...
                            <tr>
                                <td>
                                    <label class="control-label"><small>No Virtual Account :</small></label>
                                </td>
                                <td>
                                    <table>
                                        <s:textfield  id="noVA" name="logTransaction.noVirtualAccount" required="true" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="control-label"><small>No Rekam Medik :</small></label>
                                </td>
                                <td>
                                    <table>
                                        <s:textfield  id="noRekamMedik" name="logTransaction.noRekamMedik" required="true" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div id="actions" class="form-actions">
                            <table align="center">
                                <tr>
                                    <td>
                                        <sj:submit type="button" cssClass="btn btn-primary" formIds="logTransactionForm" id="search" name="search"
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initForm_logtransaction"/>'">
                                ...
                                <tr>
                                    <td align="center">
                                        <sj:dialog id="view_dialog_menu" openTopics="showDialogMenu" modal="true"
                                                   height="750" width="600" autoOpen="false"

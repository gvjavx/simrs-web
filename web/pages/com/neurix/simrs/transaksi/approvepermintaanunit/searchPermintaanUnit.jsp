...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Approve Permintaan Obat Unit Lain
        </h1>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Permintaan Obat Unit</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="permintaanForm" method="post" namespace="/approvepermintaanunit" action="searchApproveUnit_approvepermintaanunit.action"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <s:action id="initComboUnitLain" namespace="/checkup"
                                                  name="listComboGudangOtherBranch_checkup"/>
                                        <s:select cssStyle="margin-top: 7px; width: 100%"
                                                  list="#initComboUnitLain.listOfPelayanan" id="poli"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initFormApproveUnit_approvepermintaanunit.action">
                                    ...
                                    <td align="center">
                                        <s:if test='#row.approvalFlag == null'>
                                            <s:if test='#row.request == true'>
                                                <s:url var="init_permintaan" namespace="/approvepermintaanunit" action="initApprovePermintaanUnit_approvepermintaanunit" escapeAmp="false">
                                        ...
                                        <s:elseif test='#row.approvalFlag == "Y" '>
                                            <s:url var="print_permintaan" namespace="/approvepermintaanunit" action="printPermintaanObatApproveUnit_approvepermintaanunit" escapeAmp="false">
                                                <s:param name="idPermintaan"><s:property value="idPermintaanObatPoli"/></s:param>
                                            </s:url>

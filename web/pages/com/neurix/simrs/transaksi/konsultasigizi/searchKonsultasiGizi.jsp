...
<head>
    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function () {
            ...
            setTipe('<s:property value="konsultasiGizi.tipePelayanan"/>');
        });
...
<script type='text/javascript'>
    ...
    function printBarcodeGizi(noCheckup, idorderGizi) {
        window.open('printBarcodeGizi_konsultasigizi.action?id=' + noCheckup + '&order=' + idorderGizi, '_blank');
    }
    ...
    function closePoz(){
        ...
        if(pos == 2){
            ...
            $.each(json, function (i, item) {
                window.open(contextPathHeader + '/konsultasigizi/printBarcodeGizi_konsultasigizi.action?id=' + item.no_checkup + '&order=' + item.id_order_gizi, '_blank');
            });
        }
    }

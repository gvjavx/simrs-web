...
<head>
    ...
    <script type='text/javascript'>
        ...
        function confirm() {
            ...
            var jumlahKm = $('#jumlah_kilometer').val();
            ...
            if (idPasien != '' && cekNik && namaPasien != '' && jenisKelamin != '' && tempatLahir != ''
                ...
                && provinsi != '' && kota != '' && kecamatan != '' && desa != '' && tipe != '' && statusPerkawinan != '' && pendidikan != '' && jalan != '') {
        ...
        function resetField(input) {
            ...
            if (input != 1) {
                ...
                if(noCheckup != '' && noCheckup != null){
                    var form = { "headerDetailCheckup.idPasien": $('#id_pasien').val()};
                    var host = contextPathHeader+'/rawatinap/searchIgd_rawatinap.action';
                    postAtas(host, form);
                }

                $('#no_bpjs, #id_pasien, #no_ktp, #nama_pasien, #jenis_kelamin, #tempat_lahir, #st_tgl_lahir, #jalan, #suku, #profesi, #agama, #dokter, #penjamin, #img_file, #provinsi, #kabupaten, #kecamatan, #desa').css('border', '');
                $('#id_online').val(null);
                $('#pembayaran').val(null);
                $('#uang_muka').val(null);
                ...
                <div class="box box-primary">
                    ...
                    <s:form id="igdForm" enctype="multipart/form-data" method="post" namespace="/rawatinap"
                        ...
                        <div class="box-body">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group" style="margin-top: 7px">
                                                        <s:textfield id="id_pasien" name="headerCheckup.idPasien"
                                                                     ...
                                                                     onkeypress="$(this).css('border','');" placeholder="input 3 karakter no rm/nama"
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select style="width: 100%" class="form-control select2" id="poli"
                                                            onchange="listDokter(this.value); var warn =$('#war_poli').is(':visible'); if (warn){$('#cor_poli').show().fadeOut(3000);$('#war_poli').hide()};">
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="form-group" id="form-lab" style="display: none">
                                                <label class="col-md-4" style="margin-top: 10px">Unit
                                                    Pemeriksaan</label>
                                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-4" style="margin-top: 10px">Kunjungan UGD</label>
                                                <div class="col-md-8">
                            ...
                            <s:hidden name="headerCheckup.tarif" id="h_tarif"></s:hidden>
                            <s:hidden name="headerCheckup.idTindakan" id="h_id_tindakan"></s:hidden>
                            ...
                            <div id="form-ambulance">
                                <div class="box-header with-border"></div>
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-ambulance"></i> Penunjang</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control select2" id="ambulance" onchange="setDiskonHarga(this.value)">
                                                            <option value="">[Select One]</option>
                                                        </select>
                                                    </div>
                                                </div>
...
<script type='text/javascript'>
    ...
    function setPelayanan(){
        ...
        var option = '<option value="">[Select One]</option>';
        CheckupAction.getComboPelayananWithLabCtx('igd', function (res) {
            if(res.length > 0){
    ...
    function setDokter(idDokter, namaDokter) {
        ...
        $('#war_dokter').hide();
        cekKunjunganPoli($('#h_id_pelayanan').val());
    }
    ...
    function showPasienOnline() {
        ...
        dwr.engine.setAsync(true);
        CheckupAction.daftarPasienOnline('<s:property value="headerCheckup.idPelayanan"/>', {

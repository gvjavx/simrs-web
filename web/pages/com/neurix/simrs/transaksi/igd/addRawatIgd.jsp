                                ...
                                <div class="row" id="form-kend-tarif" style="display:none">
                                    <div class="form-group" style="margin-top: 7px">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="form-control" type="hidden" id="h_val_diskon" name="headerDetailCheckup.diskon">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" id="form-kend-tarif-jumlah" style="display:none">
                                    <div class="form-group" style="margin-top: 7px">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control" placeholder="" name="headerDetailCheckup.jumlah" type="number" id="jumlah_kilometer" oninput="setTotalTarif(this.value)">
                                        </div>
                                    </div>
                                </div>
...
<script type='text/javascript'>
    ...
    // Fahmi 2021-08-30, Tambah perhitungan discon kendaraan

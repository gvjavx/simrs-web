            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Recovery Room Pasien</h3>
                    </div>
                    <div class="box-body">
                            ...
                            <s:form id="rawatInapForm" method="post" namespace="/recoveryroom" action="searchRR_recoveryroom.action" theme="simple" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="margin-top: 7px">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initForm_recoveryroom.action">
...
<script type='text/javascript'>
    ...
    function selectKamar(){
        ...
        CheckupDetailAction.listJustRuangan(null, 'rr', {

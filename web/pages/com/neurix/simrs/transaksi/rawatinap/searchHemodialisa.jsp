            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Hemodialisa Pasien</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="rawatInapForm" method="post" namespace="/hemodialisa" action="searchHemodialisa_hemodialisa.action" theme="simple" cssClass="form-horizontal">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="margin-top: 7px">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initForm_hemodialisa.action">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Rawat Hemodialisa Pasien</h3>
                    </div>
                    <div class="box-body">
                                    ...
                                    <td align="center">
                                        <s:if test='#row.idJenisPeriksa == "umum"'>
                                            <s:if test='#row.isBayar == "Y"'>
                                                <s:url var="add_rawat_inap" namespace="/hemodialisa" action="add_hemodialisa" escapeAmp="false">

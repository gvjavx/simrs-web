            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian Rawat Isolasi Pasien</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="rawatInapForm" method="post" namespace="/rawatisolasi" action="searchIsolasi_rawatisolasi.action" theme="simple" cssClass="form-horizontal">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="margin-top: 7px">
                                        ...
                                        <a type="button" class="btn btn-danger" href="initForm_rawatisolasi.action">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Rawat Isolasi Pasien</h3>
                    </div>
                    <div class="box-body">
                                        ...
                                        <s:if test='#row.statusPeriksa != "3"'>
                                            <s:if test='#row.idJenisPeriksa == "umum"'>
                                                <s:if test='#row.isBayar == "Y"'>
                                                    <s:url var="add_rawat_inap" namespace="/rawatisolasi" action="add_rawatisolasi" escapeAmp="false">
                                                ...
                                                <s:else>
                                                    <span class="spin-warning">Uang muka belum bayar</span>
                                                </s:else>
                                            </s:if>
                                            <s:else>
                                                <s:url var="add_rawat_inap" namespace="/rawatisolasi" action="add_rawatisolasi" escapeAmp="false">

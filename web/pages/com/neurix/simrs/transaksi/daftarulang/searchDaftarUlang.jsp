                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="daftarulangForm" method="post" namespace="/daftarulang" action="search_daftarulang.action" theme="simple" cssClass="form-horizontal">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <s:hidden value="3"  name="headerDetailCheckup.statusPeriksa"></s:hidden>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        <sj:submit type="button" cssClass="btn btn-success" formIds="daftarulangForm" id="search" name="search"
                                                   onClickTopics="showDialogLoading" onCompleteTopics="closeDialogLoading" >
                                            <i class="fa fa-search"></i>
                                            Search
                                        </sj:submit>
                                        <a type="button" class="btn btn-danger" href="initForm_daftarulang.action">
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <s:iterator value="#session.listOfResult" status="listOfRawatJalan" id="listRawatjalan">
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="add_daftarulang.action?id=<s:property value="idDetailCheckup"/>">

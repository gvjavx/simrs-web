...
<head>
  ...
  <script type='text/javascript'>
      ...
      function link(){
          window.location.href="<s:url action='initForm_jenispersediaanobat'/>";
      }
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-filter"></i>Jenis Persediaan Obat</h3>
          </div>
          <div class="box-body">
            <table width="100%" align="center">
              <tr>
                <td align="center">
                  <s:form id="SearchJenisPersediaanObatForm" method="post"  theme="simple"
                          namespace="/jenispersediaanobat" action="search_jenispersediaanobat.action" cssClass="form-horizontal">
                    <table>
                      <tr>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                          <table>
                            <s:textfield id="jenispersediaanobat" name="jenisPersediaanObat.nama"
                      ...
                      <tr>
                        ...
                        <td>
                          <table>
                            <s:select list="#{'N':'Non-Active'}" id="flag" name="jenisPersediaanObat.flag"
                        ...
                        <tr>
                          <td >
                            <sj:submit type="button" cssStyle="margin-right: 5px" cssClass="btn btn-primary"
                                       formIds="SearchJenisPersediaanObatForm" id="search" name="search"
                          ...
                          <td>
                            ...
                            <s:url var="urlAdd"  namespace="/jenispersediaanobat" action="add_jenispersediaanobat" escapeAmp="false">
                            </s:url>
                          ...
                          <td>
                            <button type="button" class="btn btn-danger" id="reset" cssStyle="margin-right: 5px"
                                    onclick="window.location.href='<s:url
                                            action="initForm_jenispersediaanobat"/>'">
                      ...
                      <table id="showdata" width="90%">
                        <tr>
                          <td align="center">
                            ...
                            <s:set name="listOfsearchJenisPersediaanObat" value="#session.listOfResultJenisPersediaanObat" scope="request" />
                            <display:table name="listOfsearchJenisPersediaanObat" class="table table-condensed table-striped table-hover"
                                           requestURI="paging_displaytag_jenispersediaanobat.action" export="true" id="row"
                              ...
                              <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                <s:if test='jenisPersediaanObat.isKp == "Y"'>
                                <s:if test='#attr.row.flag == "Y"'>
                                  <s:url var="urlViewDelete" namespace="/jenispersediaanobat" action="delete_jenispersediaanobat" escapeAmp="false">
                                    <s:param name="id"><s:property value="#attr.row.id" /></s:param>
                                    <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                  </s:url>

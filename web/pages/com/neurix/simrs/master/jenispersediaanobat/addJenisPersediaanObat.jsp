...
<head>
    ...
    $.subscribe('beforeProcessSaveAdd', function (event, data) {
        var jenispersediaanobatAdd = document.getElementById("jenispersediaanobatAdd").value;

        if (jenispersediaanobatAdd != '' ) {
    ...
    <tr>
        <td align="center" >
            <s:form id="addJenisObatForm" method="post" theme="simple"
                    namespace="/jenispersediaanobat" action="saveAdd_jenispersediaanobat" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Jenis Persediaan Obat</legend>
                <table>
                    <tr>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="jenispersediaanobatAdd" name="jenisPersediaanObat.nama"

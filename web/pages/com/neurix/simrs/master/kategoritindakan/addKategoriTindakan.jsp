...
<head>
    ...
    $.subscribe('beforeProcessSaveAdd', function (event, data) {
        var kategoritindakanAdd = document.getElementById("kategoritindakanAdd").value;
     
        if (kategoritindakanAdd != '' ) {
...
<table width="100%" align="center">
    <tr>
        <td align="center" >
            <s:form id="addKategoriTindakanForm" method="post" theme="simple"
                    namespace="/kategoritindakan" action="saveAdd_kategoritindakan" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Kategori Tindakan</legend>
                <table>
                    <tr>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="kategoritindakanAdd" name="kategoriTindakan.kategoriTindakan"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addKategoriTindakanForm" id="save" name="save"

...
//            window.location.reload(true);
        ...
        $.subscribe('beforeProcessSave2', function (event, data) {
            var idkategori = document.getElementById("idKategoriPelayanan3").value;
            var kategori = document.getElementById("idKategori3").value;
            var pelayanan = document.getElementById("idPelayanan3").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="deleteTindakanPelayananForm" method="post" theme="simple" namespace="/tindakanPelayanan" action="saveDelete_tindakanPelayanan" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>

                <legend align="left">Delete Kategori Tindakan Pelayanan</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="idKategoriPelayanan3" name="kategoriTindakanPelayanan.idKategoriPelayanan" required="true" disabled="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboKategori.listOfComboKategoriTindakan" id="idKategori3" name="kategoriTindakanPelayanan.idKategori" disabled="true"
                                          listKey="idKategoriTindakan" listValue="kategoriTindakan" headerKey="" headerValue="[Select one]" cssClass="form-control"/>
                                <s:hidden id="idKategori3" name="kategoriTindakanPelayanan.idKategori" />
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboPelayanan.listOfComboPelayanan" id="idPelayanan3" name="kategoriTindakanPelayanan.idPelayanan" disabled="true"
                                          listKey="idPelayanan" listValue="namaPelayanan" headerKey="" headerValue="[Select one]" cssClass="form-control"/>
                                <s:hidden id="idPelayanan3" name="kategoriTindakanPelayanan.idPelayanan" />
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="deleteTindakanPelayananForm" id="save" name="save"

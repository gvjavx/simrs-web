...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var kategori = document.getElementById("idKategori1").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="eTindakanPelayananForm" method="post" theme="simple" namespace="/tindakanPelayanan" action="saveAdd_tindakanPelayanan" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Kategori Tindakan Pelayanan</legend>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboKategori.listOfComboKategoriTindakan" id="idKategori1" name="kategoriTindakanPelayanan.idKategori"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboPelayanan.listOfComboPelayanan" id="idPelayanan1" name="kategoriTindakanPelayanan.idPelayanan"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="eTindakanPelayananForm" id="add" name="add"
                                ...
                                <td>
                                    <table>
                                        ...
                                        <sj:dialog id="error_validation_dialog" openTopics="showErrorValidationDialog" modal="true" resizable="false"
                                                   ...
                                                   buttons="{
                                                                        'OK':function() { $('#error_validation_dialog').dialog('close'); console.log('Close');}
                                                                    }"
                                        >
                                            <div class="alert alert-error fade in">
                                                <label class="control-label" align="left">

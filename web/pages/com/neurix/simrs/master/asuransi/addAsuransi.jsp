...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addAsuransiForm" method="post" theme="simple" namespace="/asuransi" action="saveAdd_asuransi" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Asuransi</legend>
                ...
                <table >
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Is laka :</small></label>
                        </td>
                        <td>
                            <table>
                    ...
                    <%--<tr>--%>
                        ...
                        <%--<td>--%>
                            <%--<table>--%>
                                ...
                                <%--<s:select list="#initComboMaster.listOfComboMaster" id="idMaster1" name="asuransi.noMaster"--%>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addAsuransiForm" id="save" name="save"

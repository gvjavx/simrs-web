...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='initForm_lab'/>";
        }
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Form Lab </h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="labForm" method="post"  theme="simple" namespace="/lab" action="search_lab.action" cssClass="form-horizontal">
                                        <table>
                                            <tr>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <s:textfield id="idLab" name="lab.idLab" required="true" disabled="false" cssClass="form-control"/>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <display:table name="listOfsearchLab" class="table table-condensed table-striped table-hover"
                                                            ...
                                                            <display:column media="html" title="Edit">
                                                                <s:if test='#attr.row.flag == "Y"'>
                                                                    <s:url var="urlEdit" namespace="/lab" action="edit_lab" escapeAmp="false">
                                                                        <s:param name="id"><s:property value="#attr.row.idLab"/></s:param>
                                                            ...
                                                            <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                                                <s:if test='#attr.row.flag == "Y"'>
                                                                    <s:url var="urlViewDelete" namespace="/lab" action="delete_lab" escapeAmp="false">
                                                                        <s:param name="id"><s:property value="#attr.row.idLab" /></s:param>
                                                                        <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                                                    </s:url>

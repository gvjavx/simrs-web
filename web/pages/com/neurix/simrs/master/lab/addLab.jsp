...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave1', function (event, data) {
            var namaLab = document.getElementById("namaLab1").value;
            var idOperatorLab = document.getElementById("idOperatorLab1").value;
            var idDokter = document.getElementById("idDokter1").value;
            var idKategoriLab = document.getElementById("idKategoriLab1").value;
            var tarif = document.getElementById("tarif1").value;

            if (namaLab != '' && idOperatorLab != '' && idDokter != '' && idKategoriLab != '' && tarif != '') {
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addLabForm" method="post" theme="simple" namespace="/lab" action="saveAdd_lab" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Lab</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="namaLab1" name="lab.namaLab" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addLabForm" id="save" name="save"

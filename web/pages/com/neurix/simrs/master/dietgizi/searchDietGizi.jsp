            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i>Diet Gizi</h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="SearchDietGiziForm" method="post"  theme="simple"
                                            namespace="/dietgizi" action="search_dietgizi.action" cssClass="form-horizontal">
                                        <table>
                                            <tr>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td width="18%" >
                                                    <label class="control-label"><small>Nama Diet Gizi:</small></label>
                                                </td>
                                                <td>
                                                    <table>
                                                        <s:textfield id="dietgizi" name="dietGizi.namaDietGizi"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <s:select list="#{'N':'Non-Active'}" id="flag" name="dietGizi.flag"
                                                ...
                                                <tr>
                                                    <td >
                                                        <sj:submit type="button" cssStyle="margin-right: 5px" cssClass="btn btn-primary"
                                                                   formIds="SearchDietGiziForm" id="search" name="search"
                                            ...
                                            <table id="showdata" width="90%">
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <s:set name="listOfsearchDietGizi" value="#session.listOfResultDietGizi" scope="request" />
                                                        <display:table name="listOfsearchDietGizi" class="table table-condensed table-striped table-hover"
                                                            ...
                                                            <display:column media="html" title="Edit">
                                                                <s:if test='#attr.row.flag == "Y"'>
                                                                    <s:url var="urlEdit" namespace="/dietgizi" action="edit_dietgizi" escapeAmp="false">

...
//             document.editDietGiziForm.action = "search_dietgizi.action"
//             document.editDietGiziForm.submit();
        };

        $.subscribe('beforeProcessSaveEdit', function (event, data) {
            var idDietGiziedit = document.getElementById("idDietGiziedit").value;
            var dietgiziEdit = document.getElementById("dietgiziEdit").value;
            var tarifEdit = document.getElementById("tarifEdit").value;

            console.log(idDietGiziedit);

            if (idDietGiziedit != '' && dietgiziEdit != '' && tarifEdit != '') {
                ...
                var msg = "";
                if (idDietGiziedit == '') {
                    msg += 'Field <strong>id Diet Gizi  </strong> is required.' + '<br/>';
                }
                if (dietgiziEdit == '') {
                    msg += 'Field <strong>Diet Gizi  </strong> is required.' + '<br/>';
                }
                if (tarifEdit == '') {
    ...
    <tr>
        <td align="center">
            <s:form id="editDietGiziForm" method="post" theme="simple"
                    namespace="/dietgizi" action="saveEdit_dietgizi" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <s:hidden id="addBranch" name="dietGizi.branchId"/>



                <legend align="left">Edit Diet Gizi</legend>
                ...
                <table >
                    <tr>
                        <td width="30%">
                            <label class="control-label"><small>ID Diet Gizi :</small></label>
                        </td>
                        <td>
                            <table>
                                <s:textfield id="idDietGiziedit" name="dietGizi.idDietGizi"
                                             required="true" readonly="true" cssClass="form-control"/>

                                <%--<s:hidden id="idDietGizidelete" name="dietGizi.idDietGizi" />--%>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td >
                            <label class="control-label"><small>Diet Gizi:</small></label>
                        </td>
                        <td>
                            <table>
                                <s:textfield id="dietgiziEdit" name="dietGizi.namaDietGizi"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="tarifEdit" name="dietGizi.tarif"
                                             cssStyle="margin-top: 7px"
                                             cssClass="form-control"/>
                            </table>
                        </td>

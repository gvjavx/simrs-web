...
<head>
    ...
    <script type='text/javascript'>
        function link(){
            window.location.href="<s:url action='initForm_kategoripersediaan'/>";
        }
    </script>

    <script type='text/javascript' src='<s:url value="/dwr/interface/KategoriPersediaanAction.js"/>'></script>
</head>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i>  Kategori Persediaan
                        </h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="SearchKategoriPersediaanForm" method="post"  theme="simple"
                                            namespace="/kategoripersediaan" action="search_kategoripersediaan.action" cssClass="form-horizontal">
                                        <table>
                                            <tr>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <s:textfield id="kategoripersediaan" name="kategoriPersediaan.nama"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <s:select list="#{'N':'Non-Active'}" id="flag" name="kategoriPersediaan.flag"
                                                ...
                                                <tr>
                                                    <td >
                                                        <sj:submit type="button" cssStyle="margin-right: 5px" cssClass="btn btn-primary"
                                                                   formIds="SearchKategoriPersediaanForm" id="search" name="search"
                                            ...
                                            <table id="showdata" width="90%">
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <s:set name="listOfsearchKategoriPersediaan" value="#session.listOfResultKategoriPersediaan" scope="request" />
                                                        <display:table name="listOfsearchKategoriPersediaan" class="table table-condensed table-striped table-hover"
                                                            ...
                                                            <display:column media="html" title="Edit">
                                                                <s:if test='#attr.row.flag == "Y"'>
                                                                    <s:url var="urlEdit" namespace="/kategoripersediaan" action="edit_kategoripersediaan" escapeAmp="false">
                                                                        <s:param name="id"><s:property value="#attr.row.idKategoriPersediaan"/></s:param>
                                                            ...
                                                            <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                                                <s:if test='#attr.row.flag == "Y"'>
                                                                    <s:url var="urlViewDelete" namespace="/kategoripersediaan" action="delete_kategoripersediaan"
                                                                           escapeAmp="false">
                                                                        <s:param name="id"><s:property value="#attr.row.idKategoriPersediaan" /></s:param>
                                                                        <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                                                    </s:url>
                                                            ...
                                                            <display:column property="idKategoriPersediaan" sortable="true" title="ID Kategori Persediaan" />
                                                            <display:column property="nama" sortable="true" title="Nama Kategori Persediaan" />
                                                            <display:column property="namaRekening" sortable="true" title="Nama Kode Rekening" />

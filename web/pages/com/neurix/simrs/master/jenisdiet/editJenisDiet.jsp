...
//             document.editJenisDietForm.action = "search_jenisdiet.action"
//             document.editJenisDietForm.submit();
        };

        $.subscribe('beforeProcessSaveEdit', function (event, data) {
            var idJenisDietdelete = document.getElementById("idJenisDietdelete").value;

            console.log(idJenisDietdelete);

            if (idJenisDietdelete != '') {
                ...
                var msg = "";
                if (idJenisDietdelete == '') {
                    msg += 'Field <strong>id Jenis Diet  </strong> is required.' + '<br/>';
                }
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="editJenisDietForm" method="post" theme="simple"
                    namespace="/jenisdiet" action="saveEdit_jenisdiet" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Jenis Diet</legend>
                ...
                <table >
                    <tr>
                        <td width="30%">
                            <label class="control-label"><small>ID Jenis Diet :</small></label>
                        </td>
                        <td>
                            <table>
                                <s:textfield id="idJenisDietdelete" name="jenisDiet.idJenisDiet"
                                             required="true" readonly="true" cssClass="form-control"/>

                                <%--<s:hidden id="idJenisDietdelete" name="jenisDiet.idJenisDiet" />--%>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="jenisdietEdit" name="jenisDiet.namaJenisDiet"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="editJenisDietForm" id="save" name="save"

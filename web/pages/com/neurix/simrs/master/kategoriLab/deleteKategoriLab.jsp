...
//            window.location.reload(true);
            document.kategoriLabForm.action = "search_kategorilab.action";
            document.kategoriLabForm.submit();
        };
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="deleteKategoriLabForm" method="post" theme="simple" namespace="/kategorilab" action="saveDelete_kategorilab" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>

                <legend align="left">Delete Kategori Lab</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="idKategoriLab3" name="kategoriLab.idKategoriLab" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="namaKategori3" name="kategoriLab.namaKategori" required="true" readonly="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="deleteKategoriLabForm" id="save" name="save"

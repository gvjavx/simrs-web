...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="editPasienForm" method="post" theme="simple" namespace="/pasien" action="save_pasien" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Password</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="password" type="text" name="pasien.password" required="false"

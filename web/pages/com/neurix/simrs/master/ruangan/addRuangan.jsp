...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            var statusRuangan = document.getElementById("status_ruangan1").value;
            var kelasRuangan = document.getElementById("kelas_ruangan1").value;
            var keterangan = document.getElementById("keterangan1").value;
            var tarifRuangan = document.getElementById("tarif_ruangan1").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addRuanganForm" method="post" theme="simple" namespace="/ruangan" action="saveAdd_ruangan.action" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="nama_ruangan1" cssStyle="margin-top: 7px"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="no_ruangan1" name="ruangan.noRuangan"
                        ...
                        <td>
                            <table>
                                <s:select list="#{'Y':'Tersedia','N':'Tidak Tersedia'}" cssStyle="margin-top: 7px"
                                          id="status_ruangan1" name="ruangan.statusRuangan"
                        ...
                        <td>
                            <table>
                                ...
                                <s:select cssStyle="margin-top: 7px"
                                          list="#initComboKelas.listOfKelasRuangan" id="kelas_ruangan1"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="tarif_ruangan1" cssStyle="margin-top: 7px"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addRuanganForm" id="add" name="add"

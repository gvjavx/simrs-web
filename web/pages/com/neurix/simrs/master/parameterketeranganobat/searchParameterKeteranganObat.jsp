        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <table width="100%" align="center">
              <tr>
                <td align="center">
                  <s:form id="SearchParameterKeteranganObatForm" method="post"  theme="simple"
                          namespace="/parameterketeranganobat" action="search_parameterketeranganobat.action" cssClass="form-horizontal">
                    <table>
                      <tr>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                          <table>
                            <s:textfield id="parameterketeranganobat" name="parameterKeteranganObat.nama"
                      ...
                      <tr>
                        ...
                        <td>
                          <table>
                            <s:select list="#{'N':'Non-Active'}" id="flag" name="parameterKeteranganObat.flag"
                        ...
                        <tr>
                          <td >
                            <sj:submit type="button" cssStyle="margin-right: 5px" cssClass="btn btn-primary"
                                       formIds="SearchParameterKeteranganObatForm" id="search" name="search"
                          ...
                          <td>
                            <button type="button" class="btn btn-danger" id="reset" cssStyle="margin-right: 5px"
                                    onclick="window.location.href='<s:url
                                            action="initForm_parameterketeranganobat"/>'">

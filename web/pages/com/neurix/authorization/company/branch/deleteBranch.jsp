    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form role="form" method="post" id="addForm" action="saveDelete_branch.action" onsubmit="return validateForm()">
                    <div class="box-body">
                        <div class="form-group">
                            <table align="center">
                                ...
                                <tr>
                                    <td>
                                        <s:textfield readonly="true" id="branchId" name="branch.branchId" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <s:textfield readonly="true" id="branchName" name="branch.branchName" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <s:textfield readonly="true" id="branchAddress" name="branch.branchAddress" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                    </td>
                                </tr>

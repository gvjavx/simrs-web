                ...
                <table width="100%" align="center">
                    <tr>
                        <td align="center">
                            ...
                            <s:form id="positionForm" method="post" action="%{urlProcess}"
                            ...
                            <fieldset>
                                <legend align="left">Position Information</legend>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <label class="control-label" for="position.stPositionId">Position Id :</label>
                                        </td>

                                        <td>
                                            <table>
                                                <s:if test="isAddOrEdit()">
                                                    <s:textfield id="positionId" name="position.stPositionId"  readonly="true"/>
                                                </s:if>
                                                <s:elseif test="isDelete()">
                                                    <s:textfield id="positionId" cssClass="disabled" readonly="true" name="position.stPositionId"/>
                                                </s:elseif>
                                                <s:else>
                                                    <s:textfield id="positionId" name="position.stPositionId" required="false"/>
                                                </s:else>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <label class="control-label" for="position.positionName">Position Name :</label>
                                        </td>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <s:elseif test="isDelete()">
                                                    <s:textfield id="positionName" cssClass="disabled" readonly="true" name="position.positionName"/>
                                                </s:elseif>
                                                <s:else>
                                                    <s:textfield id="positionName" name="position.positionName" required="false"/>
                                                </s:else>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <s:if test="!(isAddOrEdit() || isDelete())">
                                    <table>
                                        <tr>
                                            <td>
                                                <label class="control-label" for="position.flag">Flag :</label>
                                            </td>

                                            <td>
                                                <table>
                                                    <s:select list="#{'Y':'Active', 'N':'NonActive'}" id="flag" name="position.flag"
                                ...
                                <table>
                                    <tr>
                                        <div id="crud">
                                            ...
                                            <td>
                                                <table>
                                                    <button type="button" class="btn" onclick="window.location.href='<s:url action="initForm_position"/>'">

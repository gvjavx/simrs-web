            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus"></i> Add Report Keuangan Konsol</h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="addReportKeuanganKonsolForm" method="post"  theme="simple" namespace="/reportKeuanganKonsol" action="saveAdd_reportKeuanganKonsol.action" cssClass="form-horizontal">
                                        ...
                                        <table >
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <s:textfield id="kodeRekeningAlias1" name="akunSettingReportKeuanganKonsol.kodeRekeningAlias" required="true" disabled="false" cssClass="form-control"/>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <div id="actions" class="form-actions">
                                            <table align="center">
                                                <tr>
                                                    <td>
                                                        <sj:submit targets="o" type="button" cssClass="btn btn-primary" formIds="addReportKeuanganKonsolForm" id="save" name="save"
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="add_reportKeuanganKonsol.action"/>'">

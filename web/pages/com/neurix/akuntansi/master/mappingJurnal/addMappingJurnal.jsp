        ...
        $(document).ready(function () {
            ...
            $.subscribe('beforeProcessSave', function (event, data) {
                ...
                if (tipeJurnalId != "") {
                    ...
                    MappingJurnalAction.cekBeforeSave(tipeJurnalId, "add", function (listData) {
                        status = listData;
                    });
                    if (status == "") {
                            ...
                            <tr>
                                <td align="center">
                                    <s:form id="mappingJurnalForm" method="post" theme="simple"
                                            ...
                                            action="saveAddMappingJurnalTransaction_mappingJurnal.action"
                                        ...
                                        <table width="60%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <s:select list="#{'vendor':'vendor','dokter':'Dokter','pasien':'Pasien','karyawan':'Karyawan'}" id="master" name="mappingJurnal.master"
                                        ...
                                        <h3>
                                            ...
                                            <button
                                                    ...
                                                    class="btn btn-default btn-info" data-toggle="modal"
                                                    data-target="#modal-tambah"><i class="fa fa-plus"></i>
                                            </button>
                                        </h3>
                                        <br>
                                        <center>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table style="width: 100%;"
                                                               ...
                                                               id="kodeRekening" name="mappingJurnal.kodeRekening">
                                                        </table>
                                                    </td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger"
                                                                onclick="window.location.href='<s:url
                                                                        action="add_mappingJurnal.action"/>'">
                                                            <i class="fa fa-refresh"></i> Reset
                                                        </button>
                                                    </td>
                                                        <%--edite by aji add back button--%>
                                                    <td>
                                                        <a type="button" class="btn btn-warning"
                                                           href="initForm_mappingJurnal.action">
                                        ...
                                        $('#modKodeRekening').typeahead({
                                            ...
                                            updater: function (item) {
                                                ...
                                                if (nama != "" && !$('#is_otomatis').is(':checked')) {
                                                    ...
                                                    param = param.replaceAll(/[^A-Z0-9]/ig, "_");
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAddKodeRekening').click(function () {
            ...
            var tipeJurnal = $('#tipeJurnalId').val();
            if(tipeJurnal == ''){
                alert("Silahkan Pilih Tipe Jurnal");
            }
            else {
                $('#myForm')[0].reset();

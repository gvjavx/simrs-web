...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var idMappingJurnal = document.getElementById("mappingJurnalIdDelete").value;
            if (idMappingJurnal != '' ) {
                ...
                var msg = "";
                if (idMappingJurnal == '') {
                    msg += 'Field <strong>MappingJurnal ID</strong> not found.' + '<br/>';
                }
    ...
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/mappingJurnal" action="saveDelete_mappingJurnal" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Mapping Jurnal</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="mappingJurnalIdDelete" name="mappingJurnal.mappingJurnalId" required="true" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="mappingJurnalNameDelete" name="mappingJurnal.mappingJurnalName" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                </table>

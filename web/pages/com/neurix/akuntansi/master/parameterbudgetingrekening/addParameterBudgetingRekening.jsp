...
<table width="100%" align="center">
    <tr>
        <td align="center" >
            <s:form id="addParameterBudgetingRekeningForm" method="post" theme="simple"
                    namespace="/parameterbudgetingrekening" action="saveAdd_parameterbudgetingrekening" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Rekening Budgeting </legend>
                <table>
                    <tr>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="nama" name="parameterBudgetingRekening.nama"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addParameterBudgetingRekeningForm"
                                   id="save" name="save"

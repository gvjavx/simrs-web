...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="deleteJenisObatForm" method="post" theme="simple" namespace="/parameterbudgetingrekening"
                    action="saveDelete_parameterbudgetingrekening" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Rekening Budgeting</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="idJenisObatdelete" name="parameterBudgetingRekening.id" disabled="true"
                                             required="true" readonly="true" cssClass="form-control"/>

                                    <s:hidden id="idJenisObatdelete" name="parameterBudgetingRekening.id" />
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="parameterbudgetingrekeningAdd" name="parameterBudgetingRekening.nama" required="true"
                        ...
                        <td >
                            <table>
                                ...
                                <s:select cssStyle="margin-top: 7px; width: 100%" list="#rekening.listOfComboKodeRekening"
                                          id="koderekedit" name="parameterBudgetingRekening.rekeningId" readonly="true"

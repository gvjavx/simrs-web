...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            var reportIdAdd = document.getElementById("reportIdAdd").value;
            dwr.engine.setAsync(false);
            if (userIdAdd != ''&&reportIdAdd!='') {
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/settingReportUser" action="saveAdd_settingReportUser" cssClass="well form-horizontal">
                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add User Report</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboLaporan.listComboLaporanAkuntansi" id="reportIdAdd" name="settingReportUser.reportId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="userIdAdd" name="settingReportUser.userId" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                </table>

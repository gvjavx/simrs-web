...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var settingReportUserIdDelete = document.getElementById("settingReportUserIdDelete").value;
            if (settingReportUserIdDelete != '' ) {
    ...
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/settingReportUser" action="saveDelete_settingReportUser" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete User Report</legend>
                <table>
                    <tr>

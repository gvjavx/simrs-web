...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var idTrans = document.getElementById("transIdDelete").value;
            if (idTrans != '' ) {
            ...
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/trans" action="saveDelete_trans" cssClass="well form-horizontal">
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="transIdDelete" name="trans.transId" required="true" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="transNameDelete" name="trans.transName" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                </table>

...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var idTipeRekening = document.getElementById("tipeRekeningIdDelete").value;
            if (idTipeRekening != '' ) {
    ...
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/tipeRekening" action="saveDelete_tipeRekening" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Tipe Rekening</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="tipeRekeningIdDelete" name="tipeRekening.tipeRekeningId" required="true" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="tipeRekeningNameDelete" name="tipeRekening.tipeRekeningName" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                </table>

...
<head>
    ...
    $.subscribe('beforeProcessSaveAdd', function (event, data) {
        ...
        // var jenisbg = document.getElementById("jenisbg").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center" >
            <s:form id="addKtegoriParameterBudgetingForm" method="post" theme="simple"
                    namespace="/kategoriparameterbudgeting" action="saveAdd_kategoriparameterbudgeting" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Kategori Budgeting </legend>
                <table>
                    <tr>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="nama" name="kategoriParameterBudgeting.nama"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addKtegoriParameterBudgetingForm"
                                   id="save" name="save"

...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var idTipeJurnal = document.getElementById("tipeJurnalIdDelete").value;
            if (idTipeJurnal != '' ) {
    ...
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/tipeJurnal" action="saveDelete_tipeJurnal" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Tipe Jurnal</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="tipeJurnalIdDelete" name="tipeJurnal.tipeJurnalId" required="true" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="tipeJurnalNameDelete" name="tipeJurnal.tipeJurnalName" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="form-check">
                            <input type="checkbox"
                                   ...
                                   name="tipeJurnal.isOperasional" disabled="true">

...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='resultAddPengajuanSetorPph21_pengajuanSetor'/>";
        }
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-plus"></i> Pencarian Pengajuan Setor PPH21</h3>
                    </div>
                    <s:form id="addPengajuanSetorForm" enctype="multipart/form-data" method="post" namespace="/pengajuanSetor"
                            action="searchAddPengajuanSetorPph21_pengajuanSetor.action" theme="simple">
                        <div class="box-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8"  style="margin-top: 7px">
                                                ...
                                                <s:select cssClass="form-control" list="#comboBranch.listOfComboBranches" id="branch_id_view" name="pengajuanSetor.branchId" required="true" disabled="true"
                                                          listKey="branchId" listValue="branchName" headerKey="" headerValue="" />
                                                <s:hidden name="pengajuanSetor.branchId" id="branch_id" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="box-body col-md-offset-4">
                                ...
                                <div class="form-group" style="display: inline;">
                                    ...
                                    <a type="button" class="btn btn-warning" href="initFormPengajuanSetorPph21_pengajuanSetor.action">

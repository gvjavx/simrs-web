...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='resultAddPengajuanSetorPpn_pengajuanSetor'/>";
        }
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-plus"></i> Pencarian Pengajuan Setor PPN</h3>
                    </div>
                    <s:form id="addPengajuanSetorForm" enctype="multipart/form-data" method="post" namespace="/pengajuanSetor"
                            action="searchAddPengajuanSetorPpn_pengajuanSetor.action" theme="simple">
                        <div class="box-body">
                            ...
                            <div class="box-body col-md-offset-4">
                                ...
                                <div class="form-group" style="display: inline;">
                                    ...
                                    <a type="button" class="btn btn-warning" href="initFormPengajuanSetorPpn_pengajuanSetor.action">

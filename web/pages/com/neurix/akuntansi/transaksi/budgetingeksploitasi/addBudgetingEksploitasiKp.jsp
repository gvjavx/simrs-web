...
//            });
    ...
    function showDetail() {
        ...
        if (idParam == "PDTRJTDN"){
            ...
            BgEksploitasiAction.getListPendapatanTindakan(unit, tahun, "RJ", function (list) {
                $.each(list, function (i, item) {
                    str += "<tr>" +
        ...
        if (idParam == "PDTRITDN"){
            ...
            BgEksploitasiAction.getListPendapatanTindakan(unit, tahun, "RI", function (list) {
                $.each(list, function (i, item) {
                    str += "<tr>" +
                        "<td>"+item.namaTindakan+"</td>" +
                        "<td align='right'>"+ formatRupiah(item.harga)+"</td>" +
        ...
        if (idParam == "PDTRJOBT"){
            ...
            BgEksploitasiAction.getListPendapatanObat(unit, tahun, "RJ", function (list) {
                $.each(list, function (i, item) {
                    str += "<tr>" +
                        "<td>"+item.namaTindakan+"</td>" +
                        "<td align='right'>"+ formatRupiah(item.harga)+"</td>" +
        ...
        if (idParam == "PDTRIOBT"){
            ...
            BgEksploitasiAction.getListPendapatanObat(unit, tahun, "RI", function (list) {
                $.each(list, function (i, item) {
                    str += "<tr>" +
                        "<td>"+item.namaTindakan+"</td>" +
                        "<td align='right'>"+ formatRupiah(item.harga)+"</td>" +
    ...
    function addCoa() {
        ...
        dwr.engine.setAsync(true);
        BgEksploitasiAction.setPerhitunganToSession(idParam, stJson, function (res) {
            dwr.engine.setAsync(false);
            ...
            if (response.branchId == null && response.tahun == null){
                ...
                BudgetingAction.checkNilaiDasarByTahun(tahun, function(flag){
                    ...
                    if (flag == "Y"){
                        showDialog('loading');
                        dwr.engine.setAsync(true);
                        BgEksploitasiAction.saveAdd(unit, tahun, tipe, function (res) {
                            dwr.engine.setAsync(false);
                            if (res.status == "success"){
                               showDialog('success');
                               $('#ok_con').on('click', function () {

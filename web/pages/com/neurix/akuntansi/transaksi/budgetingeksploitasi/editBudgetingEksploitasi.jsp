...
<script type='text/javascript'>
    ...
    var tipeBudgeting = '<s:property value="budgeting.tipeBudgeting" />';
...
//            $(".btn-edit").hide();
    ...
    function detail(id){
        var host = firstpath()+"/bgeksploitasi/edit_bgeksploitasi.action?status="+status+"&id="+id+"&trans="+trans;
        post(host, form);
    }

    function refresh() {
        var host = firstpath()+"/bgeksploitasi/add_bgeksploitasi.action?status="+status+"&tipe=detail";
        post(host, form);
    }

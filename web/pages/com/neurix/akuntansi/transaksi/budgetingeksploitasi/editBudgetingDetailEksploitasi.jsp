...
<script type='text/javascript'>
    ...
    function back() {
        ...
        if (trans != "" && trans != null){
            var host = firstpath()+"/bgeksploitasi/edit_bgeksploitasi.action?status="+status+"&trans="+trans;
        } else {
            var host = firstpath()+"/bgeksploitasi/add_bgeksploitasi.action?status="+status+"&tipe=detail&trans="+trans;
        }
    ...
    function refresh() {
        var host = firstpath()+"/bgeksploitasi/edit_bgeksploitasi.action?status="+status+"&id="+rekeningid+"&tipe=detail&trans="+trans;
        post(host, form);
    }

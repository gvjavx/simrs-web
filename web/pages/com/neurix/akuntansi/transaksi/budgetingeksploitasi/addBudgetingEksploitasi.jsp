...
//            $("#btn-save").show();
    ...
    function refreshAdd() {
        var host = firstpath()+"/bgeksploitasi/add_bgeksploitasi.action?status=add";
        post(host);
    }
            ...
            if (response.branchId == null && response.tahun == null){
                ...
                BudgetingAction.checkNilaiDasarByTahun(tahun, function(flag){
                    ...
                    if (flag == "Y"){
                        ...
                        var host = firstpath()+"/bgeksploitasi/add_bgeksploitasi.action?status=addedi&tipe=detail&trans=ADD_DRAFT";
                        post(host, form);
                    } else {

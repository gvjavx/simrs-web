                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-horizontal">
                            ...
                            <input type="hidden" id="add-coa-tipe" value="nominasi" name="budgeting.tipeBudgeting"/>
                            <div class="row">
...
//            $("#btn-save").show();
    ...
    function refreshAdd() {
        var host = firstpath()+"/bgnominasi/add_bgnominasi.action?status=add";
        post(host);
    }
            ...
            if (response.branchId == null && response.tahun == null){
                ...
                BudgetingAction.checkNilaiDasarByTahun(tahun, function(flag){
                    if (flag == "Y"){
                        ...
                        var host = firstpath()+"/bgnominasi/add_bgnominasi.action?status=add&tipe=detail&trans=ADD_DRAFT";
                        post(host, form);
                    } else {

...
//            $(".btn-edit").hide();
    ...
    function detail(id){
        var host = firstpath()+"/bgnominasi/edit_bgnominasi.action?status="+status+"&id="+id+"&trans="+trans;
        post(host, form);
    }

    function refresh() {
        var host = firstpath()+"/bgnominasi/add_bgnominasi.action?status="+status+"&tipe=detail";
        post(host, form);
    }

...
<script type='text/javascript'>
    ...
    function changeAction(var1){
        ...
        if (unit != null || unit != ""){
            BudgetingAction.findLastStatus(unit, tahun, "investasi", function(response){
                var str = "";
                if (response.status != ""){
...
//                            "<td class='val-master-name' >"+item.masterName+"</td>"+
    ...
    function action(var1){
        ...
        if ((unit && tahun) != ""){
            ...
            var host = firstpath()+"/bginvestasi/edit_bginvestasi.action?status=edit&trans="+var1;
            post(host, form);
        } else {

...
<head>
    ...
    <script type='text/javascript' src='<s:url value="/dwr/interface/SewaLahanAction.js"/>'></script>
    ...
    <script type='text/javascript'>
        function link(){
            window.location.href="<s:url action='initForm_sewaLahan'/>";
        }
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="sewaLahanForm" method="post"  theme="simple" namespace="/sewaLahan" action="search_sewaLahan.action" cssClass="form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Unit </label>
                                    <div class="col-sm-4">
                                        <s:if test='sewaLahan.branchIdUser == "KP"'>
                                            <s:action id="initComboBranch" namespace="/admin/branch" name="initComboBranch_branch"/>
                                            <s:select list="#initComboBranch.listOfComboBranch" id="branchId" name="sewaLahan.branchId"
                                                      listKey="branchId" listValue="branchName" headerKey="" headerValue="[Select one]" cssClass="form-control select2"/>
                                        </s:if>
                                        <s:else>
                                            <s:action id="initComboBranch" namespace="/admin/branch" name="initComboBranch_branch"/>
                                            <s:select list="#initComboBranch.listOfComboBranch" id="branchIdView" name="sewaLahan.branchId" disabled="true"
                                                      listKey="branchId" listValue="branchName" headerKey="" headerValue="[Select one]" cssClass="form-control select2"/>
                                            <s:hidden id="branchId" name="sewaLahan.branchId" />
                                        </s:else>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <s:textfield id="sewaLahanId" name="sewaLahan.sewaLahanId"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <s:select list="#initComboVendor.listOfComboVendor" id="namaPenyewa" cssStyle="width: 100%;font-size: 10px"
                                                  listKey="nomorMaster" listValue="nama" headerKey="" headerValue="" name="sewaLahan.namaPenyewa" cssClass="form-control select2"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date"  style="margin-top: 7px">
                                            ...
                                            <s:textfield id="tgl1" name="sewaLahan.stTanggalDari" cssClass="form-control pull-right"
                                            />
                                            <div class="input-group-addon">
                                                s/d
                                            </div>
                                            ...
                                            <s:textfield id="tgl2" name="sewaLahan.stTanggalSelesai" cssClass="form-control pull-right"
                                            />
                                        </div>
                                        <script>
                                            $('#tgl1').datepicker({
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        <sj:submit type="button" cssClass="btn btn-primary" formIds="sewaLahanForm"
                                        ...
                                        <a id="btnAddSewaLahan" href="javascript:void(0)" class="btn btn-success" ><i class="fa fa-plus"></i> Add Penyewaan Lahan</a>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initForm_sewaLahan"/>'">
                    ...
                    <div style="text-align: left !important;">
                        ...
                        <div class="box-body">
                            <table id="tableSewaLahan" class="tableSewaLahan table table-bordered table-striped">
                                <thead >
                                <tr bgcolor="#90ee90">
                                ...
                                <s:iterator value="#session.listOfResult" var="row">
                                    <tr>
                                        <td style="text-align: center"><s:property value="sewaLahanId"/></td>
                                        ...
                                        <td style="text-align: right"><s:property value="stNilaiPpn"/></td>
                                        <td style="text-align: right"><s:property value="stNilaiPph"/></td>
                                        <td style="text-align: right"><s:property value="stNilaiNetto"/></td>
                                        <td align="center">
                                            <a href="javascript:;" data="<s:property value="%{#attr.row.sewaLahanId}"/>" class="item-view">
                                        ...
                                        <td align="center">
                                            <s:if test='#row.cancelFlag == "Y"'>
                                                ...
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.sewaLahanId}"/>" who="batal" class="item-view-approval">
                                            ...
                                            <s:else>
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.sewaLahanId}"/>" class="item-delete">
                                        ...
                                        <td align="center">
                                            ...
                                            <s:elseif test='#row.approvalFlag == "Y"'>
                                                <img border="0" src="<s:url value="/pages/images/icon_success.ico"/>" >
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.sewaLahanId}"/>" who="keu" class="item-view-approval">
                                                    <img border="0" src="<s:url value="/pages/images/icons8-search-25.png"/>" >
                                                </a>
                                            </s:elseif>
                                            <s:else>
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.sewaLahanId}"/>" class="item-posting">
                                        ...
                                        <td align="center">
                                            ...
                                            <s:elseif test='#row.approvalFlag == "Y"'>
                                                <a href="javascript:;" sewaLahanId="<s:property value="%{#attr.row.sewaLahanId}"/>" class="item-cetak-bukti">
    ...
    <div class="modal-dialog modal-flat" style="width: 1000px">
        <div class="modal-content">
                ...
                <div class="box">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-4" style="margin-top: 14px" >Nilai</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-4" style="margin-top: 14px" >PPN</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-4" style="margin-top: 14px" >PPH</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-4" style="margin-top: 14px" >Netto ( Nilai - PPN - PPH )</label>
                                    <div class="col-md-6">
            ...
            <div class="modal-footer" style="background-color: #cacaca">
                <button type="button" class="btn btn-success" id="btnSaveAddSewaLahan"><i class="fa fa-plus"></i> Add</button>
...
<script>
    $(document).ready(function () {
        $('#pilih_bank').hide();
        $('.tableSewaLahan').on('click', '.item-view', function() {
            var sewaLahanId = $(this).attr('data');
            $('#mod_view_penyewaan_lahan_id').val(sewaLahanId);
            SewaLahanAction.getForModalPopUp(sewaLahanId,function (data) {
        ...
        $('.tableSewaLahan').on('click', '.item-posting', function() {
            var sewaLahanId = $(this).attr('data');
            $('#mod_view_penyewaan_lahan_id').val(sewaLahanId);
            SewaLahanAction.getForModalPopUp(sewaLahanId,function (data) {
                $('#mod_view_branch_id').val(data.branchName);
        ...
        $('.tableSewaLahan').on('click', '.item-delete', function() {
            var sewaLahanId = $(this).attr('data');
            $('#mod_view_penyewaan_lahan_id').val(sewaLahanId);
            SewaLahanAction.getForModalPopUp(sewaLahanId,function (data) {
                $('#mod_view_branch_id').val(data.branchName);
        ...
        $('#btnPostingJurnal').click(function () {
            var sewaLahanId =  $('#mod_view_penyewaan_lahan_id').val();
            if (confirm("apakah anda ingin memposting transaksi dengan Penyewaan Lahan ID "+sewaLahanId +" ?")){
                SewaLahanAction.postingJurnal(sewaLahanId,function (data) {
                    alert(data);
        ...
        $('#btnCancelPenyewaan').click(function () {
            var sewaLahanId =  $('#mod_view_penyewaan_lahan_id').val();
            if (confirm("apakah anda ingin membatalkan transaksi dengan Penyewaan Lahan ID "+sewaLahanId +" ?")){
                SewaLahanAction.cancelSewaLahan(sewaLahanId,function (data) {
                    alert(data);
                    window.location.reload();
                })
            }
        ...
        $('#btnAddSewaLahan').click(function () {
            selectPembayaran();
        ...
        $('#btnSaveAddSewaLahan').click(function () {
            ...
            if (branchId!=""&&namaPenyewa!=""&&tanggal!=""&&nilai!=""&&metodeBayar!=""&&keterangan!=""&&nilaiPpn!=""&&nilaiNetto!=""){
                if (metodeBayar=="transfer"&&bank==""){
                    ...
                    if (confirm("Apakah anda ingin menambahkan data ini ?")){
                        // SewaLahanAction.saveAdd(branchId,namaPenyewa,tanggal,nilai,metodeBayar,keterangan,bank,nilaiPpn,nilaiPph,nilaiNetto,noFakturPajak,dataURL,function () {
                        SewaLahanAction.saveAdd(branchId,namaPenyewa,tanggal,nilai,metodeBayar,keterangan,bank,nilaiPpn,nilaiPph,nilaiNetto,'','',function () {
    ...
    $('#btnViewFaktur').click(function () {
        var url = $('#mod_view_url_faktur_image').val();
        var nomorFaktur =$('#mod_view_no_faktur').val();
        dwr.engine.setAsync(false);
        $('#modal-view-faktur').find('.modal-title').text(nomorFaktur);
        $("#my-image").attr("src", url);
        $('#modal-view-faktur').modal('show');
    });

    $('#tableSewaLahan').on('click', '.item-cetak-bukti', function() {
        var sewaLahanId = $(this).attr('sewaLahanId');
        var url = "cetakBuktiPembayaran_sewaLahan.action?sewaLahan.sewaLahanId="+sewaLahanId;
        window.open(url,'_blank');
    });

    $('.tableSewaLahan').on('click', '.item-view-approval', function() {
        var id = $(this).attr('data');
        var who = $(this).attr('who');
        var title ="View Keterangan ";

        SewaLahanAction.getViewApproval(id,function (data) {
            if (who=="batal"){
                title += " Pembatalan";

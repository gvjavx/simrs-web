            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <s:form id="addPembayaranUtangPiutangForm" enctype="multipart/form-data" method="post" namespace="/kas"
                        ...
                        <s:hidden name="kas.tipePembayaran" value="KK" />
                        <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-control" id="coa_asal" onchange="isiKeteterangan()" style="margin-top: 7px" name="kas.metodePembayaran">
                                                    <option value="" ></option>
                                                </select>
                                            </div>
                                        </div>
...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        ...
        $('#btnSaveDetailPembayaran').click(function () {
            ...
            if (statusDivisi=='Y'&& divisiId==""){
                ...
                console.log(tipePengajuanBiaya);
                if (tipePengajuanBiaya=="N"){
                    KasAction.saveKasDetail(kodeVendor,namaVendor,noNota,jumlahPembayaran,rekeningId,divisiId,divisiName,tipePengajuanBiaya,pengajuanBiayaDetailId,noBudgeting,function (result) {
                        if (result==""){
                            loadDetailPembayaran();
                            //dihitung totalbayarnya
                            var totalBayar = $('#bayar').val();
        ...
        $('.detailPembayaranTable').on('click', '.item-delete-data', function () {
            ...
            if (id!=''){
                KasAction.deleteDetailPembayaran(id,function (result) {
    ...
    function getTipePengajuan() {
        var tipeTransaksi = $('#tipe_transaksi option:selected').val();
        KasAction.getTipePengajuan(tipeTransaksi,function (response) {

                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <s:hidden id="tipe_transaksi_add" name="kas.tipeTransaksi" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-control" id="coa_asal" onchange="isiKeteterangan()" style="margin-top: 7px" name="kas.coaKas">
                                                    <option value="" ></option>
                                                </select>
                                            </div>
                                        </div>
            ...
            KasAction.searchDetailPembayaran(function (listdata) {
                ...
                $.each(listdata, function (i, item) {
                    ...
                    tmp_table += '<tr style="font-size: 12px;" ">' +
                        ...
                        '<td align="center">' + item.rekeningId + " | "+item.namaRekening+  '</td>' +
            ...
            KasAction.searchNotaPembayaran(masterId,transaksiId,branchId,'',coaLawan,function (listdata) {
                ...
                $.each(listdata, function (i, item) {
                    tmp_table += '<tr style="font-size: 12px;" ">' +
                        '<td align="center">' + (i + 1) + '</td>' +
                        '<td align="center">' + item.masterId + '</td>' +
                        '<td align="left">' + item.rekeningId +'</td>' +
                        '<td align="center">' + item.noNota + '</td>' +

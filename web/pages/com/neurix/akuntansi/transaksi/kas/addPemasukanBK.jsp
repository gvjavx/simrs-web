...
<head>
    ...
    <script type='text/javascript'>
        function confirm() {
            ...
            var status = "";
            KasAction.cekBeforeSave(tipeTransaksi, tanggal, metodeBayar, bayar, keterangan, noslipBank, branchId, function (result) {
                status = result;
            });
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <s:form id="addPembayaranUtangPiutangForm" enctype="multipart/form-data" method="post"
                            namespace="/kas"
                            action="saveAdd_kas.action" theme="simple">
                    <s:hidden name="kas.tipePembayaran" value="KM"/>
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <s:select list="#comboTrans.listOfComboTrans" id="tipe_transaksi"
                                                      ...
                                                      onchange="isiKeteterangan(),getTipeMaster(),getCoaLawan(),getCoaAsal()"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" id="coa_asal" onchange="isiKeteterangan()"
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <s:textfield id="divisi_id" onkeypress="$(this).css('border','')"
                                                         wajib="Y"
                                                         cssClass="form-control" cssStyle="margin-top: 7px"/>
                                            <script>
                                        ...
                                        <div class="col-md-5">
                                            <s:textfield id="nama_divisi" onkeypress="$(this).css('border','')"
                                                         readonly="true"
                                                         cssClass="form-control" cssStyle="margin-top: 7px"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4" style="margin-top: 7px">ID
                                            Vendor/Kary/Dokter/Pasien</label>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-5">
                                            <s:textfield id="nama_vendor" onkeypress="$(this).css('border','')"
                                                         readonly="true"
                                                         cssClass="form-control" cssStyle="margin-top: 7px"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:void(0)">
                                                <img style="margin-top: 10px" id="btnSearchNota" border="0"
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4" style="margin-top: 7px">Mata Uang</label>
                                        <div class="col-md-8">
                                            <select class="form-control" id="currencyId"
                                                    onchange="clearJumlahPembayaran()"
                                                    style="margin-top: 7px"
                                                    name="kas.currencyId">
                                                <option value=""></option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <s:textfield id="jumlah_pembayaran"
                                                     onkeypress="$(this).css('border','')" readonly="true"
                                                     wajib="Y" cssClass="form-control"
                                                     cssStyle="margin-top: 7px"
...
<script type='text/javascript'>
    ...
    function getCurrencyActive() {
        ...
        var option = '';
        AkunMataUangAction.getCurrency(function (res) {
            if (res.length > 0) {

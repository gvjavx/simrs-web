                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="kasForm" method="post"  theme="simple" namespace="/kas" action="searchKoreksi_kas.action" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        ...
                                        <a href="addKoreksi_kas.action" class="btn btn-success" ><i class="fa fa-plus"></i> Add Koreksi Kas/Bank</a>

                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initFormKoreksi_kas"/>'">

...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='initFormPemasukan_kas'/>";
        }
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Search Pemasukan Kas/Bank</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="kasForm" method="post"  theme="simple" namespace="/kas" action="searchPemasukan_kas.action" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Pemasukan Kas/Bank ID</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-4">Billing</label>
                                    <div class="col-sm-2">
                                        <s:select list="#{'Y':'Y','N':'N'}" cssStyle="margin-top: 7px"
                                                  id="status" name="kas.billing"
                                ...
                                <%--<div class="form-group">
                                    <label class="control-label col-sm-4">Billing</label>
                                    <div class="col-sm-8">
                                        <input type="checkbox" id="billing"  value="Y" style="width: 25px; height: 25px ;" name="kas.billing"  />
                                    </div>
                                </div>--%>
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        ...
                                        <a href="addPemasukan_kas.action" class="btn btn-success" ><i class="fa fa-plus"></i> Add Pemasukan Kas/Bank</a>

                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initFormPemasukan_kas"/>'">
                    ...
                    <div style="text-align: left !important;">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Pemasukan Kas/Bank</h3>
                        </div>
                        <div class="box-body">
                            <table id="tableKas" class="tableKas table table-bordered table-striped" style="font-size: 11px">
                                ...
                                <s:iterator value="#session.listOfResult" var="row">
                                    <tr>
                                        ...
                                        <td><s:property value="stBilling"/></td>
                                        ...
                                        <td align="center">
                                            <s:if test='#row.approvalKeuanganFlag == "Y"'>
                                                ...
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.kasId}"/>" who="keu" class="item-view-approval">
                                                    <img border="0" src="<s:url value="/pages/images/icons8-search-25.png"/>" >
                                                </a>
                                            </s:if>
                                        ...
                                        <td align="center">
                                            <s:if test='#row.approvalKasubKeuanganFlag == "Y"'>
                                                <img border="0" src="<s:url value="/pages/images/icon_success.ico"/>">
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.kasId}"/>" who="kasubkeu" class="item-view-approval">
                                                    <img border="0" src="<s:url value="/pages/images/icons8-search-25.png"/>" >
                                                </a>
                                            </s:if>
                                            <s:elseif test='#row.registeredFlag == "Y"'>
                                        ...
                                        <td align="center">
                                            <s:if test='#row.registeredFlag == "Y"'>
                                                <img border="0" src="<s:url value="/pages/images/icon_success.ico"/>"  >
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.kasId}"/>" who="kakeu" class="item-view-approval">
                                                    <img border="0" src="<s:url value="/pages/images/icons8-search-25.png"/>" >
                                                </a>
                                            </s:if>
...
<script>
    $(document).ready(function () {
        ...
        $('.tableKas').on('click', '.item-view', function() {
            ...
            $("#modal-posting-jurnal").find('.modal-title').text('View Pemasukan Kas/Bank');
        ...
        $('#btnApproveKeu').click(function () {
            ...
            var who = "keu";
            var flag ="Y";
            if (confirm("apakah anda ingin melakukan approve pemasukan dengan pembayaran id "+pembayaranId +" ?")){
        ...
        $('#btnNotApproveKeu').click(function () {
            ...
            var who = "keu";
            var flag ="N";
            if (confirm("apakah anda ingin melakukan not approve pemasukan dengan pembayaran id "+pembayaranId +" ?")){
                KasAction.approvePembayaran(pembayaranId,who,flag,function (listdata) {
                    alert(listdata);
                    window.location.reload();
                })
        ...
        $('#btnPostingJurnal').click(function () {
            var pembayaranId =  $('#mod_pembayaran_id').val();
            if (confirm("apakah anda ingin memposting pemasukan dengan pembayaran id "+pembayaranId +" ?")){

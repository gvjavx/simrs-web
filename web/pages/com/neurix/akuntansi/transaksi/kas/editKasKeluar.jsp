...
<head>
    ...
    <script type='text/javascript'>
        ...
        function confirmJkk() {
            ...
            var tipeTransaksi = $('#tipe_transaksi_edit').val();
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-plus"></i> Edit Kas Keluar</h3>
                    </div>
                    <s:form id="addPembayaranUtangPiutangForm" enctype="multipart/form-data" method="post" namespace="/kas"
                            action="saveEditKas_kas.action" theme="simple">
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <s:action id="comboTrans" namespace="/trans" name="initComboTransaksi_trans">
                                                    <s:param name="tipe">JKK</s:param>
                                                </s:action>
                                                <s:select list="#comboTrans.listOfComboTrans" id="tipe_transaksi" name="kas.tipeTransaksi" disabled="true"
                                                ...
                                                <s:hidden id="tipeMaster" name="kas.tipeMaster" />
                                                <s:hidden id="keperluan" />
                                                <s:hidden id="tipe_transaksi_edit" name="kas.tipeTransaksi" />
                                                <s:hidden id="tipePengajuan" name="kas.tipePengajuanBiaya" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group date" style="margin-top: 7px" id="st_tgl">
                                                    ...
                                                    <s:textfield id="tanggal" name="kas.stTanggal" disabled="true"
                                                                 cssClass="form-control datemask" onchange="$('#st_tgl').css('border','')"/>
                                                    <s:hidden name="kas.stTanggal"></s:hidden>
                                                    <script>
                                                        $("#tanggal").datepicker({
                                                            setDate: new Date(),
                                                            autoclose: true,
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-control" id="coa_asal" onchange="isiKeteterangan()" style="margin-top: 7px" name="kas.kodeRekening">
                                                    <option value="" ></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <s:action id="comboCurrency" namespace="/akunMataUang" name="initComboCurrency_akunMataUang">
                                                </s:action>
                                                <s:select list="#comboCurrency.listOfComboCurrency" id="currencyId" name="kas.currencyId"
                                                          cssStyle="margin-top: 7px"
                                                          listKey="kodeMataUang" listValue="kodeMataUang" headerKey="" headerValue="" cssClass="form-control" />
                                            </div>
                                            <%--
                                            <div class="col-md-7">
                                                <s:action id="comboCurrency" namespace="/akunMataUang" name="initComboCurrency_akunMataUang">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <s:textfield id="no_slip_bank" name="kas.noSlipBank" onkeypress="$(this).css('border','')" onchange="isiKeteterangan()"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group" style="display: inline;">
                                    ...
                                    <a type="button" class="btn btn-warning" href="initForm_kas.action">
                                    ...
                                    <sj:dialog id="info_dialog" openTopics="showInfoDialog" modal="true" resizable="false" closeOnEscape="false"
                                               ...
                                               buttons="{
                                                                                'OK':function() {
                                                                                         ...
                                                                                         window.location.href = 'initForm_kas.action';
                                                                                     }
                                                                            }"
                                    >
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $('#mod_pengajuan_detail_id').typeahead({
                                            ...
                                            updater: function (item) {
                                                ...
                                                var totalPpn  = nilaiJumlah*10/100;
                                                var totalPph  = nilaiJumlah*2/100;
                                                var jumlahPembayaran = nilaiJumlah - (totalPph+totalPpn);
                                                $('#mod_jumlah_pembayaran').val(formatRupiahAtas(jumlahPembayaran));
                                                $('#mod_total_pph').val(formatRupiahAtas(totalPph));
                                                $('#mod_total_ppn').val(formatRupiahAtas(totalPpn));
                            ...
                            <div class="form-group">
                                ...
                                <script>
                                    $('#btnScanFaktur').click(function () {
                                        ...
                                        if (namaVendor==""){
                                            alert("Masukkan vendor terlebiA dahulu");
                                        } else{
                                            $('.mod_scan_faktur').val('');
...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        ...
        getTipeMaster();
        getCoaAsal();
        var coaAsal = '<s:property value="kas.kodeRekening"/>';
        $('#coa_asal').val(coaAsal);
                ...
                if (nilaiPengajuan-(nilaiPembayaran+nilaiPph-nilaiPpn)<0){
                    ...
                    if (noFakturPajak==""){
                        if (confirm("Tidak memasukkan Faktur Pajak apakah anda ingin melanjutkan ?")){
                            KasAction.saveKasDetail(kodeVendor, namaVendor, "", jumlahPembayaran, rekeningId, divisiId,
                                divisiName, "", tipePengajuanBiaya, pengajuanBiayaDetailId, noBudgeting,jumlah_pph,jumlah_ppn,
                                noFakturPajak,dataURL, function (result) {
                                    if (result == "") {
                                        loadDetailPembayaran();
                                        ...
                                        $('#tipe_transaksi_edit').val($('#tipe_transaksi').val());
        ...
        window.loadDetailPembayaran = function () {
            ...
            KasAction.searchDetailPembayaran(function (listdata) {
                ...
                $.each(listdata, function (i, item) {
                    var namaVendor = item.masterName == null ? "" : item.masterName ;
                    var coa = item.rekeningId != "" ? item.rekeningId +" | "+item.namaRekening : "";
    ...
    function getDisableTrans() {
        ...
        if (tipeMaster=="pengajuan_biaya") {
            var coaLawan = $('#mod_coa_lawan option:selected').val();
        }
    ...
    $('#modBtnSearchNotaAdd').click(function () {
        ...
        if (add){
            KasAction.searchNotaPembayaran(masterId,transaksiId,branchId,'',coaLawan,function (listdata) {
                tmp_table = "<thead style='font-size: 14px' ><tr class='active'>" +
                    "<th style='text-align: center; color: #fff; background-color:  #30d196 '>No</th>" +
                    "<th style='text-align: center; color: #fff; background-color:  #30d196 '>Kode Vendor</th>" +
                    "<th style='text-align: center; color: #fff; background-color:  #30d196 ''>Rekening ID</th>" +

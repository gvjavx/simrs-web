            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-plus"></i> Edit Kas Masuk</h3>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group date" style="margin-top: 7px" id="st_tgl"
                                                ...
                                                <s:textfield id="tanggal" name="kas.stTanggal"
                                                             ...
                                                             onchange="$('#st_tgl').css('border','')" disabled="true"/>
                                                <s:hidden name="kas.stTanggal"/>
                                                <script>
                                                    $("#tanggal").datepicker({
                                                        setDate: new Date(),
                                                        autoclose: true,
                                    ...
                                    <div class="row">
                                        ...
                                        <script>console.log('<s:property value="kas.kodeRekening"/>') </script>
                                        <%--<div class="col-md-5" id="pilih_bank">
                                            <s:action id="initComboRekening" namespace="/kodeRekening" name="getKodeRekeningLawanByTransId_kodeRekening"/>
                                            <s:select list="#initComboRekening.listOfComboKodeRekening" cssClass="form-control select2" id="coa_asal"
                                                      cssStyle="margin-top: 7px" onchange="isiKeteterangan()"
                                                    name="kas.kodeRekening"
                                            />
                                        </div>--%>
                                        <div class="col-md-5" id="pilih_bank">
            ...
            if (statusDivisi == 'Y' && divisiId == "") {
                ...
                KasAction.saveKasDetail(kodeVendor, namaVendor, noNota, jumlahPembayaran, rekeningId, divisiId, divisiName, currency, function (result) {
                    if (result == "") {
                        ...
                        $('#currencyHide').val($('#currencyId option:selected').val());
                        $('#modal-add').modal('hide');
                    } else {
                        alert(result);
                    }

...
<head>
    ...
    <script type='text/javascript'>
        function confirm() {
            ...
            var tanggal  = $('#stTanggalKoreksi').val();
            var keterangan  = $('#keterangan').val();
            var branchId = $('#branch_id').val();
            var status ="";
            KoreksiAction.cekBeforeSaveKoreksi(tipeTransaksi,tanggal,keterangan,branchId,function (result) {
                status=result;
            })
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-user-plus"></i> Edit Koreksi / Penyesuaian</h3>
                    </div>
                    <s:form id="koreksiForm" enctype="multipart/form-data" method="post" namespace="/koreksi"
                            action="saveEditKoreksi_koreksi.action" theme="simple">
                        <s:hidden name="koreksi.tipePembayaran" value="KR" />
                        <div class="box-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <s:else>
                                                    <s:action id="comboBranch" namespace="/admin/user" name="initComboBranch_user"/>
                                                    <s:select cssClass="form-control" list="#comboBranch.listOfComboBranches" id="branch_id_view" name="koreksi.branchId" required="true" disabled="true"
                                                              listKey="branchId" listValue="branchName" headerKey="" headerValue="" />

                                                    <s:hidden name="koreksi.branchId" id="branch_id" />
                                                </s:else>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <s:select list="#comboTrans.listOfComboTrans" id="tipe_transaksi" name="koreksi.tipeTransaksi" disabled="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group date" style="margin-top: 7px" id="st_tgl">
                                                    ...
                                                    <s:textfield id="stTanggalKoreksi" name="koreksi.stTanggalKoreksi"
                                                                 cssClass="form-control datemask" onchange="$('#st_tgl').css('border','')"/>
                                                    <script>
                                                        $("#stTanggalKoreksi").datepicker({
                                                            setDate: new Date(),
                                                            autoclose: true,
                                                            changeMonth: true,
                                                            changeYear:true,
                                                        ...
                                                        $("#stTanggalKoreksi").datepicker("setDate", new Date());
                                                    </script>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <s:textarea id="keterangan" rows="3" cssStyle="margin-top: 7px" onkeypress="$(this).css('border','')"
                                                            name="koreksi.keterangan" cssClass="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group" style="display: inline;">
                                            <div class="col-sm-10 col-md-offset-4" style="margin-top: 7px">
                                                <button type="button" class="btn btn-success" id="btnSaveDetailKoreksiDebit"><i
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group" style="display: inline;">
                                            <div class="col-sm-10 col-md-offset-4" style="margin-top: 7px">
                                                <button type="button" class="btn btn-success" id="btnSaveDetailKoreksiKredit"><i
                                                        class="fa fa-save"></i> Add
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table style="width: 100%;"
                                                   class="detailKoreksiTable table table-bordered">
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group" style="display: inline;">
                                    ...
                                    <a type="button" class="btn btn-warning" href="initFormKoreksi_koreksi.action">
                                    ...
                                    <sj:dialog id="confirm_dialog" modal="true" resizable="false" closeOnEscape="false"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <sj:submit targets="crud" type="button" cssClass="btn btn-success"
                                                       formIds="koreksiForm" id="save" name="save"
                                    ...
                                    <sj:dialog id="info_dialog" openTopics="showInfoDialog" modal="true" resizable="false" closeOnEscape="false"
                                               ...
                                               buttons="{
                                                                                'OK':function() {
                                                                                         ...
                                                                                         window.location.href = 'initFormKoreksi_koreksi.action';
                                                                                     }
                                                                            }"
                                    >
...
<script type='text/javascript'>
    $(document).ready(function () {
        ...
        $('#btnSearchNotaDebit').click(function () {
            ...
            if (statusDivisi=='Y'&& divisiId==""){
                ...
                if (add){
                    KoreksiAction.searchNotaKoreksi(masterId,transaksiId,branchId,divisiId,coaLawan,function (listdata) {
        ...
        $('#btnSearchNotaKredit').click(function () {
            ...
            if (statusDivisi=='Y'&& divisiId==""){
                ...
                if (add){
                    KoreksiAction.searchDetailKoreksi(masterId,transaksiId,branchId,divisiId,coaLawan,function (listdata) {
                        tmp_table = "<thead style='font-size: 14px' ><tr class='active'>" +
                            "<th style='text-align: center; color: #fff; background-color:  #30d196 '>No</th>" +
            ...
            $.each(data, function (i, item) {
                ...
                if ($('#check_' + i).prop("checked") == true) {
                    if (kodeVendor!=''&&noNota!=''&&namaVendor!=''){
                        KoreksiAction.saveDetailKoreksi(kodeVendor,namaVendor,noNota,bayar,rekeningId,divisiId,divisiName,function (result) {
                            if (result==""){
                                loadDetailKoreksi();
        ...
        $('#btnSaveDetailKoreksiDebit').click(function () {
            var kodeVendor=$('#kode_vendor_debit').val();
            var namaVendor=$('#nama_vendor_debit').val();
            ...
            if (statusDivisi=='Y'&& divisiId==""){
                ...
                if (jumlahPembayaran!=""){
                    KoreksiAction.saveDetailKoreksi(kodeVendor,namaVendor,noNota,jumlahPembayaran,rekeningId,divisiId,divisiName,tipeTransaksi,function (result) {
                        if (result==""){
                            loadDetailKoreksi();
                        } else{
                            alert(result);
        ...
        $('#btnSaveDetailKoreksiKredit').click(function () {
            var kodeVendor=$('#kode_vendor_kredit').val();
            var namaVendor=$('#nama_vendor_kredit').val();
        ...
        $('.detailKoreksiTable').on('click', '.item-delete-data', function () {
            var rekeningId = $(this).attr('rekening') == 'null' ? "" : $(this).attr('rekening');
            var nonota = $(this).attr('data') == 'null' ? "" : $(this).attr('data');
            var vendor = $(this).attr('vendor') == 'null' ? "" : $(this).attr('vendor');
            var divisi = $(this).attr('divisi') == 'null' ? "" : $(this).attr('divisi');
            var biaya = $(this).attr('biaya') == 'null' ? "" : $(this).attr('biaya');
            KoreksiAction.deleteDetailKoreksi(rekeningId,divisi,vendor,nonota,biaya,function () {
        ...
        window.loadDetailKoreksi = function () {
            $('.detailKoreksiTable').find('tbody').remove();
            $('.detailKoreksiTable').find('thead').remove();
            dwr.engine.setAsync(false);
            var tmp_table = "";
            KoreksiAction.searchDetailKoreksi(function (listdata) {
                tmp_table = "<thead style='font-size: 14px' ><tr class='active'>" +
                    "<th style='text-align: center; color: #fff; background-color:  #30d196 '>No</th>" +
                ...
                $.each(listdata, function (i, item) {
                    ...
                    var namaCoa = item.namaCoa == null ? ""  : " | "+item.namaCoa;
                    var coa = item.kodeCoa != "" ? item.kodeCoa +namaCoa : "";
                    var kodeVendor = item.kodeVendor == null || item.kodeVendor == "" ? "" : item.kodeVendor;
                    var namaVendor = item.masterName == null || item.masterName == "" ? "" : item.masterName;
                    ...
                    tmp_table += '<tr style="font-size: 12px;" ">' +
                        ...
                        '<td align="center">' + item.noNota + '</td>' +
                        '<td align="center">' + stDebit.replace(/[,]/g,".")+ '</td>' +
                        '<td align="center">' + stKredit.replace(/[,]/g,".")+ '</td>' +
                        '<td align="center">' +
                        "<a href='javascript:;' class ='item-delete-data' data ='" + item.noNota + "' rekening ='" + item.kodeCoa+ "' vendor ='" + item.masterId + "' biaya ='" + item.stJumlahPembayaran + "' divisi ='" + item.divisiId + "'>" +
                ...
                tmp_table += '<tr style="font-size: 12px;" ">' +
                    ...
                    '<td align="center"> </td>' +
                    "</tr>";
                $('.detailKoreksiTable').append(tmp_table);
            });
        };
    ...
    function getTipeMaster() {
        var tipeTransaksi = $('#tipe_transaksi option:selected').val();
        KoreksiAction.getTipeMaster(tipeTransaksi,function (response) {
    ...
    function getDisableTransDebit() {
        ...
        var tipeTransaksi = $('#tipe_transaksi option:selected').val();
        KoreksiAction.getDisableTrans(tipeTransaksi,coaLawanDebit,function (res) {
            if (res.divisiId=="Y"){
    ...
    function getDisableTransKredit() {
        ...
        var tipeTransaksi = $('#tipe_transaksi option:selected').val();
        KoreksiAction.getDisableTrans(tipeTransaksi,coaLawanKredit,function (res) {
            if (res.divisiId=="Y"){
    ...
    $('#btnAddLampiran').click(function () {
        ...
        if (namaLampiran !=''&&canvas!=''){
            KoreksiAction.saveSessionLampiran(namaLampiran, dataURL, function (result) {
                if (result == "") {
                    loadLampiran();
    ...
    $('.tabelLampiran').on('click', '.item-delete-lampiran', function () {
        ...
        if (nama != '') {
            KoreksiAction.deleteSessionLampiran(nama, function (result) {
                alert("data berhasil dihapus");
                loadLampiran();
            });
        };
    ...
    $('.tabelLampiran').on('click', '.item-view-lampiran', function(){
        ...
        dwr.engine.setAsync(false);
        KoreksiAction.loadImageSessionLaporan(judul,function (data) {
    ...
    function loadDataEdit(){
        getCoaLawan();
        <%--$('#coa_kredit').val(<s:property value="koreksi.koreksiId"/>);--%>
        <%--$('#coa_debit').val(<s:property value="koreksi.koreksiId"/>);--%>

    }
    $(document).ready(function () {
        <%--console.log('<s:property value="koreksi.koreksiId"/>');--%>
        loadDataEdit();

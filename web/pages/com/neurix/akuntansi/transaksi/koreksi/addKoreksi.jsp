            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <s:form id="koreksiForm" enctype="multipart/form-data" method="post" namespace="/koreksi"
                            action="saveAddKoreksi_koreksi.action" theme="simple">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <s:select list="#comboTrans.listOfComboTrans" id="tipe_transaksi" name="koreksi.tipeTransaksi"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group date" style="margin-top: 7px" id="st_tgl">
                                                    ...
                                                    <s:textfield id="tanggal" name="koreksi.stTanggal"

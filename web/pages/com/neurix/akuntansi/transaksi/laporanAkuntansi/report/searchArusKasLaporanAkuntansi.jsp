    ...
    <script type='text/javascript'>
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            if ( unit != '' && periodeTahun != ''&& periodeBulan != ''&&tipePendapatan!=''&&reportId!='') {
                ...
                var url = "printLaporanArusKas_laporanAkuntansi.action?laporanAkuntansi.unit="+unit+"&laporanAkuntansi.tahun="+periodeTahun+"&laporanAkuntansi.bulan="+periodeBulan+"&laporanAkuntansi.tipeLaporan="+tipePendapatan+"&laporanAkuntansi.reportId="+reportId;
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Laporan Arus Kas</h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="laporanAkuntansiForm" method="post"  theme="simple" namespace="/laporanAkuntansi" action="printLaporanArusKas_laporanAkuntansi.action" cssClass="form-horizontal">
                                        <table>
                                            <tr>
                                        ...
                                        <div id="actions" class="form-actions">
                                            <table align="center">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="searchLaporanArusKas_laporanAkuntansi.action"/>'">

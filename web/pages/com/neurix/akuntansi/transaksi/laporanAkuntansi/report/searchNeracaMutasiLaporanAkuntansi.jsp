    ...
    <script type='text/javascript'>
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            if ( unit != '' && periodeTahun != ''&& periodeBulan != '') {
                ...
                var url = "printReportNeracaMutasi_laporanAkuntansi.action?tipeLaporan="+tipeLaporan+"&laporanAkuntansi.unit="+unit+"&laporanAkuntansi.tahun="+periodeTahun+"&laporanAkuntansi.bulan="+periodeBulan;

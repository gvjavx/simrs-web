    ...
    <script type='text/javascript'>
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            if ( unit != '' && periodeTahun != ''&& periodeBulan != ''&&reportId!='') {
                ...
                var url = "printReportNeracaMutasi_laporanAkuntansi.action?tipeLaporan="+tipeLaporan+"&laporanAkuntansi.unit="+unit+"&laporanAkuntansi.tahun="+periodeTahun+"&laporanAkuntansi.bulan="+periodeBulan+"&laporanAkuntansi.reportId="+reportId;
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Laporan Neraca Mutasi</h3>
                    </div>
                    <div class="box-body">

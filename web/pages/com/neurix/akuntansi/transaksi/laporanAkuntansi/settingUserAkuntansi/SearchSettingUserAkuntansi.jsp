...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Setting User Laporan Akuntansi
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Pencarian User Laporan Akuntansi</h3>
                    </div>
                    <div class="box-body">
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <s:form id="userLaporanAkuntansiForm" method="post"  theme="simple" namespace="/laporanAkuntansi" action="search_laporanAkuntansi.action" cssClass="form-horizontal">
                                        <table>
                                            <tr>
                                        ...
                                        <div id="actions" class="form-actions">
                                            <table align="center">
                                                <tr>
                                                    <td>
                                                        <sj:submit type="button" cssClass="btn btn-primary" formIds="userLaporanAkuntansiForm" id="search" name="search"
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <display:table name="listOfLaporanAkuntansi" class="table table-condensed table-striped table-hover"
                                                                       requestURI="paging_displaytag_setting_user_laporanAkuntansi.action" export="true" id="row" pagesize="14" style="font-size:10">

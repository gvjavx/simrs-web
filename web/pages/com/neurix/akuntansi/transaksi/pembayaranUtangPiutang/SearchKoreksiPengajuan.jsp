            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-filter"></i> Search Koreksi Pengajuan Biaya ( Dengan Uang Muka )</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <s:form id="pembayaranUtangPiutangForm" method="post"  theme="simple" namespace="/pembayaranUtangPiutang" action="searchKoreksiPengajuan_pembayaranUtangPiutang.action" cssClass="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <s:if test='pembayaranUtangPiutang.branchIdUser == "01"'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 7px">
                                        ...
                                        <a href="#" id="btnAddDetailPembayaran" class="btn btn-success" ><i class="fa fa-plus"></i> Add Koreksi Pengajuan</a>
                    ...
                    <div style="text-align: left !important;">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-th-list"></i> Daftar Koreksi Pengajuan Biaya ( Dengan Uang Muka )</h3>
                        </div>
                        <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control modal_pengajuan" id="mod_metode_bayar" style="margin-top: 7px">
                                        <option value="" ></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textfield id="mod_jumlah_uang_muka" cssClass="form-control modal_pengajuan" cssStyle="margin-top: 7px" placeholder="0" readonly="true" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textfield id="mod_jumlah_pembayaran" onkeypress="$(this).css('border','')"
                                                 cssClass="form-control modal_pengajuan" cssStyle="margin-top: 7px" onkeyup="formatRupiah2(this),hitungNilaiNettoBruto(this.value)" />
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textfield id="mod_total_ppn" cssClass="form-control modal_pengajuan" onkeyup="formatRupiah2(this),hitungNilaiNettoPpn(this.value)" cssStyle="margin-top: 7px" placeholder="0" />
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textfield id="mod_total_pph" cssClass="form-control modal_pengajuan" cssStyle="margin-top: 7px;" onkeyup="formatRupiah2(this),hitungNilaiNettoPph(this.value)" placeholder="0"/>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textfield id="mod_netto" cssClass="form-control modal_pengajuan" cssStyle="margin-top: 7px;" readonly="true" placeholder="0"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <s:textarea id="mod_keterangan_pengajuan" onkeypress="$(this).css('border','')" cssStyle="margin-top: 7px" cssClass="form-control"/>
                                    <br>
                                </div>
                            </div>
                            <br>
                            ...
                            if (noFakturPajak==""){
                                if (confirm("Tidak ada faktur pajak, apakah anda ingin melanjutkan ?")){
                                    if (confirm("Do you want to save this record ?")){
                                        PembayaranUtangPiutangAction.saveAddKoreksiPengajuan(pengajuanId,kodeRekeningLawan,metodeBayar,stJumlahPembayaran,stNetto,stPpn,stPph,

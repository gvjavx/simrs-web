...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSaveRefreshLembur', function (event, data) {
            var groupId = document.getElementById("appGroupId").value;
            ...
            if (branchId != '' && groupId !='') {
                ...
                if (branchId === '') {
                    msg += '<strong>Unit </strong>tidak didapatkan.' + '<br/>';
                }
                if (groupId === '') {
                    msg += '<strong>Group Id </strong>tidak didapatkan.' + '<br/>';
                }
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addFormRefreshLembur" method="post" theme="simple" namespace="/refreshLembur" action="approveRefresh_refreshLembur" cssClass="well form-horizontal">

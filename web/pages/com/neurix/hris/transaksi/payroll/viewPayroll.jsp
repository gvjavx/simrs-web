            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> View Payroll</h3>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="row" id="totalAMod">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="kopkar" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Iuran Sp</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="iuranSp" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Iuran PIIKB</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="iuranPiiKb" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Bank BRI</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="bankBri" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Bank Mandiri</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="bankMandiri" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Infaq</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="infaq" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Perkes dan Obat</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="perkesDanObat" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Listrik</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="listrik" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Iuran Profesi</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="iuranProfesi" name="nip" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" >Potongan Lain</label>
                                <div class="col-sm-6">
                                    <input style="text-align: right"  type="text" class="form-control nip" readonly id="potonganLain" name="nip" >
                                </div>
                            </div>
                        </div>
                    </div>

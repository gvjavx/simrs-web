...
<div class="content-wrapper">
    ...
    <section class="content">
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="sppdForm" method="post"  theme="simple" namespace="/payroll" action="edit_payroll.action" cssClass="well form-horizontal">
            ...
            <div class="modal-body" align="left">
                <form class="form-horizontal" id="formEdit">
                    ...
                    <div class="form-group">
                        ...
                        <input style="display: none" readonly type="text" class="form-control nip" id="payrollId" name="nip">
                        <div class="col-sm-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <input style="padding-left: 8px; padding-right: 0px" readonly type="text" class="form-control nip" id="golongan" name="nip">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="padding-left: 0px;">
                            <a href="javascript:;" class="detailGaji" >
                        ...
                        <div class="col-sm-2">
                            <%--<input style="text-align: right" type="text" class="form-control nip" id="pphGaji" onfocusout="updateDataPayroll(this.id, this.value)">--%>
                            <input style="text-align: right" type="text" onfocusout="updateNilai(this.id, this.value)" class="form-control nip" id="pphGaji" readonly >
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input style="text-align: right" readonly type="text" class="form-control nip" id="pengobatan" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input style="text-align: right" readonly type="text" class="form-control nip" id="pphPengobatan" >
                        </div>
                        <div class="col-md-1" style="padding-left: 0px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input style="text-align: right" type="text" class="form-control nip" id="tunjPeralihan" onfocusout="updateNilai(this.id, this.value)">
                        </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" >Pengobatan</label>
                        <div class="col-sm-2">
                            <input style="text-align: right" type="text" class="form-control nip" id="tunjPengobatan" readonly>
                            <%--<input style="text-align: right" type="text" class="form-control nip" id="tunjPengobatan" onfocusout="updateDataPayroll(this.id, this.value)">--%>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-1" >Tunj. Pph</label>
                        <div class="col-sm-2">
                            <input style="text-align: right" type="text" class="form-control nip" onfocusout="updateNilai(this.id, this.value)" id="tunjPph" readonly>
                            <%--<input style="text-align: right" type="text" class="form-control nip" id="tunjPph" onfocusout="updateDataPayroll(this.id, this.value)">--%>
                        </div>
                        <div class="col-sm-2">
...
<script>
    $('#btnSave').click(function(){
        ...
        var pphPengobatan = document.getElementById("pphPengobatan").value;
        ...
        if (confirm('Apakah Anda ingin merubah Data?')) {
            ...
            if(tipe == "PR" || tipe == "R"){
                PayrollAction.saveEditData(payrollId, tunjanganPeralihan, kompensasi, transport, uangMukaLain, kurangBpjs, koperasi, dansos,
                        ...
                        flagPerumahan, flagKalkulasiPph, pphGaji, tunjPph, pphPengobatan,  flagKalkulasiPphObat, function(listdata) {
    ...
    $(document).ready(function() {
        ...
        $('.tablePayroll').on('click', '.item-edit', function(){
            ...
            PayrollAction.getDetailEdit(payrollId, function(listdata){
                ...
                $('#jasprodGolongan').val(listdata.golonganName);
                ...
                if(listdata.flagPayroll == 'Y'){
                    ...
                    $('#checkPerumahan').show();
                    $('.detailLembur').show();
                }else if(listdata.flagJasprod == 'Y'){
    ...
    $('.item-reproses').on('click', function(){
        var nip = $(this).attr('nip');
        ...
        var payrollId = $(this).attr('payrollId');
        //alert(nip + ' - ' + branchId + ' - ' + bulan + ' - ' + tahun + ' - ' + payrollId);
        if (confirm('Apakah Anda ingin meproses ulang Data ' + nama + '?')) {
            PayrollAction.reprosesPayroll(payrollId, nip, branchId, bulan, tahun, function(listdata) {
                        alert('Reproses ' + nama + ' Berhasil');
                    });
        }
    });
    ...
    window.updateNilai = function(id, a){
        ...
        if(isnum == true){
            ...
            if(tipe == "PR" || tipe == "R"){
                PayrollAction.saveEditSessionDataUsingPayrollId(payrollId, tunjanganPeralihan, kompensasi, transport, uangMukaLain, kurangBpjs, koperasi, dansos,
                        sp, bazis, bapor, lainLain, tunjLain, flagJubileum, flagPensiun, tipePegawai, gaji, lembur, pengobatan,
                        flagListrikAir, flagPerumahan, flagKalkulasiPph, pphGaji, tunjPph, pphObat, flagKalkulasiPphPengobatan, function(listdata) {
                            reloadDataModal();
                        });
            }else if(tipe == "JP"){
                //alert("2");
    ...
    window.updateDataPayroll = function(id, a){
        ...
        var pengobatan = document.getElementById("tunjPengobatan").value;
        var tunjPph = document.getElementById("tunjPph").value;
        var pphGaji = document.getElementById("pphGaji").value;
        /*var pphPengobatan = document.getElementById("pphPengobatan").value;
        var pengobatan = document.getElementById("pengobatan").value;*/

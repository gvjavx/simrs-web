...
<head>
    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function() {
            window.loadRapelDetail =  function(nip){
                ...
                PayrollAction.loadRapelDetail(nip, function(listdata) {
                    ...
                    tmp_table = "<thead style='font-size: 13px; color: white; white-space: nowrap' ><tr class='active'>"+
                            ...
                            "<th style='text-align: center; background-color:  #3c8dbc''>Peralihan Lama</th>"+
                            "<th style='text-align: center; background-color:  #3c8dbc''>Peralihan Baru</th>"+
                    ...
                    $.each(listdata, function (i, item) {
                        ...
                        tmp_table += '<tr style="font-size: 12px; white-space: nowrap">' +
                                ...
                                '<td align="center">' + item.peralihanLama  + '</td>' +
                                '<td align="center">' + item.peralihanBaru + '</td>' +
...
<div class="content-wrapper">
    ...
    <section class="content">
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <%--<s:form id="sppdForm" method="post"  theme="simple" namespace="/payroll" action="searchSession_payroll.action" cssClass="well form-horizontal">--%>
                    <s:form id="sppdForm" method="post"  theme="simple" namespace="/payroll" action="saveAdd_payroll.action" cssClass="well form-horizontal">
                        ...
                        <div id="actions" class="form-actions">
                            <table align="center">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning" onclick="menujuLink('refreshData_payroll.action', 'merefresh data');">
                                            <i class="fa fa-refresh"></i> Refresh
                                        </button>
                                    </td>
                                    <td>
                                        <sj:submit targets="crsud" type="button" cssClass="btn btn-success" formIds="sppdForm" id="save" name="save"
                                        ...
                                        <%--<input type="submit" formaction="saveAdd_payroll.action" name="action" value="FirstServlet">--%>
                                        <%--<button type="button" class="btn btn-success" onclick="menujuLink('saveAdd_payroll.action', 'menyimpan data');">
                                    ...
                                    <td align="center">
                                        ...
                                        <display:table name="listDataPayroll" class="tablePayroll table table-condensed table-striped table-hover"
                                            ...
                                            <display:column media="html" title="Edit">
                                                <a href="javascript:;" data="<s:property value="%{#attr.row.nip}"/>" class="item-edit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" align="left">
                    <form class="form-horizontal" id="formEdit">
                        ...
                        <div class="form-group">
                            <label style="padding-left: 0px; padding-right: 0px" class="control-label col-sm-1" >PJS</label>
                            <div class="col-sm-2">
                                <input type="checkbox" id="checkPjs" class="checkApprove" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <h4>A. Penerimaan Income </h4>
                            </div>

                            <div class="col-sm-4">
                                <h4>B. Potongan (Reduce)</h4>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-1" >PPh Gaji </label>
                            <div class="col-sm-2">
                                <input readonly style="text-align: right"  type="text" class="form-control nip" id="pphGaji" name="nip">
                            </div>

                            <div class="col-md-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="detailPphGaji" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                                <input onchange="disableReadOnly()" type="checkbox" id="checkKalkulasiPph" name="checkKalkulasiPph" class="checkApprove">
                            </div>

                            <%--<div class="col-md-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="editPphGaji" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>--%>

                            <label class="control-label col-sm-1" >Pengobatan</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="pengobatan" name="nip">
                            </div>
                            <div id="detailPengobatan" class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="detailPengobatan">
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="detailPphPengobatan" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-edit"></span>
                                </a>
                            </div>

                            <label class="control-label col-sm-1" >Koperasi</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="koperasi" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="dansos" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-2" >Iuran Bpjs Tk</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="iuranBpjsTk" name="nip">
                            </div>

                            <label class="control-label col-sm-2" >SP</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="sp" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="iuranBpjsPensiun" name="nip">
                            </div>

                            <label class="control-label col-sm-2" >Bazis</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="bazis" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-2" >Bapor</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="bapor" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-1" >Kompensasi</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="kompensasi" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                            <label class="control-label col-sm-2" >Uang Muka Lain</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="uangMukaLain" onfocusout="updateNilai(this.id, this.value)">
                            </div>

                            <label class="control-label col-sm-2" >Zakat Profesi</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="zakatProfesi" name="nip">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-1" >Transport</label>
                            <div class="col-sm-2">
                                <input style="text-align: right"  type="text" class="form-control nip" id="transport" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                            <label class="control-label col-sm-2" >Kurang Bpjs</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="kekuranganIuranBpjs" onfocusout="updateNilai(this.id, this.value)">
                            </div>

                            <label class="control-label col-sm-2" >Lain - lain</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="lainLain" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                            <%--<div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="detailBiayaLainLain">
                                    <span style="font-size: 25px" class="fa fa-edit"></span>
                                </a>
                            </div>--%>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-1" >Listrik Air</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="listrikAir" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <input onchange="changeJubileumNPensiun()" type="checkbox" id="checkListrikAir" name="checkListrikAir" class="checkApprove">
                            </div>
                            ...
                            <label class="control-label col-sm-2" >Total C</label>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-1" >Perumahan</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="tunjPerumahan" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <input onchange="changeJubileumNPensiun()" type="checkbox" id="checkPerumahan" name="checkperumahan" class="checkApprove">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-1" >Pengobatan</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="tunjPengobatan" name="nip">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input style="text-align: right" type="text" class="form-control nip" id="tunjLain" onfocusout="updateNilai(this.id, this.value)">
                            </div>
                            <div class="col-sm-1">
                            </div>
                            <label class="control-label col-sm-1" >Rapel</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="rapel" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;" class="detailLembur">
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>

                            <label class="control-label col-sm-1" >THR</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="thr" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailThr">
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-1" >Pendidikan</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="pendidikan" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailPendidikan" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-1" >Jasprod</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="jasprod" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailJasprod" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-1" ><b>Gaji Bersih (A-B-C) + D</b></label>
                            <div class="col-sm-2">
                            ...
                            <label class="control-label col-sm-1" >Insentif</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="insentif" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailInsentif" >
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1" style="text-align: right">
                                <input onchange="changeJubileumNPensiun()" type="checkbox" id="checkApproveJubileum" name="checkApproveJubileum" class="checkApprove">
                                <label class="control-label " >Jubilium: </label>
                            </div>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="jubileum" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailJubileum">
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1" style="text-align: right">
                                <input onchange="changeJubileumNPensiun()" type="checkbox" id="checkApprovePensiun" name="checkApprovePensiun" class="checkApprove">
                                <label class="control-label " >Pensiun: </label>
                            </div>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="pensiun" name="nip">
                            </div>
                            <div class="col-sm-1" style="padding-left: 0px;">
                                <a href="javascript:;"  data="a"  class="detailPensiun">
                                    <span style="font-size: 25px" class="glyphicon glyphicon-search"></span>
                                </a>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-1" >Total D</label>
                            <div class="col-sm-2">
                                <input style="text-align: right" readonly type="text" class="form-control nip" id="totalD" name="nip">
                            </div>
            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="text-align: right" readonly type="text" class="form-control nip" id="jasprodTotal" name="nip">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <div class="form-group">
                        <label style="padding-left: 0px" class="control-label col-sm-4" >A. Perhitungan</label>
                        <div class="col-sm-6">
                            <input style="text-align: right" readonly type="text" class="form-control nip" id="jasprodPerhitungan" name="nip">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" >B. Gaji Kotor X Faktor</label>
                        <div class="col-sm-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    ...
                    <hr>
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Pensiun</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Penghargaan</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Perumahan</label>
                        <div class="col-sm-3">
                            <input style="text-align: right" readonly type="text" class="form-control nip" id="pensiunTotalPenghargaan" name="nip">
                        </div>
...
<div id="modal-biayaLainLain" class="modal fade modal2" role="dialog">
    <div class="modal-dialog " style="width: 700px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a type="button" class="btn btn-success" id="btnDetailLain" data-dismiss="modal">Save</a>
                <a type="button" class="btn btn-default" data-dismiss="modal">Close</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog " style="width:700px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    <div class="form-group">
                        <label class="control-label col-sm-5" style="padding-right:0px;">Bulan Aktif</label>
                        <div class="col-sm-4">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrBulanAktif" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2" >
                            <input style="text-align: right; padding-left: 5px; padding-right: 9px;" readonly type="text"
                                   class="form-control" id="rapelDetailThrPeralihanBaru" name="nip">
                        </div>

                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrPeralihanLama" >
                        </div>
                        <div class="col-sm-1">
                            <label class="control-label" style="text-align: center;"> = </label>
                        </div>
                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrSelisihPeralihan" >
                        </div>
                    </div>
                    ...
                    <%--Total--%>
                    <div class="form-group">
                        <label class="control-label col-sm-5" style="padding-right:0px;">Total THR Baru - Total THR Lama</label>
                        <div class="col-sm-2" >
                            <input style="text-align: right; padding-left: 5px; padding-right: 9px;" readonly type="text"
                                   class="form-control" id="rapelDetailThrTotalBaru" name="nip">
                        </div>

                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrTotalLama" >
                        </div>
                        <div class="col-sm-1">
                            <label class="control-label" style="text-align: center;"> = </label>
                        </div>
                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrSelisihTotal" >
                        </div>
                    </div>

                    <%--Total Bersih--%>
                    <div class="form-group">
                        <label class="control-label col-sm-5" style="padding-right:0px;">Total Bersih THR Baru - Total Bersih THR Lama</label>
                        <div class="col-sm-2" >
                            <input style="text-align: right; padding-left: 5px; padding-right: 9px;" readonly type="text"
                                   class="form-control" id="rapelDetailThrTotalBersihBaru" name="nip">
                        </div>

                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrTotalBersihLama" >
                        </div>
                        <div class="col-sm-1">
                            <label class="control-label" style="text-align: center;"> = </label>
                        </div>
                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailThrSelisihBersihTotal" >
                        </div>
                    </div>
            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2" >
                            <input style="text-align: right; padding-left: 5px; padding-right: 9px;" readonly type="text"
                                   class="form-control" id="rapelDetailPendidikanPeralihanBaru" name="nip">
                        </div>

                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailPendidikanPeralihanLama" >
                        </div>
                        <div class="col-sm-1">
                            <label class="control-label" style="text-align: center;"> = </label>
                        </div>
                        <div class="col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailPendidikanSelisihPeralihan" >
                        </div>
                    </div>
                    ...
                    <%--Total Detail Rapel Pendidikan--%>
                    <div class="form-group">
                        <label class="control-label col-sm-10" style="padding-right:0px;">Selisih Rapel Pendidikan</label>
                        <div class=" col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailPendidikanTotal" >
                        </div>
                    </div>

                    <%--Selisih Rapel Pendidikan--%>
                    <div class="form-group">
                        <label class="control-label col-sm-10" style="padding-right:0px;">Jumlah Bulan</label>
                        <div class=" col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailPendidikanJumlahBulan" >
                        </div>
                    </div>

                    <%--Rapel Pendidikan--%>
                    <div class="form-group">
                        <label class="control-label col-sm-10" style="padding-right:0px;">Jumlah Rapel Pendidikan</label>
                        <div class=" col-sm-2">
                            <input style="text-align: right; padding-left: 5px" readonly type="text" class="form-control nip" id="rapelDetailPendidikanJumlahRapel" >
                        </div>
                    </div>
...
<div id="modal-konsisten" class="modal fade modal2" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" >Periode sebelumnya</label>
                        <div class="col-sm-6">
                            <input style="text-align: left" readonly type="text" class="form-control nip" id="konsistensiSebelumnya" name="nip">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-4" >Periode Sekarang</label>
                        <div class="col-sm-6">
                            <input style="text-align: left" readonly type="text" class="form-control nip" id="konsistensiSekarang">
                        </div>
                    </div>

                    <hr>

                    <table style="width: 100%;" id="tabelDetailKonsisten" class="tabelDetailKonsisten table table-bordered"></table>
                </form>
            </div>
            <div class="modal-footer">
                <a type="button" class="btn btn-default" data-dismiss="modal">Close</a>
...
<div id="modal-dataLembur" class="modal fade modal2" role="dialog">
    <div class="modal-dialog " style="width:400px;">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" >
                <form class="form-horizontal" >
                    <div class="form-group">
                        <label class="control-label col-sm-5" style="padding-right:0px;">Jumlah Biaya Lembur</label>
                        <div class="col-sm-7" >
                            <input style="text-align: left; padding-left: 5px; padding-right: 3px;" type="text" class="form-control nip" id="fieldBiayaLembur" name="nip">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <a id="btnSimpanBiayaLembur" type="button" class="btn btn-success" >Simpan</a>
                <a type="button" class="btn btn-default" data-dismiss="modal">Close</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog " style="width:800px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                ...
                <table style="width: 100%;" id="tabelDetailGaji" class="tabelDetailGaji table table-bordered"></table>
            </div>
            <div class="modal-footer">
...
<script>
    $(document).ready(function() {
        ...
        window.menujuLink = function(param, param2){
            if (confirm('Apakah Anda ingin '+param2+'?')) {
        ...
        window.searchData = function(){
            ...
            PayrollAction.searchSession(nip, function(listdata) {
                location.reload();
            });
        }
        ...
        $('#btnSave').click(function(){
            if (confirm('Apakah Anda ingin merubah Data?')) {
                PayrollAction.saveEditPersonalSession(function(listdata) {
        ...
        $('.detailJasprod').on('click', function(){
            ...
            PayrollAction.getDetailJasprod(nip, function(listdata){
                if(listdata.flagJasprod == 'Y'){
                    $('#jasprodMasKer1').val(listdata.masaKerja);
                    $('#jasprodGolongan').val(listdata.golongan);
                    $('#jasprodPoint').val(listdata.point);
                    ...
                    $('#jasprodTotal').val(listdata.gajiBruto);
                    $('#jasprodPengali').val(listdata.gajiMasaKerja);
                    $('#jasprodFaktor').val(listdata.faktor);
                    $('#jasprodNilaiSmk').val(listdata.nilaiSmk);
                    $('#jasprodPersenSmk').val(listdata.persenSmk);
        ...
        $('.detailInsentif').on('click', function(){
            var nip = document.getElementById("nip").value;
            PayrollAction.getDetailInsentif(nip, function(listdata){
        ...
        $('.detailJubileum').on('click', function(){
            ...
            PayrollAction.getDetailJubileum(nip, function(listdata){
            ...
            $('#modal-jubileum').find('.modal-title').text('Komposisi Jubilium');
        ...
        $('.detailRapelThr').on('click', function(){
            ...
            PayrollAction.getDetailRapelThr(nip, function(listdata){
                $('#rapelDetailThrBulanAktif').val(listdata.bulanAktif);
                $('#rapelDetailThrGadasLama').val(listdata.thrGajiGolonganLama);
                $('#rapelDetailThrUmkLama').val(listdata.thrUmkLama);
                $('#rapelDetailThrPeralihanLama').val(listdata.thrPeralihanLama);
                ...
                $('#rapelDetailThrPeralihanBaru').val(listdata.thrPeralihanBaru);
                ...
                $('#rapelDetailThrTotalBaru').val(listdata.totalRapelBaru);
                $('#rapelDetailThrTotalLama').val(listdata.totalRapelLama);
                $('#rapelDetailThrSelisihTotal').val(listdata.totalRapelSelisihBaru);

                $('#rapelDetailThrTotalBersihBaru').val(listdata.totalRapelBersihBaru);
                $('#rapelDetailThrTotalBersihLama').val(listdata.totalRapelBersihLama);
                $('#rapelDetailThrSelisihBersihTotal').val(listdata.totalRapelSelisihBaru);

                $('#rapelDetailThrSelisihGadas').val(listdata.thrGajiGolonganSelisihBaru);
                $('#rapelDetailThrSelisihPeralihan').val(listdata.thrPeralihanSelisihBaru);
        ...
        $('.detailRapelJubileum').on('click', function(){
            ...
            PayrollAction.getDetailRapelJubileum(nip, function(listdata){
                ...
                $('#rapelDetailJubileumSubTotal').val(listdata.totalRapelSelisih);
        ...
        $('.detailRapelInsentif').on('click', function(){
            ...
            PayrollAction.getDetailRapelInsentif(nip, function(listdata){
                if(listdata != null){
        ...
        $('.detailRapelPendidikan').on('click', function(){
            ...
            PayrollAction.getDetailRapelPendidikan(nip, function(listdata){
                $('#rapelDetailPendidikanGadasLama').val(listdata.pendidikanGajiGolonganLama);
                $('#rapelDetailPendidikanPeralihanLama').val(listdata.pendidikanPeralihanLama);
                ...
                $('#rapelDetailPendidikanPeralihanBaru').val(listdata.pendidikanPeralihanBaru);
                ...
                $('#rapelDetailPendidikanSelisihPeralihan').val(listdata.pendidikanPeralihanSelisihBaru);
                ...
                $('#rapelDetailPendidikanTotal').val(listdata.totalRapelSelisih);
                $('#rapelDetailPendidikanJumlahBulan').val(listdata.bulanAktif);
                $('#rapelDetailPendidikanJumlahRapel').val(listdata.totalRapelSelisihBaru);
            });
        ...
        $('.detailRapelLembur').on('click', function(){
            ...
            PayrollAction.getDetailRapelLembur(nip, function(listdata){
                tmp_table = "<thead style='font-size: 13px; color: white; white-space: nowrap' ><tr class='active'>" +
            ...
            $('#rapelDetailLemburTotal').val(numberWithCommas(hasil));
            $('#modal-rapel-lembur').find('.modal-title').text('Detail Rapel Lembur');
            $('#modal-rapel-lembur').modal('show');
        });

        $('.detailKonsisten').on('click', function(){
            //alert('aa');
        });

        $('.detailPensiun').on('click', function(){
            var nip = document.getElementById("nip").value;
            PayrollAction.getDetailPensiun(nip, function(listdata){
                ...
                $('#pensiunTgl2').val(listdata.stTanggalPayroll);
                $('#pensiunGolongan').val(listdata.golongan);
                ...
                $('#pensiunJumlah').val(listdata.hasil);
                $('#pensiunUangPensiun').val(listdata.hasil);
                $('#pensiunFaktorPensiun').val(listdata.faktorPensiun);
                $('#pensiunKaliPensiun').val(listdata.hasilKaliFaktorPensiun);
                $('#pensiunUangPenghargaan').val(listdata.hasil);
                $('#pensiunFaktorPenghargaan').val(listdata.faktorPenghargaan);
                $('#pensiunKaliPenghargaan').val(listdata.hasilKaliFaktorPenghargaan);
        ...
        $('.detailRapel').on('click', function(){
            ...
            PayrollAction.getDetailRapel(nip, function(listdata){
        ...
        $('.detailLembur').on('click', function(){
            ...
            if(branchId == "KD01"){
                ...
                $('#modal-dataLembur').find('.modal-title').text('Edit Biaya Lembur');
                $('#modal-dataLembur').modal('show');
            }
        });
        ...
        $('.detailThr').on('click', function(){
            ...
            PayrollAction.getDetailThr(nip, function(listdata){
        ...
        $('.detailBiayaLainLain').on('click', function(){
            var nip = document.getElementById("nip").value;
            PayrollAction.searchPotonganLain(nip, function(listdata){
                if(listdata != null){
        ...
        $('.detailPendidikan').on('click', function(){
            ...
            var nip = document.getElementById("nip").value;
            PayrollAction.getDetailPendidikan(nip, function(listdata){
        ...
        $('.detailPphGaji').on('click', function(){
            ...
            PayrollAction.getDetailPph(nip, function(listdata){
        ...
        $('.detailPphBulan').on('click', function(){
            ...
            PayrollAction.payrollDetailPphTahun('2019', nip, function(listdata){
                ...
                /*if(window.myDataTablePphBulan){
                    window.myDataTablePphBulan.destroy();
                    window.myDataTablePphBulan = $("#tableDetailPphBulan").DataTable();
                }else{
                    window.myDataTablePphBulan = $("#tableDetailPphBulan").DataTable();
                }*/
            });
        ...
        $('.tablePayroll').on('click', '.item-edit', function(){
            ...
            PayrollAction.getDetailAdd(nip, function(listdata){
                ...
                if(listdata.flagPjs == "Y"){
                    document.getElementById("checkPjs").checked = true;
                }else{
                    document.getElementById("checkPjs").checked = false;
                }
                ...
                if(listdata.flagPayroll == "Y"){
                    ...
                    $('#kompensasi').attr('readonly', true);
                    $('#transport').attr('readonly', true);
                    $('#tunjLain').attr('readonly', true);
                    $('#pphGaji').attr('readonly', true);
                    $('#uangMukaLain').attr('readonly', true);
                    $('#kekuranganIuranBpjs').attr('readonly', true);
                    $('#koperasi').attr('readonly', true);
                    $('#dansos').attr('readonly', true);
                    $('#sp').attr('readonly', true);
                    $('#bazis').attr('readonly', true);
                    $('#bapor').attr('readonly', true);
                    $('#lainLain').attr('readonly', true);
                }
        ...
        $('.tablePayroll').on('click', '.item-konsisten', function(){
            var nip = $(this).attr('data');
            var bulan = $(this).attr('bulan');
            var tahun = $(this).attr('tahun');
            var tmp_table = "";

            $('#konsistensiSekarang').val(convertBulan(bulan) + " " + tahun);
            $('#konsistensiSebelumnya').val(periodeSebelumnya(bulan, tahun));

            $('.tabelDetailKonsisten').find('tbody').remove();
            $('.tabelDetailKonsisten').find('thead').remove();
            $('.tabelDetailKonsisten').find('tfoot').remove();
            tmp_table = "<thead style='color: white; font-size: 14px' ><tr class='active'>"+
                    "<th style='text-align: center; background-color:  #3c8dbc'>Jenis Detail</th>"+
                    "<th style='text-align: center; background-color:  #3c8dbc''>Bulan Sebelumnya</th>"+
                    "<th style='text-align: center; background-color:  #3c8dbc''>Bulan Sekarang</th>"+
                    "<th style='text-align: center; background-color:  #3c8dbc''>Detail</th>"+
                    "</tr></thead>";
            PayrollAction.showKonsistensiGaji(nip, bulan, tahun, function(listdata){
                tmp_table += '<tr  ">' +
                        '<td>Gaji Kotor</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strGajiKotorSebelumnya + '</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strGajiKotor + '</td>' +
                        '<td align="center"> '+ compareGaji(listdata.gajiKotorSebelumnya, listdata.gajiKotor) +' </td>' +
                        "</tr>";

                tmp_table += '<tr  ">' +
                        '<td>Potongan (Reduce)</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strReduceSebelumnya + '</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strReduce + '</td>' +
                        '<td align="center">' + compareGaji(listdata.reduceSebelumnya, listdata.reduce) + '</td>' +
                        "</tr>";

                tmp_table += '<tr  ">' +
                        '<td>Potongan lain - lain</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strLainLainSebelumnya + '</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strLainLain + '</td>' +
                        '<td align="center">' + compareGaji(listdata.lainLainSebelumnya, listdata.lainLain) + '</td>' +
                        "</tr>";

                tmp_table += '<tr  ">' +
                        '<td>Penambahan</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strPenambahanSebelumnya + '</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strPenambahan + '</td>' +
                        '<td align="center">' + compareGaji(listdata.penambahanSebelumnya, listdata.penambahan) +'</td>' +
                        "</tr>";

                tmp_table += '<tr  ">' +
                        '<td>Gaji Bersih</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strNilaiSebelumnya+ '</td>' +
                        '<td style="text-align: right" align="center">' + listdata.strNilai + '</td>' +
                        '<td align="center"> - </td>' +
                        "</tr>";
            });

            $('.tabelDetailKonsisten').append(tmp_table);

            $('#modal-konsisten').find('.modal-title').text('Perbedaan gaji bulan sebelumnya');
            $('#modal-konsisten').modal('show');
        });
        ...
        $('#btnDetailLain').on('click', function(){
            ...
            PayrollAction.potonganLain(nip, keterangan1, keterangan2, keterangan3, keterangan4, keterangan5, biaya1, biaya2, biaya3,
                    biaya4, biaya5, total, function(listdata){
                        //alert('Record has been saved successfully');
                        //$('#myFormLainLain')[0].reset();
            });
        ...
        $('.btnCariGaji').on('click', function(){
            ...
            var splitTglAwal = tglAwal.split("-");
            var splitTglAkhir = tglAkhir.split("-");
            ...
            if(tglAwal == '' || tglAkhir == ''){
                ...
                dwr.engine.setAsync(false);
                var tmp_table = "";
                PayrollAction.listGajiHarian(nip, branchId, tglAwal, tglAkhir, function(listdata) {
                    tmp_table = "<thead style='color: white' ><tr class='active'>"+
                            "<th style='text-align: center; background-color:  #3c8dbc'><input type='checkbox' onclick='check_uncheck_checkbox(this.checked)' class='checkApprove' id='checkAll'></th>"+
                            "<th style='text-align: center; background-color:  #3c8dbc'>Tanggal</th>"+
                    ...
                    $.each(listdata, function (i, item) {
                        ...
                        var status = "";
                        if(item.status == "Y"){
                            combo = '<input disabled type="checkbox" id="checkApprove" name="checkAll" value="'+item.stTnggal+'" class="checkApprove" ' +
                                    'onchange="hitungCentang()">';
                        }else{
                            if(item.checked == "Y"){
                                combo = '<input checked type="checkbox" id="checkApprove" name="checkAll" value="'+item.stTnggal+'" class="checkApprove" ' +
                                        'onchange="hitungCentang()">';
                            }else{
                                combo = '<input type="checkbox" id="checkApprove" name="checkAll" value="'+item.stTnggal+'" class="checkApprove" ' +
                                        'onchange="hitungCentang()">';
                            }
                        }
            ...
            /*if(splitTglAkhir[1] > (blnSekarang + 1)){
                alert('bulan akhir tidak boleh melebihi bulan sekarang ');
            }else{
                if(tglAwal == '' || tglAkhir == ''){
                    alert('Tanggal Awal dan Tanggal Akhir harus diisi!');
                }else{
        ...
        $('#btnApprove').click(function(){
            ...
            if(values.length > 0){
                if (confirm('Are you sure you want to save this Record?')) {
                    dwr.engine.setAsync(false);
                    var nip = document.getElementById('nip').value;
                    PayrollAction.removeSessionGajiPkwt(nip);
                    $.each($("input[name='checkAll']:checked"), function() {
                        PayrollAction.saveSessionGajiPkwt(nip, $(this).val(), function(listdata) {
    ...
    window.Comma = function(Num) { //function to add commas to textboxes
        Num += '';
    ...
    window.changeJubileumNPensiun = function(){
        ...
        var tunjanganLain = document.getElementById("tunjLain").value;
        ...
        var lembur = document.getElementById("tunjLembur").value;
        var pengobatan = document.getElementById("fieldBiayaPengobatan").value;
        var pphPengobatan = document.getElementById("pphPengobatanBayar").value;
        ...
        var flagKalkulasiPphPengobatan = "N";
        ...
        if($('#checkKalkulasiPphPengobatan').is(":checked")){
            flagKalkulasiPphPengobatan = "Y";
        }else{
            flagKalkulasiPphPengobatan = "N";
        }
        ...
        PayrollAction.saveEditSessionData(nip, tunjanganPeralihan, kompensasi, transport, uangMukaLain, kurangBpjs, koperasi, dansos,
                sp, bazis, bapor, lainLain, tunjanganLain, flagJubileum, flagPensiun, tipePegawai, gaji, lembur, pengobatan, flagListrikAir,
                flagPerumahan, pphPengobatan, pphGaji, flagKalkulasiPph, flagKalkulasiPphPengobatan, function(listdata) {
                    alert('Data Berhasil Dirubah');
                    reloadDataModal();
                });
    }
    ...
    window.periodeSebelumnya = function(indexBulan, indexTahun){
        var strPeriode = "";
        var intBulan = parseInt(indexBulan);
        var intTahun = parseInt(indexTahun);

        intBulan = intBulan - 1;

        if(intBulan < 1){
            intTahun = intTahun - 1 ;
            strPeriode = "Desember " + intTahun ;
        }else{
            strPeriode = convertBulan(intBulan) + " " + intTahun;
        }

        return strPeriode;
    }

    window.convertBulan =  function(indexBulan){
        var strBulan = "";
    ...
    window.compareGaji = function(gajiSebelum, gajiSekarang, nip, bulan, tahun){
        var hasil = "";
        if(gajiSekarang < gajiSebelum){
            hasil = "<a href='javascript:;' class='detailJubileum' style='color: red'>" + "Kurang" + "</a>";
        }else if(gajiSekarang > gajiSebelum){
            hasil = "<a href='javascript:;' class='detailKonsisten' nip = '"+nip+"' style='color: red'>" + "Lebih" + "</a>";
        }else{
            hasil = "<a href='javascript:;' class='detailKonsisten' nip = '"+nip+"' style='color: green'>" + "Sama" + "</a>";
        }
        return hasil;
    }
</script>
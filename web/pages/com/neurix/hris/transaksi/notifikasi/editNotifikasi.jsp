...
//                }
                ...
                if (tipeNotifName == '') {
                    msg += 'Field <strong>Tipe Notfif Name</strong> is required.' + '<br/>';
                }
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/notifikasi" action="saveEdit_notifikasi" cssClass="well form-horizontal">

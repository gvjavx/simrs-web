    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function() {
            ...
            $.subscribe('beforeProcessSave', function (event, data) {
                var id             = document.getElementById("evaluasiPegawaiAspekDetailId").value;
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="smkForm" method="post"  theme="simple" namespace="/smk" action="saveEditAspekDetail_smk.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <%--<s:property value="%{smk.editNilai}"/>--%>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <a href="javascript:;"
                                           ...
                                           id2 = "<s:property value="%{#attr.row.evaluasiPegawaiAspekId}"/>"
                                           bulan="<s:property value="%{#attr.row.bulan}"/>" class="viewNilaiBulan">
                                            <s:if test="%{smk.editNilai}">
                                    ...
                                    <td>
                                        <s:if test="%{smk.editNilai}">
                                            <s:if test="%{smk.editRealisasi}">
                                                <sj:submit targets="crsud" type="button" cssClass="btn btn-primary" formIds="smkForm" id="save" name="save"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.listAspekMonthly').on('click', '.viewNilaiBulan', function(){
            ...
            var bulan = $(this).attr('bulan');
            var tahun = document.getElementById('periodeId').value;

            loadDatePicker(bulan, tahun);
        ...
        window.loadDatePicker= function(bulan, tahun)
        {
            var tanggal = "1-" + bulan + "-" + tahun  ;
            //alert(tanggal);
        ...
        $('.btnAddKejadian').on('click', function(){
            ...
            $('#modal-view-peristiwa').find('.modal-title').text('Tambah Peristiwa');
            $('#modal-view-peristiwa').modal('show');
        });

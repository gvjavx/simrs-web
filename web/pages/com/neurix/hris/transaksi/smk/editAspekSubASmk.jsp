            ...
            <div class="modal-body" >
                <form class="form-horizontal" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control nip" id="nilaiBulan">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control nip" id="nilaiValue" name="nip">
                        </div>
                    </div>
                </form>
                    ...
                    <s:form id="sppdForm" method="post"  theme="simple" namespace="/smk" action="saveEditAspekADetail_smk.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:textfield  id="uraian" name="smk.indikatorKinerja" readonly="true" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:if test="%{smk.editNilai}">
                                            <s:textfield  id="nilai" name="smk.nilai" readonly="false" cssClass="form-control"/>
                                        </s:if>
                                        <s:else>
                                            <s:textfield  id="nilai" name="smk.nilai" readonly="true" cssClass="form-control"/>
                                        </s:else>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        <sj:dialog id="view_dialog_menu" openTopics="showDialogMenu" modal="true"
                                                   height="350" width="400" autoOpen="false"
                                                   title="Aspek A">
                                            <center><img border="0" src="<s:url value="/pages/images/loading11.gif"/>" alt="Loading..."/></center>
                                        </sj:dialog>

                                        <s:set name="listAspekMonthlyA" value="#session.listAspekMonthlyA" scope="request" />
                                        <display:table name="listAspekMonthlyA" class="listAspekMonthlyA table table-condensed table-striped table-hover"
                                                       requestURI="paging_displaytag_department.action" id="row" pagesize="14" style="font-size:10">
                                            <display:column media="html" title="Peristiwa">
                                                <s:if test="#attr.row.flagYes">
                                                    <a href="javascript:;"
                                                       id="<s:property value="%{#attr.row.aspekActivityMonthly}"/>"
                                                       aspekDetail="<s:property value="%{#attr.row.evaluasiPegawaiAspekDetailId}"/>"
                                                       activityId="<s:property value="%{#attr.row.activityId}"/>"
                                                       class="viewNilaiBulan">
                                                        <img border="0" src="<s:url value="/pages/images/icon_lup.ico"/>" name="icon_edit">
                                                    </a>
                                                </s:if>
                                            </display:column>
                                            <display:column media="html" title="Nilai">
                                                <s:if test="#attr.row.flagYes">
                                                    ...
                                                    <s:if test="#attr.row.editNilai">
                                                    </s:if>
                                                </s:if>
                                            </display:column>

                                            <display:column property="checkList" sortable="true" title="Sub Aspek" />
                                            <display:column property="jan" sortable="true" title="1" />
                                            <display:column property="feb" sortable="true" title="2"  />
                                            <display:column property="mar" sortable="true" title="3"  />
                                            <display:column property="apr" sortable="true" title="4"  />
                                            <display:column property="mei" sortable="true" title="5"  />
                                            <display:column property="jun" sortable="true" title="6"  />
                                            <display:column property="jul" sortable="true" title="7"  />
                                            <display:column property="ags" sortable="true" title="8"  />
                                            <display:column property="sep" sortable="true" title="9"  />
                                            <display:column property="okt" sortable="true" title="10"  />
                                            <display:column property="nov" sortable="true" title="11"  />
                                            <display:column property="des" sortable="true" title="12"  />
                                            <display:column property="rataRata" sortable="true" title="Rata - rata"  />
                                            <%--<display:footer>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.listAspekMonthlyA').on('click', '.editNilaiBulan', function(){
            var id = $(this).attr('id');
            var aspekDetail = $(this).attr('aspekDetail');
            var activityId = $(this).attr('activityId');

            $('#nilaiId').val(activityId);
            $('#nilaiValue').val(0);
        ...
        $('#btnSaveNilai').click(function(){
            ...
            if (confirm('Apakah Anda ingin merubah Data?')) {
                SmkAction.saveNilaiSubAspekA(id, bulan, nilai, function(listdata) {
                    alert('Data Berhasil Dirubah');
        ...
        $('.listAspekMonthlyA').on('click', '.viewNilaiBulan', function(){
            var aspekActivitymonthly = $(this).attr('activityId');
            ...
            SmkAction.aspekPeristiwa(aspekActivitymonthly, function(listdata) {
        ...
        $('#btnSavePeristiwa').click(function(){
            ...
            SmkAction.getIdMonthly(id, tanggal, function(listdata) {
                idMonthly = listdata;
            });
            if(tanggal != '' && peristiwa != ''){
                if (confirm('Apakah Anda ingin Menambahkan Data?')) {
                    SmkAction.saveAddPeristiwa(idMonthly, tanggal, peristiwa, function(listdata) {
                        if(listdata == 'success'){
...
<s:if test="#attr.row.flagYes">
<s:url var="urlEdit" namespace="/smk" action="addNilaiSubAspekA_smk" escapeAmp="false">
    <s:param name="id"><s:property value="#attr.row.aspekActivityMonthly"/></s:param>
    <s:param name="bulan"><s:property value="#attr.row.bulan"/></s:param>
    <s:param name="activityId"><s:property value="#attr.row.activityId"/></s:param>
</s:url>

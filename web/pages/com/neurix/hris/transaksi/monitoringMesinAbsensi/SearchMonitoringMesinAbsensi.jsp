...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="notifikasiForm" method="post"  theme="simple" namespace="/monitoringmesinabsensi" action="search_monitoringmesinabsensi.action" cssClass="well form-horizontal">

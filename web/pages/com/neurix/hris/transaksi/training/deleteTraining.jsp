            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Delete Training</h3>
                    </div>

                    <form role="form" method="post" name="training" id="training" action="saveDelete_training.action">
                        <div class="box-body">
                                ...
                                <table align="center">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <s:hidden name="training.tipeTraining"></s:hidden>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <s:textfield id="trainingName" name="training.trainingName" cssClass="form-control" cssStyle="margin-top: -25px;margin-left: 20px;" readonly="true"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <s:textfield id="tanggalStart" name="training.stTanggalStart" cssClass="form-control"
                                                         required="false"  cssStyle="margin-top: -25px;margin-left: 20px;" readonly="true"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <center>
                                        <table>
                                            <tr>
                                                <td>
                                                    <table>
                                                        <sj:submit targets="crud" type="button" cssClass="btn btn-warning" formIds="training" id="save" name="save"
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <display:table name="listOfResultBukti" class="table table-condensed table-striped table-hover"
                                                ...
                                                <display:column property="trainingPersonId" sortable="true" title="T. Person ID" />
                                                <display:column property="trainingDocId" sortable="true" title="ID Dokumen" />

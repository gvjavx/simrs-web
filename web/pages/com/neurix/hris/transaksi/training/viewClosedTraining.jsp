...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="closeForm" method="post" theme="simple" namespace="/training" action="saveClose_training" cssClass="well form-horizontal">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:textfield id="kota" name="training.kota" cssClass="form-control" cssStyle="display: none" readonly="true"/>
                                <s:textfield id="instansi" name="training.instansi" cssClass="form-control" cssStyle="display: none" readonly="true"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textarea id="note" name="training.closedNote" cssClass="form-control" rows="4"/>
                            </table>
                        </td>
                    </tr>
                </table>
                ...
                <div class="form-group">
                    <div class="col-md-12 col-sm-12">
                        <center>
                            <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="closeForm" id="save" name="save"

    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessDeleteLembur', function (event, data) {
            if (confirm('Do you want to delete this record ?')) {
                var id=document.getElementById("lemburId").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addFormLembur" method="post" theme="simple" namespace="/lembur" action="saveDelete_lembur" cssClass="well form-horizontal">
                        ...
                        <td>
                            <table>
                                <div class="input-group date">
                                    ...
                                    <s:textfield id="tglAwal" name="lembur.stTanggalAwal" readonly="true" cssClass="form-control pull-right"
                                    ...
                                    <s:textfield id="tglAkhir" name="lembur.stTanggalAkhir" readonly="true" size="12" cssClass="form-control pull-right"
                        ...
                        <td>
                            <table>
                                <div class="input-group date">
                                    ...
                                    <s:textfield id="jamAwal" name="lembur.jamAwal" readonly="true" size="12" cssClass="form-control pull-right" onchange="onChange()"
                                                 required="false" cssStyle=""/>
                                    <div class="input-group-addon">
                                        s/d
                                    </div>
                                    ...
                                    <s:textfield id="jamAkhir" name="lembur.jamAkhir" readonly="true" size="12" cssClass="form-control pull-right" onchange="onChange()"
                                                 required="false" cssStyle=""/>
                                </div>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <s:textarea rows="4" id="keterangan" name="lembur.keterangan" required="false" readonly="true" cssClass="form-control"/>
                                    </td>
                                </tr>
                            </table>
                        </td>

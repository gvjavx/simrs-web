                    ...
                    <s:form id="mutasiKualifikasiForm" method="post"  theme="simple" namespace="/mutasi" action="searchMutasiKualifikasi_mutasi.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            <tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <s:select list="#initComboBranch.listOfComboBranch" id="branchId" name="mutasi.branchLamaId" onchange="listPosisi()"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <select id="positionId" name="mutasi.positionLamaId" class="form-control" onchange="isiPosisiBaru()"></select>
                                        <s:textfield name="mutasi.positionBaruId" id="posisiBaru" cssStyle="display: none" ></s:textfield>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:select list="#{'promosi' : 'Promosi', 'rotasi':'Rotasi'}" cssClass="form-control"
                                                  name="mutasi.status"/>
                                    </table>
...
<script>
    $(document).ready(function() {
        ...
        listPosisi();
        $('#positionId').val(document.getElementById("posisiBaru").value).change();
...
//    }
    ...
    window.listPosisi = function () {
        ...
        $('#positionId').append($("<option></option>")
                .attr("value", '')
                .text(''));
        PositionAction.searchPosition2(branch, function (listdata) {
            $.each(listdata, function (i, item) {
                $('#positionId').append($("<option></option>")
    ...
    window.isiPosisiBaru= function () {
        $('#posisiBaru').val(document.getElementById("positionId").value);
    }

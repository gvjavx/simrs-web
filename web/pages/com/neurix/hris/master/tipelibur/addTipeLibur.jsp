...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var tipLiburName = $("#tipeLiburName").val()
...
<s:form id="addForm" method="post" theme="simple" namespace="/tipelibur" action="save_tipelibur" cssClass="well form-horizontal">
    ...
    <legend align="left">Add Tipe Libur</legend>

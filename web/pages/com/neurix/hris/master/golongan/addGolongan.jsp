...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/golongan" action="saveAdd_golongan" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Golongan</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="level1" name="golongan.stLevel" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

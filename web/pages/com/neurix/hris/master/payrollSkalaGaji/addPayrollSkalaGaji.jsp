...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollSkalaGajiForm" method="post" theme="simple" namespace="/payrollSkalaGaji" action="saveAdd_payrollSkalaGaji" cssClass="well form-horizontal">
...
<%--
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="noSk" name="payrollSkalaGaji.noSk" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollSkalaGaji" action="saveDelete_payrollSkalaGaji" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Skala Gaji</legend>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select cssClass="form-control" list="#comboPeriode.listOfComboPeriode" id="tahunPayroll3"

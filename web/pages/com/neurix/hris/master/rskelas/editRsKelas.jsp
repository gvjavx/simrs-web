...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            var rsKelasId = '<s:property value="rsKelas.rsKelasId"/>';
            var kelas = '<s:property value="rsKelas.kelas"/>';
...
<s:form id="editForm" method="post" theme="simple" namespace="/rskelas" action="saveEdit_rskelas" cssClass="well form-horizontal">
    ...
    <legend align="left">Edit Data Rs Kelas</legend>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8" align="left">
            <s:select cssClass="form-control" list="#{'Y':'Active', 'N':'NonActive'}" id="flag" name="rsKelas.flag"
                      headerKey="" headerValue="[Select one]"/>
        </div>
    </div>

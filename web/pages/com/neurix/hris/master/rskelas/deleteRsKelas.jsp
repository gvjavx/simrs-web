...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var tipeLiburId = '<s:property value="rsKelas.rsKelasId"/>';
            var tipeLiburName = '<s:property value="rsKelas.kelas"/>';
...
<s:form id="deleteForm" method="post" theme="simple" namespace="/rskelas" action="saveDelete_rskelas" cssClass="well form-horizontal">

    <legend align="left">Delete Data Rs Kelas</legend>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Rs Kelas Id :</label>
        <div class="col-sm-8">
            <s:textfield cssClass="form-control" id="rsKelasId" name="rsKelas.rsKelasId" readonly="true" required="true" />
            <s:hidden id="createdDate" name="rsKelas.createdDate" />
            <s:hidden id="createdWho" name="rsKelas.createdWho" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <s:hidden name="rsKelas.rsId"></s:hidden>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <s:select list="#comboKelompok.listOfComboKelompokPosition" id="kelompokId" name="rsKelas.kelompokId"
                      ...
                      cssClass="form-control" disabled="true"/>
            <s:hidden name="rsKelas.kelompokId"></s:hidden>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <s:select list="#comboGolongan.listOfComboGolongan" id="golonganId" name="rsKelas.golonganId"
                      ...
                      cssClass="form-control" disabled="true"/>
            <s:hidden name="rsKelas.golonganId"></s:hidden>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <s:textfield id="kelas" cssClass="form-control" name="rsKelas.kelas" required="false" disabled="false" readonly="true"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <s:select list="#comboBranch.listOfComboBranches" id="branchId" name="rsKelas.branchId"
                      ...
                      cssClass="form-control" disabled="true"/>
            <s:hidden name="rsKelas.branchId"></s:hidden>
        </div>
    </div>

            ...
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollSkalaGajiPensiunDplk" action="saveEdit_payrollSkalaGajiPensiunDplk" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="point1" name="payrollSkalaGajiPensiunDplk.poin" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="nilai1" name="payrollSkalaGajiPensiunDplk.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

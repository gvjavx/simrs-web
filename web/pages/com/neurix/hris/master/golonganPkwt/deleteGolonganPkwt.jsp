...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/golongan" action="saveDeletePkwt_golongan" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Golongan Pkwt</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="golonganPkwtName1" name="golonganPkwt.golonganPkwtName" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

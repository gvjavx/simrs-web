        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" id="searchForm" action="search_tunjangan.action">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <table align="center">
                                    <tr>
                                        <td>
                                            <label>Tunjangan Id </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <s:textfield id="tunjanganId" name="tunjangan.tunjanganId" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label>Tunjangan Name </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <s:textfield id="tunjanganName" name="tunjangan.tunjanganName" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <s:select list="#{'N':'Non-Active'}" id="flag" name="tunjangan.flag"
                            ...
                            <div class="box-footer">
                                <table align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <s:url var="urlAdd" namespace="/tunjangan" action="add_tunjangan" escapeAmp="false">
                                            </s:url>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-default" onclick="window.location.href='<s:url action="initForm_tunjangan"/>'">
                                            ...
                                            <display:table name="listOfAlat" class="table table-condensed table-striped table-hover"
                                                ...
                                                <display:column media="html" title="Edit">
                                                    <s:if test="#attr.row.flagYes">
                                                        <s:url var="urlEdit" namespace="/tunjangan" action="edit_tunjangan" escapeAmp="false">
                                                            <s:param name="id"><s:property value="#attr.row.tunjanganId"/></s:param>
                                                ...
                                                <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                                    <s:url var="urlViewDelete" namespace="/tunjangan" action="delete_tunjangan" escapeAmp="false">
                                                        <s:param name="id"><s:property value="#attr.row.tunjanganId" /></s:param>
                                                        <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                                    </s:url>
                                                ...
                                                <display:column property="tunjanganName" sortable="true" title="Tunjangan Name"  />

...
<%--<script type='text/javascript' src='<s:url value="/dwr/interface/PayrollSkalaGajiAction.js"/>'></script>--%>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            ...
            var telekomunikasi = document.getElementById("telekomunisasi1").value;
            var penghasilan = document.getElementById("penghasilan1").value;
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollSkalaBodForm" method="post" theme="simple" namespace="/payrollSkalaGajiBod" action="saveAdd_payrollSkalaGajiBod" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>

                <legend align="left">Add Payroll Skala Gaji</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboPosition.listOfComboPositions" id="positionId1" name="payrollSkalaGajiBod.positionId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" value="0" id="gaji1" name="payrollSkalaGajiBod.gajiBod" required="true" cssClass="form-control" onfocusout="setJumlahGaji()"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" value="0" id="rumah1" name="payrollSkalaGajiBod.tunjRumah" required="true" cssClass="form-control" onfocusout="setJumlahGaji()"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" value="0" id="telekomunisasi1" name="payrollSkalaGajiBod.tunjTelekomunikasi" required="true" cssClass="form-control" onfocusout="setJumlahGaji()"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="penghasilan1" readonly="true" name="payrollSkalaGajiBod.jumlahPengasilanBulan" required="true" cssClass="form-control" />
                            </table>
                        </td>
                    </tr>
                ...
                <script>
                    function setJumlahGaji(){
                        var gaji1 = document.getElementById("gaji1").value;
                        var rumah1 = document.getElementById("rumah1").value;
                        var telekomunikasi1 = document.getElementById("telekomunisasi1").value;

                        var jumlahGaji = parseFloat(gaji1)+parseFloat(rumah1)+parseFloat(telekomunikasi1);
                        console.log(jumlahGaji);
                        $('#penghasilan1').val(jumlahGaji);
                    }
                </script>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addPayrollSkalaBodForm" id="save" name="save"

...
<head>
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave', function (event, data) {
            var nameDepartment = document.getElementById("smkSkalaNilaiId1").value;
            if (nameDepartment != '' ) {
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/smkSkalaNilai" action="saveDelete_smkSkalaNilai" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkSkalaNilaiName1" name="smkSkalaNilai.skalaName" required="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkSkalaNilaiAtas1" name="smkSkalaNilai.nilaiAtas" required="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkSkalaNilaiBawah1" name="smkSkalaNilai.nilaiBawah" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkAngkaPrestasi" name="smkSkalaNilai.poin" readonly="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboBranch.listOfComboBranch" id="branchId1"
                                          name="smkSkalaNilai.branchId" disabled="true"

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollFaktorKeluargaForm" method="post" theme="simple" namespace="/payrollFaktorKeluarga" action="saveDelete_payrollFaktorKeluarga" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Faktor Keluarga</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="id" name="payrollFaktorKeluarga.faktorKeluargaId" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:select list="#{'K':'Keluarga'}" id="status" name="payrollFaktorKeluarga.statusKeluarga" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="jumlahAnak1" name="payrollFaktorKeluarga.jumlahAnak" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="nilai1" name="payrollFaktorKeluarga.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="ptkp1" name="payrollFaktorKeluarga.ptkp" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

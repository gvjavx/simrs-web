        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" id="searchForm" action="search_biayapengobatan.action">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <table align="center">
                                    <tr>
                                        <td>
                                            <label>Biaya Pengobatan Id </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <s:textfield id="biayaPengobatanId" name="biayaPengobatan.biayaPengobatanId" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label>Biaya Pengobatan Name </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <s:textfield id="biayaPengobatanName" name="biayaPengobatan.biayaPengobatanName" cssClass="form-control" cssStyle="margin-top: -30px; margin-left: 20px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <s:select list="#{'N':'Non-Active'}" id="flag" name="biayaPengobatan.flag"
                            ...
                            <div class="box-footer">
                                <table align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <s:url var="urlAdd" namespace="/biayapengobatan" action="add_biayapengobatan" escapeAmp="false">
                                            </s:url>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initForm_biayapengobatan"/>'">
                                            ...
                                            <display:table name="listOfResult" class="table table-condensed table-striped table-hover"
                                                ...
                                                <display:column media="html" title="Edit">
                                                    <s:if test="#attr.row.flagYes">
                                                        <s:url var="urlEdit" namespace="/biayapengobatan" action="edit_biayapengobatan" escapeAmp="false">
                                                            <s:param name="id"><s:property value="#attr.row.biayaPengobatanId"/></s:param>
                                                ...
                                                <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                                    <s:url var="urlViewDelete" namespace="/biayapengobatan" action="delete_biayapengobatan" escapeAmp="false">
                                                        <s:param name="id"><s:property value="#attr.row.biayaPengobatanId" /></s:param>
                                                        <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                                    </s:url>
                                                ...
                                                <display:column property="biayaPengobatanName" sortable="true" title="Biaya Pengobatan Name"  />

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollDanaPensiunForm" method="post" theme="simple" namespace="/payrollDanaPensiun" action="saveEdit_payrollDanaPensiun" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilai1" name="payrollDanaPensiun.persentase" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

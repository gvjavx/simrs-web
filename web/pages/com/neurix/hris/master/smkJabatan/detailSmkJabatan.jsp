                    ...
                    <table id="showdata" width="50%">
                        <tr>
                            <td align="center">
                                ...
                                <s:set name="listOfsmkKategoriAspekB" value="#session.listOfViewSmkJabatan" scope="request" />
                                <display:table name="listOfsmkKategoriAspekB" varTotals="totals" class="table table-condensed table-striped table-hover"
                                               id="row" pagesize="14" style="font-size:10">
                                    <display:column media="html" title="View" style="text-align:center;font-size:9">
                                        <s:url var="urlView" namespace="/smkJabatan" action="detail2_smkJabatan" escapeAmp="false">
                                            <s:param name="id"><s:property value="#attr.row.jabatanSmkId" /></s:param>
                                        </s:url>
                                        <sj:a onClickTopics="showDialogMenu2" href="%{urlView}">
                                            <img border="0" src="<s:url value="/pages/images/icon_lup.ico"/>" name="icon_detail">
                                        </sj:a>
                                    </display:column>
                                    <display:column property="tipeAspekId" sortable="true" title="Tipe Aspek" />

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/cutiPanjang" action="saveEdit_cutiPanjang" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Cuti Panjang</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="jumlahCuti" name="cutiPanjang.jumlahCuti" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>

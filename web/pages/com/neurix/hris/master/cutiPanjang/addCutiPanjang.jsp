...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/cutiPanjang" action="saveAdd_cutiPanjang" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Cuti Panjang</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="jumlahCuti" name="cutiPanjang.jumlahCuti" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>

...
//            window.location.reload(true);
        ...
        $.subscribe('beforeProcessSave3', function (event, data) {
            var idMapping = document.getElementById("mappingPersenGajiId3").value;
            var namaMapping = document.getElementById("namaMappingPersenGaji3").value;
            var jenisGaji = document.getElementById("jenisGaji3").value;
            var persentase = document.getElementById("persentase3").value;
            ...
            if (idMapping != '' && namaMapping != '' && jenisGaji != '' && persentase != '') {
                ...
                document.getElementById('errorValidationMessage3').innerHTML = msg;

                $.publish('showErrorValidationDialog2');
            }
        });
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="deleteMappingForm" method="post" theme="simple" namespace="/mappingPersenGaji" action="saveDelete_mappingPersenGaji" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>

                <legend align="left">Delete Mapping Persen Gaji</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="mappingPersenGajiId3" name="mappingPersenGaji.mappingPersenGajiId" readonly="true" required="true" disabled="false" cssClass="form-control"/>
                        ...
                        <td>
                            <table>
                                <s:select list="#{'gaji_golongan':'Gaji Pokok', 'tunjangan_umk' : 'Santunan Khusus', 'tunjangan_jabatan' : 'Tunjangan Jabatan',
                                          ...
                                          headerKey="" headerValue="[Select one]" cssClass="form-control"/>
                                <s:hidden id="jenisGaji3" name="mappingPersenGaji.jenisGaji" />
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="persentase3" name="mappingPersenGaji.presentase" required="true" readonly="true" disabled="false" type="number" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="deleteMappingForm" id="save2" name="save"
                            ...
                            <div id="crud">
                                <td>
                                    <table>
                                        ...
                                        <sj:dialog id="error_validation_dialog" openTopics="showErrorValidationDialog2" modal="true" resizable="false"
                                        ...
                                        >
                                            <div class="alert alert-error fade in">
                                                <label class="control-label" align="left">
                                                    ...
                                                    <br/>
                                                    <center><div id="errorValidationMessage3"></div></center>
                                                </label>
                                            </div>
                                        </sj:dialog>
                                    </table>

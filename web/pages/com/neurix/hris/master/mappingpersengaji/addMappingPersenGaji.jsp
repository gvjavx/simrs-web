...
<head>
    ...
    <script type="text/javascript">
        ...
        $.subscribe('beforeProcessSave1', function (event, data) {
            ...
            if (namaMapping != '' && jenisGaji != '' && persentase != '') {
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addMappingForm" method="post" theme="simple" namespace="/mappingPersenGaji" action="saveAdd_mappingPersenGaji" cssClass="well form-horizontal">

                <s:hidden name="addOrEdit"/>
                <s:hidden name="delete"/>
                <legend align="left">Add Mapping Persen Gaji</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboJenisPegawai.listOfComboJenisPegawai" id="namaMappingPersenGaji1" name="mappingPersenGaji.namaMappingPersenGaji"
                        ...
                        <td>
                            <table>
                                <s:select list="#{'gaji_golongan':'Gaji Pokok', 'tunjangan_umk' : 'Santunan Khusus', 'tunjangan_jabatan' : 'Tunjangan Jabatan',
                                          ...
                                          id="jenisGaji1" name="mappingPersenGaji.jenisGaji"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield id="persentase1" name="mappingPersenGaji.presentase" required="true" disabled="false" type="number" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <sj:submit targets="crud" type="button" cssClass="btn btn-primary" formIds="addMappingForm" id="save1" name="save"

...
//            window.location.reload(true);
            ...
            $.subscribe('beforeProcessSave2', function (event, data) {
                ...
                var namaMapping = document.getElementById("namaMappingPersenGaji2").value;
                var jenisGaji = document.getElementById("jenisGaji2").value;
                var persentase = document.getElementById("persentase2").value;
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboJenisPegawai.listOfComboJenisPegawai"

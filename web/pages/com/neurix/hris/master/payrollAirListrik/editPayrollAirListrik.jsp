...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollAirListrik" action="saveEdit_payrollAirListrik" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollAirListrik.golonganId"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilai1" name="payrollAirListrik.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

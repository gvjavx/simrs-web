...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollSkalaGajiForm" method="post" theme="simple" namespace="/payrollAirListrik" action="saveAdd_payrollAirListrik" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Payroll Air Listrik</legend>

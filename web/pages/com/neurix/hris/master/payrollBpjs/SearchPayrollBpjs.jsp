...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='initForm_payrollBpjs'/>";
        }
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollBpjsForm" method="post"  theme="simple" namespace="/payrollBpjs" action="search_payrollBpjs.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            <tr>
                                <td>
                                    <label class="control-label"><small>Bpjs Id :</small></label>
                                </td>
                                <td>
                                    <table>
                                        <s:textfield  id="skalaGajiId" name="payrollBpjs.bpjsId" required="false" readonly="false" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:select list="#{'N':'Non-Active'}" id="flag" name="payrollBpjs.flag"
                        ...
                        <div id="actions" class="form-actions">
                            <table align="center">
                                <tr>
                                    <td>
                                        <sj:submit type="button" cssClass="btn btn-primary" formIds="payrollBpjsForm" id="search" name="search"
                                    ...
                                    <td>
                                        <s:url var="urlAdd" namespace="/payrollBpjs" action="add_payrollBpjs" escapeAmp="false">
                                        </s:url>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initForm_payrollBpjs"/>'">
                                ...
                                <tr>
                                    <td align="center">
                                        <sj:dialog id="view_dialog_menu" openTopics="showDialogMenu" modal="true"
                                                   height="600" width="550" autoOpen="false"
                                                   title="Payroll BPJS">
                                        ...
                                        <display:table name="listOfPayrollSkalaGaji" class="table table-condensed table-striped table-hover"
                                                       requestURI="paging_displaytag_payrollBpjs.action" export="true" id="row" pagesize="14" style="font-size:10">
                                            <display:column media="html" title="Edit">
                                                <s:if test="#attr.row.flagYes">
                                                    <s:url var="urlEdit" namespace="/payrollBpjs" action="edit_payrollBpjs" escapeAmp="false">

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollBpjs" action="saveDelete_payrollBpjs" cssClass="well form-horizontal">
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="skalaGajiId1" readonly="true" name="payrollBpjs.bpjsId" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="iuranKaryawan1" name="payrollBpjs.iuranKary" required="true" cssClass="form-control" />
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="jpkKaryawan1" name="payrollBpjs.jpkKary" required="true" cssClass="form-control" onchange="setPersenTkKary()"/>
                                </table>
                            </td>
                        </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="jkkPers1" name="payrollBpjs.jkkPers" required="true" cssClass="form-control"/>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="jhtPers1" name="payrollBpjs.jhtPers" required="true" cssClass="form-control"/>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="jkmPers1" name="payrollBpjs.jkmPers" required="true" cssClass="form-control" onchange="setiuranTkPers()"/>
                                </table>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield readonly="true" id="jpkPers1" name="payrollBpjs.jpkPers" required="true" cssClass="form-control" onchange="setPersenTkPers()"/>
                                </table>
                            </td>
                        </tr>
                    <tr>

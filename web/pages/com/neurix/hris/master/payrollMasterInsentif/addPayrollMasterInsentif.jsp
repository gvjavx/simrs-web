...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollMasterInsentifForm" method="post" theme="simple" namespace="/payrollMasterInsentif" action="saveAdd_payrollMasterInsentif" cssClass="well form-horizontal">

            ...
            <s:form id="addPayrollPtkpForm" method="post" theme="simple" namespace="/payrollPtkp" action="saveAdd_payrollPtkp.action" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <%--<s:select list="#initComboTipe.listComboStatusKeluarga" id="statusKeluargaAdd" name="payrollPtkp.statusKeluarga"--%>
                                          <%--listKey="statusKeluarga" listValue="statusKeluargaName" headerKey="" headerValue="[Select one]" cssClass="form-control"/>--%>
                                    <s:select list="#{'B':'Bujang', 'K':'Keluarga'}" id="statusKeluargaAdd" name="payrollPtkp.statusKeluarga"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilaiAdd" name="payrollPtkp.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

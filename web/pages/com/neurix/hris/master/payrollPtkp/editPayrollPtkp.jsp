...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollPtkp" action="saveEdit_payrollPtkp.action" cssClass="well form-horizontal">
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <%--<s:select list="#initComboTipe.listComboStatusKeluarga" id="statusKeluargaEdit" name="payrollPtkp.statusKeluarga"--%>
                                          <%--listKey="statusKeluarga" listValue="statusKeluargaName" headerKey="" headerValue="[Select one]" cssClass="form-control"/>--%>
                                    <s:select list="#{'B':'Bujang', 'K':'Keluarga'}" id="statusKeluargaEdit" disabled="true" name="payrollPtkp.statusKeluarga"

                ...
                <form class="form-horizontal" id="myForm">
                    <div class="form-group">
                        ...
                        <div class="row" style="margin-top: 7px">
                            ...
                            <div class="col-sm-4">
                                <s:textfield id="modPersenKsoTindakan" cssClass="form-control" readonly="true"
                                />
                            </div>
                        </div>
                        <br>
    ...
    $(document).ready(function() {
        ...
        $('#modBtnSave').click(function () {
            ...
            if(riwayatTindakanId!='' && persenKsoTindakan!=''){
                DokterKsoAction.saveKonsolDetailSession(riwayatTindakanId,riwayatTindakanName,persenKsoTindakan,function() {
                    listResult();
                });

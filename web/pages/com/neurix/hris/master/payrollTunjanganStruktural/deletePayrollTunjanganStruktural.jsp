...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollTunjanganStruktural" action="saveDelete_payrollTunjanganStruktural" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Payroll Tunjangan Struktural</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollTunjanganStruktural.golonganId" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="nilai1" name="payrollTunjanganStruktural.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

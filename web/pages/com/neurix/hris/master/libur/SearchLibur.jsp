...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="liburForm" method="post"  theme="simple" namespace="/libur" action="search_libur.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:textfield  id="liburId" name="libur.liburId" required="false" readonly="false" cssClass="form-control"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:textfield id="liburTahun" name="libur.liburTahun" required="true" disabled="false" cssClass="form-control"/>
                                            <%--<s:hidden name="libur.liburTahun"/>--%>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <table id="showdata" width="40%">
                                <tr>
                                    <td align="center">
                                        ...
                                        <s:set name="listOfLibur" value="#session.listOfResult" scope="request" />
                                        <display:table name="listOfLibur" class="table table-condensed table-striped table-hover"

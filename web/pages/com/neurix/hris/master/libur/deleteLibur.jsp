...
//                if(Date.parse(tang1[2] + '-' + tang1[1] + '-' + tang1[0])){
//                    //alert('error');
...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/libur" action="saveDelete_libur" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Libur</legend>
                ...
                <table >
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#comboLibur.listOfResultTipe" id="Tipe" name="libur.tipeLiburId"
                                          listKey="tipeLiburId" listValue="tipeLiburName" headerKey="" headerValue="[Select one]" cssClass="form-control" disabled="true" />
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="tahun" name="libur.liburTahun" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="tgl1" name="libur.stTanggal" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textarea rows="4" readonly="true" id="liburKeterangan" name="libur.liburKeterangan" required="false" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <table>
                        <tr>
                            <div id="crud">
                                <td>
                                    <table>
                                        <sj:dialog id="waiting_dialog_delete" openTopics="showDialog"

...
<s:form id="addForm" method="post" theme="simple" namespace="/jamkerja" action="save_jamkerja" cssClass="well form-horizontal">
    ...
    <legend align="left">Add Jam Kerja</legend>

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/department" action="saveEdit_department" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="kodering1" name="department.kodering" required="true" readonly="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/smkKategoriAspek" action="saveEdit_smkKategoriAspek" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit SmkKategori</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkKategoriAspekName1" name="smkKategoriAspek.kategoriName" required="false" readonly="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkKategoriAspekBobot1" name="smkKategoriAspek.bobot" required="false" readonly="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

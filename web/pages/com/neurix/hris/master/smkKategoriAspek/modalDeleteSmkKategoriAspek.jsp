            ...
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/smkKategoriAspek" action="SavedeleteIndikator_smkKategoriAspek" cssClass="well form-horizontal">
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield rows="3"  id="indikatorPenilaianAspekId1" name="smkIndikatorPenilaianAspek.indikatorPenilaianAspekId" required="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield rows="3"  id="bobot1" name="smkIndikatorPenilaianAspek.bobot" required="false" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/smkSkalaPointPrestasi" action="saveAdd_smkSkalaPointPrestasi" cssClass="well form-horizontal">
                ...
                <legend align="left">Add SMK Skala Point Prestasi</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                    <s:textfield type="number" min="0" id="smkSkalaNilaiKode1" name="smkSkalaPointPrestasi.point" required="false" readonly="false" cssClass="form-control"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" step="0.1" id="smkSkalaNilaiAtas1" name="smkSkalaPointPrestasi.nilaiAtas" required="false" readonly="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" step="0.1" id="smkSkalaNilaiBawah1" name="smkSkalaPointPrestasi.nilaiBawah" readonly="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

    ...
    <tr>
        <td align="center">
            <s:form id="addPayrollSkalaGajiForm" method="post" theme="simple" namespace="/payrollSkalaGajiDplkPegawai" action="saveAdd_payrollSkalaGajiDplkPegawai" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Payroll Skala Gaji Pensiun Dplk Pegawai</legend>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select cssClass="form-control" list="#comboGolongan.listComboGolonganDapen" id="golonganId1" name="payrollSkalaGajiDplkPegawai.golonganId" required="true"

...
<head>
    ...
    <script type='text/javascript'>
        ...
        function link(){
            window.location.href="<s:url action='initForm_payrollSkalaGajiDplkPegawai'/>";
        }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Payroll Skala Gaji Pensiun Dplk Pegawai
        </h1>
    </section>
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollSkalaGajiDplkPegawaiForm" method="post"  theme="simple" namespace="/payrollSkalaGajiDplkPegawai" action="searchPayrollSkalaGajiDplkPegawai_payrollSkalaGajiDplkPegawai.action" cssClass="well form-horizontal">
                        ...
                        <table >
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:textfield  id="skalaGajiId" name="payrollSkalaGajiDplkPegawai.skalaGajiPensiunDplkPegawaiId" required="false" readonly="false" cssClass="form-control"/>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <s:select cssClass="form-control" list="#comboGolongan.listComboGolonganDapen" id="golonganDapenId" name="payrollSkalaGajiDplkPegawai.golonganId" required="true"
                        ...
                        <div id="actions" class="form-actions">
                            <table align="center">
                                <tr>
                                    <td>
                                        <sj:submit type="button" cssClass="btn btn-primary" formIds="payrollSkalaGajiDplkPegawaiForm" id="search" name="search"
                                ...
                                <tr>
                                    <td align="center">
                                        <sj:dialog id="view_dialog_menu" openTopics="showDialogMenu" modal="true"
                                                   ...
                                                   title="Payroll Skala Gaji Iuran Dplk">
                                            <center><img border="0" src="<s:url value="/pages/images/loading11.gif"/>" alt="Loading..."/></center>
                                        </sj:dialog>

                                        <s:set name="listComboPayrollSkalaGajiIuranDplk" value="#session.listOfResult" scope="request" />
                                        <display:table name="listComboPayrollSkalaGajiIuranDplk" class="table table-condensed table-striped table-hover"
                                            ...
                                            <display:column media="html" title="Edit">
                                                <s:if test="#attr.row.flagYes">
                                                    <s:url var="urlEdit" namespace="/payrollSkalaGajiDplkPegawai" action="edit_payrollSkalaGajiDplkPegawai" escapeAmp="false">
                                                        <s:param name="id"><s:property value="#attr.row.skalaGajiPensiunDplkPegawaiId"/></s:param>
                                            ...
                                            <display:column property="skalaGajiPensiunDplkPegawaiId" sortable="true" title="Skala Gaji ID" />

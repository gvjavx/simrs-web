    ...
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollSkalaGajiDplkPegawai" action="saveEdit_payrollSkalaGajiDplkPegawai" cssClass="well form-horizontal">
                ...
                <legend align="left">Edit Payroll Skala Gaji Pensiun Dplk Pegawai</legend>
                <table>
                    <tr>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="skalaGajiId1" readonly="true" name="payrollSkalaGajiDplkPegawai.skalaGajiPensiunDplkPegawaiId" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="golonganId1" name="payrollSkalaGajiDplkPegawai.golonganName" readonly="true" required="true"  cssClass="form-control"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" id="nilai1" name="payrollSkalaGajiDplkPegawai.nilai" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

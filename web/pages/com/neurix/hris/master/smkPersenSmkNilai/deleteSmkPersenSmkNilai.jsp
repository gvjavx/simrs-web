...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollTunjanganUmk" action="saveDelete_payrollTunjanganUmk" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboBranch.listOfComboBranch" id="branchId1" name="payrollTunjanganUmk.branchId" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollTunjanganUmk.golonganId" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="nilai1" name="payrollTunjanganUmk.nilai" required="true" cssClass="form-control" readonly="true"/>
                            </table>
                        </td>
                    </tr>

...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollTunjanganUmkForm" method="post" theme="simple" namespace="/smkPersenSmkNilai" action="saveAdd_smkPersenSmkNilai" cssClass="well form-horizontal">
                ...
                <legend align="left">Add Persen Nilai</legend>

...
<s:form id="deleteForm" method="post" theme="simple" namespace="/group" action="saveDelete_group" cssClass="well form-horizontal">

    <legend align="left">Delete Group</legend>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <s:textfield cssClass="form-control" id="groupId" name="group.groupId" readonly="true" required="false"  />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <s:textfield id="groupName" cssClass="form-control" name="group.groupName" required="false" readonly="true"/>
        </div>
    </div>
    <br>
    <div class="form-group">

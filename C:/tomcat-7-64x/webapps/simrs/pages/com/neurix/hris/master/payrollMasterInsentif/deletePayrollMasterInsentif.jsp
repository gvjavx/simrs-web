...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="addPayrollMasterInsentifForm" method="post" theme="simple" namespace="/payrollMasterInsentif" action="saveDelete_payrollMasterInsentif" cssClass="well form-horizontal">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboBranch.listOfComboBranch" id="branchId" name="payrollMasterInsentif.branchId" readOnly="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="potonganInsentif" name="payrollMasterInsentif.potonganInsentif" required="true" readonly="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="smkStandart" name="payrollMasterInsentif.smkStandart" readonly="true" required="true" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>

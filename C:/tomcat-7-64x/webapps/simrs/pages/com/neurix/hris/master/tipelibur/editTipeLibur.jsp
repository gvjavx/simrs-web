...
<body bgcolor="#FFFFFF">
    <table width="100%" align="center">
        <tr>
            <td align="center">
                <s:form id="editForm" method="post" theme="simple" namespace="/tipelibur" action="saveEdit_tipelibur" cssClass="well form-horizontal">
                    ...
                    <legend align="left">Edit Tipe Libur</legend>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <table>
                                    <s:textfield cssClass="form-control" id="tipeLiburId" name="tipeLibur.tipeLiburId" readonly="true" required="true" />

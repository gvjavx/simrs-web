...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="modifyRolefuncForm" method="post" theme="simple" namespace="/cutiPegawai" action="saveDelete_libur" cssClass="well form-horizontal">
                ...
                <legend align="left">Add CutiPegawai</legend>
                ...
                <table >
                    <tr>
                        <td>
                            <label class="control-label"><small>CutiPegawai Id :</small></label>
                        </td>
                        <td>
                            <table>
                                <s:textfield  id="liburId" name="cutiPegawai.liburId" required="true" readonly="true" cssClass="form-control"/>
                                    <%--<s:hidden name="cutiPegawai.liburId"/>--%>
                    ...
                    <tr>
                        <td>
                            <label class="control-label"><small>Tipe CutiPegawai :</small></label>
                        </td>
                        <td>
                            <table>
                                <s:select list="#session.listOfResultTipe" id="Tipe" name="cutiPegawai.tipeLiburId" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="tahun" name="cutiPegawai.liburTahun" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="tgl1" name="cutiPegawai.stLiburFrom" required="true" disabled="false" cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield readonly="true" id="tgl2" name="cutiPegawai.stLiburTo" required="true" disabled="false" cssClass="form-control"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textarea rows="4" readonly="true" id="liburKeterangan" name="cutiPegawai.keterangan" required="false" disabled="false" cssClass="form-control"/>

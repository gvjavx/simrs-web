    ...
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollTunjanganJabatanStruktural" action="saveDelete_payrollTunjanganJabatanStruktural" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Payroll Tunjangan Jabatan Struktural</legend>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:hidden name="payrollTunjanganJabatanStruktural.positionId"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select cssClass="form-control" list="#comboBranch.listOfComboBranches" id="branchId1" name="payrollTunjanganJabatanStruktural.branchId" required="true" disabled="true"
                                          listKey="branchId" listValue="branchName" headerKey="" headerValue="[Select one]" />
                                <s:hidden name="payrollTunjanganJabatanStruktural.branchId"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield type="number" min="0" id="nilai1" name="payrollTunjanganJabatanStruktural.nilai" required="true" cssClass="form-control" disabled="true"/>
                            </table>
                        </td>
                    </tr>

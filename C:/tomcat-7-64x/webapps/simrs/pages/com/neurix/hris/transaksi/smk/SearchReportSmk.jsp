...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <table width="100%" align="center">
            <tr>
                <td align="center">
                    <s:form id="payrollForm" method="post"  theme="simple" namespace="/smk" action="searchReport_smk.action" cssClass="well form-horizontal">
                        ...
                        <table >
                                ...
                                <td>
                                    <table>
                                        <s:select list="#{'2017':'2017', '2018' : '2018', '2019':'2019', '2020':'2020', '2021':'2021'}"
                                                  id="tahunPayroll" name="smk.tahun"
                                                  headerKey="0" headerValue="Tahun" cssClass="form-control" />
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <s:action id="initComboBranch" namespace="/admin/branch" name="initComboBranch_branch"/>
                                        <s:select list="#initComboBranch.listOfComboBranch" id="branchIdPayroll" name="smk.branchId"
                                                  listKey="branchId" listValue="branchName" headerKey="" headerValue="[Select one]" cssClass="form-control"/>
                                    </table>

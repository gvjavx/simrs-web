...
<table width="100%" align="center">
    <tr>
        <td align="center">
            <s:form id="formEdit" method="post" theme="simple" namespace="/payrollAirListrik" action="saveDelete_payrollAirListrik" cssClass="well form-horizontal">
                ...
                <legend align="left">Delete Payroll Air Listrik</legend>
                ...
                <table >
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="tunjAirListrik1" readonly="true" name="payrollAirListrik.tunjAirListrikId" required="true"  cssClass="form-control"/>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <s:select list="#initComboTipe.listComboGolongan" id="golonganId1" name="payrollAirListrik.golonganId" disabled="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <s:textfield  id="nilai1" name="payrollAirListrik.nilai" required="true" cssClass="form-control" disabled="true"/>
                            </table>
                        </td>
                    </tr>

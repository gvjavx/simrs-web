            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Medical Record</h3>
                    </div>

                    <form role="form" method="post" name="saveMedicalRecord" id="saveMedicalRecord" action="save_medicalrecord.action">
                        <div class="box-body">
                                                ...
                                                $('#nip').typeahead({
                                                    ...
                                                    source: function (query, process) {
                                                        ...
                                                        $.each(data, function (i, item) {
                                                            ...
                                                            mapped[labelItem] = { id: item.nip, label: item.namaPegawai, status: item.statusPegawai, golongan: item.golonganId};
                                                    ...
                                                    updater: function (item) {
                                                        ...
                                                        var golongan = selectedObj.golongan;
                                                        var golonganNew="";
                                                        if (golongan==""||golongan==null){
                                                        } else{
                                                            golonganNew = golongan.replace("G","Golongan ");
                                                        }
                                                        document.getElementById("nama").value = namaMember;
                                                        document.getElementById("sendiri").value = namaMember;
                                                        document.getElementById("statusPegawai").value = statusPegawai;
                                                        document.getElementById("statusPegawai1").value = statusPegawai;
                                                        document.getElementById("golonganId").value = golonganNew;
                                                        // document.getElementById("golonganId1").value = golongan;
                                                        nip = selectedObj.id;
                                    ...
                                    <tr>
                                        <td>
                                            <s:select list="#{'KS':'Karyawan Staff','KNS':'Karyawan Non Staff'}" id="statusPegawai1" name="medicalRecord.statusPegawai"
                                                      headerKey="" headerValue="" cssClass="form-control" cssStyle="margin-top: -25px; margin-left: 20px" disabled="true"/>
                                            <s:textfield id="statusPegawai" name="medicalRecord.statusPegawai" cssClass="form-control" readonly="true" cssStyle="display: none; margin-top: -25px;margin-left: 20px;"/>
                                        </td>
                                    </tr>
                                    <tr style="vertical-align: bottom">
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <s:select list="#{'RI':'Rawat Inap','RJ':'Rawat Jalan'}" id="tipePengobatan" name="medicalRecord.tipePengobatan"
                                                      headerKey="" headerValue="" cssClass="form-control" cssStyle="margin-top: -25px; margin-left: 20px" onchange="checkTheBox()"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <script>
                                                ...
                                                $('#rsId').typeahead({
                                                    ...
                                                    source: function (query, process) {
                                                        ...
                                                        var data = [];
                                                        dwr.engine.setAsync(false);
                                                        if ($('#tipePengobatan').val()==="RI"){
                                                            MedicalRecordAction.initComboRsKelas(query, status, nip, golonganId,"RI", function (listdataRs) {
                                                                data = listdataRs;
                                                                if (data!=""){
                                                                    $.each(data, function (i, item) {
                                                                    ...
                                                                    alert("RS untuk NIP ini tidak tersedia");
                                                                    $('#rsId').val("");
                                                                }
                                                            });
                                                        }else if ($('#tipePengobatan').val()==="RJ") {
                                                            MedicalRecordAction.initComboRsKelas(query, status, nip, golonganId,"RJ", function (listdataRs) {
                                                                data = listdataRs;
                                                            });
                                                        }
                                                    },
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table>
                                                            ...
                                                            <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="add_medicalrecord"/>' ">
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <display:table name="listOfResult" class="table table-condensed table-striped table-hover"
                                                ...
                                                <display:column media="html" title="Add Bukti <br> Pengobatan" style="text-align:center;font-size:9">
                                                    <s:if test="#attr.row.flagYes">
                                                        ...
                                                        <sj:a onClickTopics="showDialogMenuEdit" href="%{urlEdit}">
                                                            ...
                                                            <%--<img border="0" src="<s:url value="/pages/images/add_doc.png"/>" height="25px" name="icon_edit">--%>
                                                        </sj:a>
                                                    </s:if>
                                                </display:column>
                                                ...
                                                <display:column property="namaBiayaPengobatan" style="text-align:right;" sortable="true" title="Biaya Pengobatan" />
...
function savetoSession(){
    ...
    var status = document.getElementById("statusPegawai").value;
    var golongan = document.getElementById("golonganId").value;
    var tanggal = document.getElementById("tanggalBerobat").value;
    var tipeBerobat = document.getElementById("tipeOrangBerobat").value;
    var sendiri = document.getElementById("sendiri").value;
    var keluarga = document.getElementById("keluargaId123").value;
    var tipepengobatan = document.getElementById("tipePengobatan").value;
    var rsId = document.getElementById("rsId").value;
    var namarumahsakit = document.getElementById("rsName").value;
    var kelaslayananrs = document.getElementById("rsKelasId").value;
    var kelaslayananrsName = document.getElementById("rsKelasName").value;
    var flagSuratJaminan = document.getElementById("flagSuratJaminan").value;
    var keluargaName =document.getElementById("keluarga").value;
    MedicalRecordAction.saveToSession(branchId, nip, nama, status,golongan,tanggal,tipeBerobat,sendiri,keluarga,tipepengobatan,rsId,namarumahsakit,kelaslayananrs,kelaslayananrsName,flagSuratJaminan,keluargaName, function (data) {
        if(data!='00'){
            alert("Error when save to session");
        }
    })
}

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" id="searchForm" action="search_groupMember.action">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <table align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <s:select cssClass="form-control" list="#comboBranch.listOfComboBranches" id="branchid" name="groupMember.branchId" required="true"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <s:textfield id="nip32" name="groupMember.nip" required="true" disabled="false" cssClass="form-control"/>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <s:select cssClass="form-control" list="#comboGroup.listOfComboGroup" id="groupId" name="groupMember.groupId" required="true"
                            ...
                            <div class="box-footer">
                                <table align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <s:url var="urlAdd" namespace="/groupMember" action="add_groupMember" escapeAmp="false">
                                            </s:url>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger" onclick="window.location.href='<s:url action="initForm_groupMember"/>'">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <sj:dialog id="view_dialog_menu" openTopics="showDialogMenu" modal="true"
                                                       height="550" width="650" autoOpen="false"
                                                       title="Group">
                                            ...
                                            <display:table name="listOfResult" class="table table-condensed table-striped table-hover"
                                                           requestURI="paging_displaytag_groupMember.action" export="true" id="row" pagesize="10" style="font-size:10">
                                                <display:column media="html" title="Edit">
                                                    <s:if test="#attr.row.flagYes">
                                                        <s:url var="urlEdit" namespace="/groupMember" action="edit_groupMember" escapeAmp="false">
                                                            <s:param name="id"><s:property value="#attr.row.groupMemberId"/></s:param>
                                                ...
                                                <display:column media="html" title="Delete" style="text-align:center;font-size:9">
                                                    <s:url var="urlViewDelete" namespace="/groupMember" action="delete_groupMember" escapeAmp="false">
                                                        <s:param name="id"><s:property value="#attr.row.groupMemberId" /></s:param>
                                                        <s:param name="flag"><s:property value="#attr.row.flag" /></s:param>
                                                    </s:url>
